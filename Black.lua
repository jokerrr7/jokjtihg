...
{{text="⋄ السورس .",url="https://t.me/BLACK_TEAM_4"},{text="⋄ لتنصيب بوت .",url="https://t.me/UUOUOU_7"}},{{text="⋄ اضفني في مجموعتك .",url="t.me/"..dpbot.username_.."?startgroup=botstart"}}
}
...
--     Source Black     --
xt and (text == 'المطور' or text == 'مطور' or text == ' المطور ⋄') then
...
keyboard = {}  
keyboard.inline_keyboard = {{{text = '𝗰𝗵𝗮𝗻𝗻𝗲𝗹 𝘀𝗼𝘂𝗿𝗰𝗲',url="t.me/BLACK_TEAM_4"}},{{text = '𝗲𝘅𝗽 𝘀𝗼𝘂𝗿𝗰𝗲',url="t.me/black09_8"}}} 
local msg_id = msg.id_/2097152/0.5 
...
Text = [[
𝘄𝗲𝗹𝗰𝗼𝗺𝗲 𝘁𝗼 𝘀𝗼𝘂𝗿𝗰𝗲
 [𝗰𝗵𝗮𝗻𝗻𝗲𝗹 𝘀𝗼𝘂𝗿𝗰𝗲](https://t.me/BLACK_TEAM_4)
 [𝗲𝘅𝗽 𝘀𝗼𝘂𝗿𝗰𝗲](https://t.me/black09_8)
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '𝗱𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿',url="t.me/UUOUOU_7"}},{{text= '𝗱𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿',url="https://t.me/V_P_E"}}}
local msg_id = msg.id_/2097152/0.5
...
BlackTeam = {"ها هلاو","انطق","قول","تفضل","احبك","عمري","لاف"};
