...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⋄",callback_data="/Song:"..data.sender_user_id_}},{{text=". 𝗰𝗵𝗮𝗻𝗻𝗲𝗹 𝘀𝗼𝘂𝗿𝗰𝗲 ⋄",url="t.me/BLACK_TEAM_4"}}} 
...
local Text ='*⋄︰تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⋄",callback_data="/mp3:"..data.sender_user_id_}},{{text=". 𝗰𝗵𝗮𝗻𝗻𝗲𝗹 𝘀𝗼𝘂𝗿𝗰𝗲 ⋄",url="t.me/BLACK_TEAM_4"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⋄",callback_data="/memz:"..data.sender_user_id_}},{{text=". 𝗰𝗵𝗮𝗻𝗻𝗲𝗹 𝘀𝗼𝘂𝗿𝗰𝗲 ⋄",url="t.me/BLACK_TEAM_4"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⋄",callback_data="/gif:"..data.sender_user_id_}},{{text=". 𝗰𝗵𝗮𝗻𝗻𝗲𝗹 𝘀𝗼𝘂𝗿𝗰𝗲 ⋄",url="t.me/BLACK_TEAM_4"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⋄",callback_data="/photo:"..data.sender_user_id_}},{{text=". 𝗰𝗵𝗮𝗻𝗻𝗲𝗹 𝘀𝗼𝘂𝗿𝗰𝗲 ⋄",url="t.me/BLACK_TEAM_4"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى ⋄",callback_data="/anime:"..data.sender_user_id_}},{{text=". 𝗰𝗵𝗮𝗻𝗻𝗲𝗹 𝘀𝗼𝘂𝗿𝗰𝗲 ⋄",url="t.me/BLACK_TEAM_4"}}} 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="‹ ترتيب الاوامر ›",callback_data="/SetCmdGp:"..data.sender_user_id_},{text="‹ رفع الادمنيه ›",callback_data="/UploadAdmin:"..data.sender_user_id_}},{{text="‹ غادر ›",callback_data="/LeaveBot:"..data.sender_user_id_},{text="‹ تعطيل ›",callback_data="/Stop:"..data.sender_user_id_}},{{text="‹ 𝗰𝗵𝗮𝗻𝗻𝗲𝗹 𝘀𝗼𝘂𝗿𝗰𝗲 ›",url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard = {}
keyboard.inline_keyboard = {{{text="‹ غادر ›",callback_data="/LeaveBot:"..data.sender_user_id_},{text="‹ تفعيل ›",callback_data="/On:"..data.sender_user_id_}},{{text="‹ 𝗰𝗵𝗮𝗻𝗻𝗲𝗹 𝘀𝗼𝘂𝗿𝗰𝗲 ›",url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
Text = "⋄︰تم ترتيب الاوامر بالشكل التالي ~\n⋄︰ ايدي - ا .\n⋄︰ رفع مميز - م .\n⋄︰رفع ادمن - اد .\n⋄︰ رفع مدير - مد . \n⋄︰ رفع منشى - من . \n⋄︰ رفع منشئ الاساسي - اس  .\n⋄︰ رفع مطور - مط .\n⋄︰رفع مطور ثانوي - ثانوي .\n⋄︰ تنزيل الكل - تك .\n⋄︰ تعطيل الايدي بالصوره - تعط .\n⋄︰ تفعيل الايدي بالصوره - تفع .\n⋄︰ الرابط - ر .\n⋄︰ ردود المدير - رر .\n⋄︰ مسح المكتومين - ،، .\n⋄︰ اضف رد - رد .\n⋄︰ مسح سحكاتي - سح .\n⋄︰ مسح رسائلي - رس .\n⋄︰ غنيلي - غ .\n⋄︰مسح قائمه العام"
keyboard = {} 
keyboard.inline_keyboard = {{{text="‹ رجوع ›",callback_data="/Reload:"..data.sender_user_id_}},{{text='‹ 𝗰𝗵𝗮𝗻𝗻𝗲𝗹 𝘀𝗼𝘂𝗿𝗰𝗲 ›',url="t.me/BLACK_TEAM_4"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source David     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '⋄ 𝗰𝗵𝗮𝗻𝗻𝗲𝗹 𝘀𝗼𝘂𝗿𝗰𝗲 .',url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
...
keyboard = {}  
keyboard.inline_keyboard = {{{text = '𝗰𝗵𝗮𝗻𝗻𝗲𝗹 𝘀𝗼𝘂𝗿𝗰𝗲 𝗯𝗹𝗮𝗰𝗸',url="t.me/BLACK_TEAM_4"}},{{text = '𝗲𝘅𝗽 𝘀𝗼𝘂𝗿𝗰𝗲',url="t.me/black09_8"}}} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/black09_8'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
⋄︰[𝗯𝗹𝗮𝗰𝗸 ⎉](https://t.me/BLACK_TEAM_4)
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '𝗰𝗵𝗮𝗻𝗻𝗲𝗹 𝘀𝗼𝘂𝗿𝗰𝗲 𝗯𝗹𝗮𝗰𝗸',url="https://t.me/BLACK_TEAM_4"}},{{text = '𝗱𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿',url="t.me/UUOUOU_7"},{text = '𝗱𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿',url="https://t.me/V_P_E"}},{{text= '𝗲𝘅𝗽 𝘀𝗼𝘂𝗿𝗰𝗲',url="https://t.me/black09_8"}}}
local msg_id = msg.id_/2097152/0.5
...
Text = "⋄︰تم تفعيل المجموعه "..dp.title_
local inline = {{{text="‹ ترتيب الاوامر ›",callback_data="/SetCmdGp:"..msg.sender_user_id_},{text="‹ رفع الادمنيه ›",callback_data="/UploadAdmin:"..msg.sender_user_id_}},{{text="‹ غادر ›",callback_data="/LeaveBot:"..msg.sender_user_id_},{text="‹ تعطيل ›",callback_data="/Stop:"..msg.sender_user_id_}},{{text="‹ 𝗰𝗵𝗮𝗻𝗻𝗲𝗹 𝘀𝗼𝘂𝗿𝗰𝗲 ›",url="t.me/BLACK_TEAM_4"}}}
...
Text = "⋄︰تم تعطيل المجموعه "..dp.title_
local inline = {{{text="‹ غادر ›",callback_data="/LeaveBot:"..msg.sender_user_id_},{text="‹ تفعيل ›",callback_data="/On:"..msg.sender_user_id_}},{{text="‹ 𝗰𝗵𝗮𝗻𝗻𝗲𝗹 𝘀𝗼𝘂𝗿𝗰𝗲 ›",url="t.me/BLACK_TEAM_4"}}}
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
DevRio:srem(Black.."Rio:Groups",msg.chat_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
