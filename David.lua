...
--   This Is The source zoro  @UUOUOU_7 .   --
--                - joker -                 --
--        -- https://t.me/UUOUOU_7 --         --
------------------------------------------------ 
...
local inline = {{{text="• ᥀ المطور . •",url="t.me/"..(dp.username_ or "SOURCE_ZORO_plus")}},{{text="• ᥀ السورس . •",url="https://t.me/SOURCE_ZORO_plus"},{text="• ᥀ لتنصيب بوت . •",url="https://t.me/UUOUOU_7"}},{{text="• ᥀ اضفني في مجموعتك . •",url="t.me/"..dp.username_.."?startgroup=botstart"}}}
...
keyboard = {}  
keyboard.inline_keyboard = {{{text = '• Ch zoro plus  ◉ •',url="t.me/SOURCE_ZORO_plus"}},{{text = '• Ch JOKER  ◉ •',url="t.me/UU_KFUF"}}} 
local msg_id = msg.id_/2097152/0.5 
...
--     Source David     --
if text == "مبرمج السورس" and ChCheck(msg) or text == "مطور السورس" and ChCheck(msg) or text == "بهجت" and ChCheck(msg) or text == "المبرمج" and ChCheck(msg) or text == "↫ مبرمج السورس ᥀" and ChCheck(msg) then 
Text = [[
