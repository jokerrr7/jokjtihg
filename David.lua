...
--   This Is The source black  @UUOUOU_7 .   --
--                - joker -                 --
--        -- https://t.me/UUOUOU_7 --         --
------------------------------------------------ 
...
DevId = Config.DevId
SudoIds = {Config.SudoIds,1965297568 ,1364212456,000000}
David = Config.David
TokenBot = Config.TokenBot
NameBot = (DevRio:get(David..'Rio:NameBot') or 'بلاك')
--     Source David     --
...
FilesPrint = FilesPrint.."\27[35m".." ◉○━━━━ BlAcK  ◉━━━━○ ◉ ┉ ┉ ┉ ┉\n".."\27[m"
...
send(chat,msg.id_,"  ◉⤈ هذا الملف ليس تابع لسورس بلاك")
return false 
end      
...
if DataText == '/delyes' and DevRio:get(David..'yes'..bot.UserName) == 'delyes' then
DevRio:del(David..'yes'..bot.UserName, 'delyes')
DevRio:del(David..'no'..bot.UserName, 'delno')
if RankChecking(bot.UserName, data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, " ◉⤈ لا استطيع طرد ↫ "..IdRank(..bot.UserName, data.chat_id_)) 
return false
end
tdcli_function({ID="ChangeChatMemberStatus",chat_id_=data.chat_id_,user_id_=..bot.UserName,status_={ID="ChatMemberStatusKicked"},},function(arg,da) 
...
ChatKick(data.chat_id_, ..bot.UserName)
EditMsg(Chat_Id2, Msg_Id2, " ◉⤈ تم طردك من المجموعه") 
return false
end
end,nil)  
end
if DataText == '/delno' and DevRio:get(David..'no'..bot.UserName) == 'delno' then
DevRio:del(David..'yes'..bot.UserName, 'delyes')
DevRio:del(David..'no'..bot.UserName, 'delno')
EditMsg(Chat_Id2, Msg_Id2, " ◉⤈ تم الغاء امر اطردني") 
end
--     Source David     --
if DataText == '/yesdel' and DevRio:get(David..'yesdel'..bot.UserName) == 'delyes' then
DevRio:del(David..'yesdel'..bot.UserName, 'delyes')
DevRio:del(David..'nodel'..bot.UserName, 'delno')
if DevRio:sismember(David..'Rio:Constructor:'..data.chat_id_, ..bot.UserName) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevRio:sismember(David..'Rio:Managers:'..data.chat_id_, ..bot.UserName) then
Managers = 'المدراء • ' else Managers = '' end
if DevRio:sismember(David..'Rio:Admins:'..data.chat_id_, ..bot.UserName) then
admins = 'الادمنيه • ' else admins = '' end
if DevRio:sismember(David..'Rio:VipMem:'..data.chat_id_, ..bot.UserName) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevRio:sismember(David..'Rio:Cleaner:'..data.chat_id_, ..bot.UserName) then
cleaner = 'المنظفين • ' else cleaner = '' end
if DevRio:sismember(David..'User:Donky:'..data.chat_id_, ..bot.UserName) then
donky = 'المطايه • ' else donky = '' end
if DevRio:sismember(David..'Rio:Constructor:'..data.chat_id_, ..bot.UserName) or DevRio:sismember(David..'Rio:Managers:'..data.chat_id_, ..bot.UserName) or DevRio:sismember(David..'Rio:Admins:'..data.chat_id_, ..bot.UserName) or DevRio:sismember(David..'Rio:VipMem:'..data.chat_id_, ..bot.UserName) or DevRio:sismember(David..'Rio:Cleaner:'..data.chat_id_, ..bot.UserName) or DevRio:sismember(David..'User:Donky:'..data.chat_id_, ..bot.UserName) then
DevRio:srem(David..'Rio:Constructor:'..data.chat_id_,..bot.UserName)
DevRio:srem(David..'Rio:Managers:'..data.chat_id_,..bot.UserName)
DevRio:srem(David..'Rio:Admins:'..data.chat_id_,..bot.UserName)
DevRio:srem(David..'Rio:VipMem:'..data.chat_id_,..bot.UserName)
DevRio:srem(David..'Rio:Cleaner:'..data.chat_id_,..bot.UserName)
DevRio:srem(David..'User:Donky:'..data.chat_id_,..bot.UserName)
EditMsg(Chat_Id2, Msg_Id2, " ◉⤈ تم تنزيلك من ↫ ⤈\n~ ( "..constructor..Managers..admins..vipmem..cleaner..donky.." ) ~ \n") 
else 
if IdRank(..bot.UserName, data.chat_id_) == 'العضو' then
EditMsg(Chat_Id2, Msg_Id2, " ◉⤈ ليس لديك رتبه في البوت") 
else 
EditMsg(Chat_Id2, Msg_Id2, " ◉⤈ لا استطيع تنزيل ↫ "..IdRank(..bot.UserName, data.chat_id_)) 
end
end
end
--     Source David     --
if DevRio:get(David.."Rio:NewDev"..bot.UserName) then
if DataText == '/setno' then
EditMsg(Chat_Id2, Msg_Id2, " ◉⤈ تم الغاء امر تغير المطور الاساسي") 
DevRio:del(David.."Rio:NewDev"..bot.UserName)
return false
end
if DataText == '/setyes' then
local NewDev = DevRio:get(David.."Rio:NewDev"..bot.UserName)
tdcli_function ({ID = "GetUser",user_id_ = NewDev},function(arg,dp) 
EditMsg(Chat_Id2, Msg_Id2, " ◉⤈ المطور الجديد ↫ ["..dp.first_name_.."](tg://user?id="..dp.id_..")\n ◉⤈ تم تغير المطور الاساسي بنجاح") 
end,nil)
tdcli_function ({ID = "GetUser",user_id_ = ..bot.UserName},function(arg,dp) 
...
if DataText == '/nodel' and DevRio:get(David..'nodel'..bot.UserName) == 'delno' then
DevRio:del(David..'yesdel'..bot.UserName, 'delyes')
DevRio:del(David..'nodel'..bot.UserName, 'delno')
EditMsg(Chat_Id2, Msg_Id2, " ◉⤈ تم الغاء امر نزلني") 
end
if DataText == '/YesRolet' and DevRio:get(David.."Rio:WittingStartRolet"..data.chat_id_..bot.UserName) then
...
DevRio:del(David.."Rio:WittingStartRolet"..data.chat_id_..bot.UserName)
EditMsg(Chat_Id2, Msg_Id2, " ◉⤈ *صاحب الحظ* ↫ ["..UserName.."]\n ◉⤈ *مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*")
end
if DataText == '/NoRolet' then
DevRio:del(David..'Rio:ListRolet'..data.chat_id_) 
DevRio:del(David.."Rio:NumRolet"..data.chat_id_..bot.UserName) 
DevRio:del(David.."Rio:WittingStartRolet"..data.chat_id_..bot.UserName)
...
if DevRio:sismember(David..'Rio:Tkeed:'..Chat_Id2, ..bot.UserName) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..Chat_Id2.."&user_id="..bot.UserName.."&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
DevRio:srem(David..'Rio:Tkeed:'..Chat_Id2, ..bot.UserName)
...
if DataText and DataText:match(tonumber(..bot.UserName)..'dl:id/(.*)') then
local Url = DataText:match(tonumber(..bot.UserName)..'dl:id/(.*)')
...
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('http://ccccxcc.ml/David/YtAnTak.php?Put=Photo&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&UserId='..bot.UserName..'&Url='..Url..'&Name='..DirName)
elseif DataText and DataText:match(tonumber(..bot.UserName)..'dl:vi/(.*)') then
local Url = DataText:match(tonumber(..bot.UserName)..'dl:vi/(.*)')
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("᥀ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
...
elseif DataText and DataText:match(tonumber(..bot.UserName)..'dl:au/(.*)') then
local Url = DataText:match(tonumber(..bot.UserName)..'dl:au/(.*)')
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("᥀ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
...
elseif DataText and DataText:match(tonumber(..bot.UserName)..'dl:vo/(.*)') then
local Url = DataText:match(tonumber(..bot.UserName)..'dl:vo/(.*)')
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("᥀ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
DeleteMessage(Chat_Id2,{[0] = MsgId2})
...
if DataText and DataText:match('/DelRed:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/DelRed:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/EndRedod:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/EndRedod:'..tonumber(..bot.UserName)..'(.*)')
local List = DevRio:smembers(David..'Rio:Text:GpTexts'..Rio..data.chat_id_)
if DevRio:get(David..'Rio:Add:GpRedod'..bot.UserName..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, " ◉⤈ تم انهاء وحفظ ↫ "..#List.." من الردود المتعدده للامر ↫ "..Rio) 
DevRio:del(David..'Rio:Add:GpRedod'..bot.UserName..data.chat_id_)
else
EditMsg(Chat_Id2, Msg_Id2, " ◉⤈ عذرا صلاحية الامر منتهيه !") 
end
end
if DataText and DataText:match('/DelRedod:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/DelRedod:'..tonumber(..bot.UserName)..'(.*)')
if DevRio:get(David..'Rio:Add:GpRedod'..bot.UserName..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, " ◉⤈ تم الغاء عملية حفظ الردود المتعدده للامر ↫ "..Rio) 
DevRio:del(David..'Rio:Add:GpRedod'..bot.UserName..data.chat_id_)
DevRio:del(David..'Rio:Text:GpTexts'..Rio..data.chat_id_)
DevRio:del(David..'Rio:Add:GpTexts'..bot.UserName..data.chat_id_)
DevRio:srem(David..'Rio:Manager:GpRedod'..data.chat_id_,Rio)
else
EditMsg(Chat_Id2, Msg_Id2, " ◉⤈ عذرا صلاحية الامر منتهيه !") 
end
end
if DataText and DataText:match('/DelKt:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/DelKt:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/EndKt:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/EndKt:'..tonumber(..bot.UserName)..'(.*)')
local List = DevRio:smembers(David..'Rio:Text:KtTexts'..Rio..data.chat_id_)
if DevRio:get(David..'Rio:Add:Kt'..bot.UserName..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, " ◉⤈ تم انهاء وحفظ ↫ "..#List.." من الاسئله للامر ↫ "..Rio) 
DevRio:del(David..'Rio:Add:Kt'..bot.UserName..data.chat_id_)
else
EditMsg(Chat_Id2, Msg_Id2, " ◉⤈ عذرا صلاحية الامر منتهيه !") 
end
end
if DataText and DataText:match('/DelAllKt:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/DelAllKt:'..tonumber(..bot.UserName)..'(.*)')
if DevRio:get(David..'Rio:Add:Kt'..bot.UserName..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, " ◉⤈ تم الغاء عملية حفظ الاسئله للامر ↫ "..Rio) 
DevRio:del(David..'Rio:Add:Kt'..bot.UserName..data.chat_id_)
DevRio:del(David..'Rio:Text:KtTexts'..Rio..data.chat_id_)
DevRio:del(David..'Rio:Add:KtTexts'..bot.UserName..data.chat_id_)
DevRio:srem(David..'Rio:Sudo:Kt'..data.chat_id_,Rio)
else
EditMsg(Chat_Id2, Msg_Id2, " ◉⤈ عذرا صلاحية الامر منتهيه !") 
end
...
--     Source David     --
if DataText and DataText:match('/Song:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/Song:'..tonumber(..bot.UserName)..'(.*)')
Rio = math.random(4,2824); 
local Text ='* ◉⤈ تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/Song:"..bot.UserName}},{{text="• Ch BlAcK • •",url="t.me/BLACK_TEAM_4"}}} 
...
--     Source David     --
if DataText and DataText:match('/mp3:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/mp3:'..tonumber(..bot.UserName)..'(.*)')
Rio = math.random(2,1167); 
local Text ='* ◉⤈ تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/mp3:"..bot.UserName}},{{text="• Ch BlAcK • •",url="t.me/BLACK_TEAM_4"}}} 
...
--     Source David     --
if DataText and DataText:match('/memz:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/memz:'..tonumber(..bot.UserName)..'(.*)')
Rio = math.random(2,1201); 
local Text ='* ◉⤈ تم اختيار مقطع الميمز لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/memz:"..bot.UserName}},{{text="• Ch BlAcK • •",url="t.me/BLACK_TEAM_4"}}} 
...
--     Source David     --
if DataText and DataText:match('/gif:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/gif:'..tonumber(..bot.UserName)..'(.*)')
Rio = math.random(2,1075); 
local Text ='* ◉⤈ تم اختيار المتحركه لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/gif:"..bot.UserName}},{{text="• Ch BlAcK • •",url="t.me/BLACK_TEAM_4"}}} 
...
--     Source David     --
if DataText and DataText:match('/photo:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/photo:'..tonumber(..bot.UserName)..'(.*)')
Rio = math.random(4,1171); 
local Text ='* ◉⤈ تم اختيار الصوره لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/photo:"..bot.UserName}},{{text="• Ch BlAcK • •",url="t.me/BLACK_TEAM_4"}}} 
...
--     Source David     --
if DataText and DataText:match('/anime:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/anime:'..tonumber(..bot.UserName)..'(.*)')
Rio = math.random(3,1002); 
local Text ='* ◉⤈ تم اختيار صورة الانمي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/anime:"..bot.UserName}},{{text="• Ch BlAcK • •",url="t.me/BLACK_TEAM_4"}}} 
...
--     Source David     --
if DataText and DataText:match(tonumber(..bot.UserName)..':SetMem:(.*)') then
local RioId = DataText:match(tonumber(..bot.UserName)..':SetMem:(.*)')
...
elseif DataText and DataText:match(tonumber(..bot.UserName)..':SetCleaner:(.*)') then
local RioId = DataText:match(tonumber(..bot.UserName)..':SetCleaner:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(David..'Rio:Cleaner:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,' ◉⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'BLACK_TEAM_4')..')\n ◉⤈ تم رفعه في قائمة المنظفين')
end,nil)
elseif DataText and DataText:match(tonumber(..bot.UserName)..':SetAdmin:(.*)') then
local RioId = DataText:match(tonumber(..bot.UserName)..':SetAdmin:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(David..'Rio:Admins:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,' ◉⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'BLACK_TEAM_4')..')\n ◉⤈ تم رفعه في قائمة الادمنيه')
end,nil)
elseif DataText and DataText:match(tonumber(..bot.UserName)..':SetManager:(.*)') then
local RioId = DataText:match(tonumber(..bot.UserName)..':SetManager:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(David..'Rio:Managers:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,' ◉⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'BLACK_TEAM_4')..')\n ◉⤈ تم رفعه في قائمة المدراء')
end,nil)
elseif DataText and DataText:match(tonumber(..bot.UserName)..':SetConstructor:(.*)') then
local RioId = DataText:match(tonumber(..bot.UserName)..':SetConstructor:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(David..'Rio:Constructor:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,' ◉⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'BLACK_TEAM_4')..')\n ◉⤈ تم رفعه في قائمة المنشئين')
end,nil)
elseif DataText and DataText:match(tonumber(..bot.UserName)..':SetBasicConstructor:(.*)') then
local RioId = DataText:match(tonumber(..bot.UserName)..':SetBasicConstructor:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(David..'Rio:BasicConstructor:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,' ◉⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'BLACK_TEAM_4')..')\n ◉⤈ تم رفعه في قائمة المنشئين الاساسيين')
end,nil)
elseif DataText and DataText:match(tonumber(..bot.UserName)..':SetOwner:(.*)') then
local RioId = DataText:match(tonumber(..bot.UserName)..':SetOwner:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(David..'Rio:RioConstructor:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,' ◉⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'BLACK_TEAM_4')..')\n ◉⤈ تم رفعه في قائمة المالكين')
end,nil)
elseif DataText and DataText:match(tonumber(..bot.UserName)..':SetSudoBot:(.*)') then
local RioId = DataText:match(tonumber(..bot.UserName)..':SetSudoBot:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(David..'Rio:SudoBot:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,' ◉⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'BLACK_TEAM_4')..')\n ◉⤈ تم رفعه في قائمة المطورين')
end,nil)
elseif DataText and DataText:match(tonumber(..bot.UserName)..':SetSecondSudo:(.*)') then
local RioId = DataText:match(tonumber(..bot.UserName)..':SetSecondSudo:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:sadd(David..'Rio:SecondSudo:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,' ◉⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'BLACK_TEAM_4')..')\n ◉⤈ تم رفعه في قائمة المطورين الثانويين')
end,nil)
elseif DataText and DataText:match(tonumber(..bot.UserName)..':SetRioSudo:(.*)') then
local RioId = DataText:match(tonumber(..bot.UserName)..':SetRioSudo:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
...
--     Source David     --
if DataText and DataText:match(tonumber(..bot.UserName)..':RemMem:(.*)') then
local RioId = DataText:match(tonumber(..bot.UserName)..':RemMem:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(David..'Rio:VipMem:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,' ◉⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'BLACK_TEAM_4')..')\n ◉⤈ تم تنزيله في قائمة المميزين')
end,nil)
elseif DataText and DataText:match(tonumber(..bot.UserName)..':RemCleaner:(.*)') then
local RioId = DataText:match(tonumber(..bot.UserName)..':RemCleaner:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(David..'Rio:Cleaner:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,' ◉⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'BLACK_TEAM_4')..')\n ◉⤈ تم تنزيله في قائمة المنظفين')
end,nil)
elseif DataText and DataText:match(tonumber(..bot.UserName)..':RemAdmin:(.*)') then
local RioId = DataText:match(tonumber(..bot.UserName)..':RemAdmin:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(David..'Rio:Admins:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,' ◉⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'BLACK_TEAM_4')..')\n ◉⤈ تم تنزيله في قائمة الادمنيه')
end,nil)
elseif DataText and DataText:match(tonumber(..bot.UserName)..':RemManager:(.*)') then
local RioId = DataText:match(tonumber(..bot.UserName)..':RemManager:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(David..'Rio:Managers:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,' ◉⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'BLACK_TEAM_4')..')\n ◉⤈ تم تنزيله في قائمة المدراء')
end,nil)
elseif DataText and DataText:match(tonumber(..bot.UserName)..':RemConstructor:(.*)') then
local RioId = DataText:match(tonumber(..bot.UserName)..':RemConstructor:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(David..'Rio:Constructor:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,' ◉⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'BLACK_TEAM_4')..')\n ◉⤈ تم تنزيله في قائمة المنشئين')
end,nil)
elseif DataText and DataText:match(tonumber(..bot.UserName)..':RemBasicConstructor:(.*)') then
local RioId = DataText:match(tonumber(..bot.UserName)..':RemBasicConstructor:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(David..'Rio:BasicConstructor:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,' ◉⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'BLACK_TEAM_4')..')\n ◉⤈ تم تنزيله في قائمة المنشئين الاساسيين')
end,nil)
elseif DataText and DataText:match(tonumber(..bot.UserName)..':RemOwner:(.*)') then
local RioId = DataText:match(tonumber(..bot.UserName)..':RemOwner:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(David..'Rio:RioConstructor:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,' ◉⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'BLACK_TEAM_4')..')\n ◉⤈ تم تنزيله في قائمة المالكين')
end,nil)
elseif DataText and DataText:match(tonumber(..bot.UserName)..':RemSudoBot:(.*)') then
local RioId = DataText:match(tonumber(..bot.UserName)..':RemSudoBot:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(David..'Rio:SudoBot:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,' ◉⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'BLACK_TEAM_4')..')\n ◉⤈ تم تنزيله في قائمة المطورين')
end,nil)
elseif DataText and DataText:match(tonumber(..bot.UserName)..':RemSecondSudo:(.*)') then
local RioId = DataText:match(tonumber(..bot.UserName)..':RemSecondSudo:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(David..'Rio:SecondSudo:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,' ◉⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'BLACK_TEAM_4')..')\n ◉⤈ تم تنزيله في قائمة المطورين الثانويين')
end,nil)
elseif DataText and DataText:match(tonumber(..bot.UserName)..':RemRioSudo:(.*)') then
local RioId = DataText:match(tonumber(..bot.UserName)..':RemRioSudo:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
...
--     Source David     --
if DataText and DataText:match(tonumber(..bot.UserName)..':Ban:(.*)') then
local RioId = DataText:match(tonumber(..bot.UserName)..':Ban:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
if dp.id_ then
...
if DataText and DataText:match(tonumber(..bot.UserName)..':UnBan:(.*)') then
local RioId = DataText:match(tonumber(..bot.UserName)..':UnBan:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
...
if DataText and DataText:match(tonumber(..bot.UserName)..':Mute:(.*)') then
local RioId = DataText:match(tonumber(..bot.UserName)..':Mute:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
if dp.id_ then
if RankChecking(dp.id_, data.chat_id_) then
...
if DataText and DataText:match(tonumber(..bot.UserName)..':UnMute:(.*)') then
local RioId = DataText:match(tonumber(..bot.UserName)..':UnMute:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
DevRio:srem(David..'Rio:Muted:'..data.chat_id_, dp.id_)
EditMsg(Chat_Id2, Msg_Id2,' ◉⤈ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'BLACK_TEAM_4')..')\n ◉⤈ تم الغاء كتمه')
end,nil)
end
if DataText and DataText:match(tonumber(..bot.UserName)..':UnAll:(.*)') then
local RioId = DataText:match(tonumber(..bot.UserName)..':UnAll:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
...
if DataText and DataText:match(tonumber(..bot.UserName)..':Tkeed:(.*)') then
local RioId = DataText:match(tonumber(..bot.UserName)..':Tkeed:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
if dp.id_ then
if RankChecking(dp.id_, data.chat_id_) then
...
if DataText and DataText:match(tonumber(..bot.UserName)..':UnTkeed:(.*)') then
local RioId = DataText:match(tonumber(..bot.UserName)..':UnTkeed:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = RioId},function(arg,dp) 
...
--     Source David     --
if DataText and DataText:match(tonumber(..bot.UserName)..':SetList:(.*)') then
local Rio = DataText:match(tonumber(..bot.UserName)..':SetList:(.*)')
...
keyboard = {} 
if Sudo(data) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=..bot.UserName..":SetMem:"..Rio},{text="• رفع ادمن •",callback_data=..bot.UserName..":SetAdmin:"..Rio}},{{text="• رفع منشئ •",callback_data=..bot.UserName..":SetConstructor:"..Rio},{text="• رفع مدير •",callback_data=..bot.UserName..":SetManager:"..Rio}},{{text="• رفع منظف •",callback_data=..bot.UserName..":SetCleaner:"..Rio},{text="• رفع منشئ اساسي •",callback_data=..bot.UserName..":SetBasicConstructor:"..Rio}},{{text="• رفع مالك •",callback_data=..bot.UserName..":SetOwner:"..Rio},{text="• رفع مطور •",callback_data=..bot.UserName..":SetSudoBot:"..Rio}},{{text="• رفع مطور ثانوي •",callback_data=..bot.UserName..":SetSecondSudo:"..Rio},{text="• رفع مطور اساسي •",callback_data=..bot.UserName..":SetRioSudo:"..Rio}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif RioSudo(data) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=..bot.UserName..":SetMem:"..Rio},{text="• رفع ادمن •",callback_data=..bot.UserName..":SetAdmin:"..Rio}},{{text="• رفع منشئ •",callback_data=..bot.UserName..":SetConstructor:"..Rio},{text="• رفع مدير •",callback_data=..bot.UserName..":SetManager:"..Rio}},{{text="• رفع منظف •",callback_data=..bot.UserName..":SetCleaner:"..Rio},{text="• رفع منشئ اساسي •",callback_data=..bot.UserName..":SetBasicConstructor:"..Rio}},{{text="• رفع مالك •",callback_data=..bot.UserName..":SetOwner:"..Rio},{text="• رفع مطور •",callback_data=..bot.UserName..":SetSudoBot:"..Rio}},{{text="• رفع مطور ثانوي •",callback_data=..bot.UserName..":SetSecondSudo:"..Rio}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif SecondSudo(data) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=..bot.UserName..":SetMem:"..Rio},{text="• رفع ادمن •",callback_data=..bot.UserName..":SetAdmin:"..Rio}},{{text="• رفع منشئ •",callback_data=..bot.UserName..":SetConstructor:"..Rio},{text="• رفع مدير •",callback_data=..bot.UserName..":SetManager:"..Rio}},{{text="• رفع منظف •",callback_data=..bot.UserName..":SetCleaner:"..Rio},{text="• رفع منشئ اساسي •",callback_data=..bot.UserName..":SetBasicConstructor:"..Rio}},{{text="• رفع مالك •",callback_data=..bot.UserName..":SetOwner:"..Rio},{text="• رفع مطور •",callback_data=..bot.UserName..":SetSudoBot:"..Rio}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif SudoBot(data) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=..bot.UserName..":SetMem:"..Rio},{text="• رفع ادمن •",callback_data=..bot.UserName..":SetAdmin:"..Rio}},{{text="• رفع منشئ •",callback_data=..bot.UserName..":SetConstructor:"..Rio},{text="• رفع مدير •",callback_data=..bot.UserName..":SetManager:"..Rio}},{{text="• رفع منظف •",callback_data=..bot.UserName..":SetCleaner:"..Rio},{text="• رفع منشئ اساسي •",callback_data=..bot.UserName..":SetBasicConstructor:"..Rio}},{{text="• رفع مالك •",callback_data=..bot.UserName..":SetOwner:"..Rio}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif RioConstructor(data) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=..bot.UserName..":SetMem:"..Rio},{text="• رفع ادمن •",callback_data=..bot.UserName..":SetAdmin:"..Rio}},{{text="• رفع منشئ •",callback_data=..bot.UserName..":SetConstructor:"..Rio},{text="• رفع مدير •",callback_data=..bot.UserName..":SetManager:"..Rio}},{{text="• رفع منظف •",callback_data=..bot.UserName..":SetCleaner:"..Rio},{text="• رفع منشئ اساسي •",callback_data=..bot.UserName..":SetBasicConstructor:"..Rio}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif BasicConstructor(data) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=..bot.UserName..":SetMem:"..Rio},{text="• رفع ادمن •",callback_data=..bot.UserName..":SetAdmin:"..Rio}},{{text="• رفع منشئ •",callback_data=..bot.UserName..":SetConstructor:"..Rio},{text="• رفع مدير •",callback_data=..bot.UserName..":SetManager:"..Rio}},{{text="• رفع منظف •",callback_data=..bot.UserName..":SetCleaner:"..Rio}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=..bot.UserName..":SetMem:"..Rio},{text="• رفع ادمن •",callback_data=..bot.UserName..":SetAdmin:"..Rio}},{{text="• رفع منظف •",callback_data=..bot.UserName..":SetCleaner:"..Rio},{text="• رفع مدير •",callback_data=..bot.UserName..":SetManager:"..Rio}},{{text = '• David TeAM •',url="t.me/BLACK_TEAM_4"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=..bot.UserName..":SetMem:"..Rio},{text="• رفع ادمن •",callback_data=..bot.UserName..":SetAdmin:"..Rio}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=..bot.UserName..":SetMem:"..Rio}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
end
...
--     Source David     --
if DataText and DataText:match(tonumber(..bot.UserName)..':RemList:(.*)') then
local Rio = DataText:match(tonumber(..bot.UserName)..':RemList:(.*)')
tdcli_function ({ID = "GetUser",user_id_ = Rio},function(arg,dp) 
if dp.first_name_ == false then
Dev_Rio(data.chat_id_, data.id_, 1, " ◉⤈ الحساب محذوف", 1, "md")
return false  
...
keyboard = {} 
if Sudo(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=..bot.UserName..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=..bot.UserName..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=..bot.UserName..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=..bot.UserName..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=..bot.UserName..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=..bot.UserName..":RemBasicConstructor:"..Rio}},{{text="• تنزيل مالك •",callback_data=..bot.UserName..":RemOwner:"..Rio},{text="• تنزيل مطور •",callback_data=..bot.UserName..":RemSudoBot:"..Rio}},{{text="• تنزيل مطور ثانوي •",callback_data=..bot.UserName..":RemSecondSudo:"..Rio},{text="• تنزيل مطور اساسي •",callback_data=..bot.UserName..":RemRioSudo:"..Rio}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif RioSudo(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=..bot.UserName..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=..bot.UserName..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=..bot.UserName..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=..bot.UserName..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=..bot.UserName..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=..bot.UserName..":RemBasicConstructor:"..Rio}},{{text="• تنزيل مالك •",callback_data=..bot.UserName..":RemOwner:"..Rio},{text="• تنزيل مطور •",callback_data=..bot.UserName..":RemSudoBot:"..Rio}},{{text="• تنزيل مطور ثانوي •",callback_data=..bot.UserName..":RemSecondSudo:"..Rio}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif SecondSudo(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=..bot.UserName..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=..bot.UserName..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=..bot.UserName..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=..bot.UserName..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=..bot.UserName..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=..bot.UserName..":RemBasicConstructor:"..Rio}},{{text="• تنزيل مالك •",callback_data=..bot.UserName..":RemOwner:"..Rio},{text="• تنزيل مطور •",callback_data=..bot.UserName..":RemSudoBot:"..Rio}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif SudoBot(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=..bot.UserName..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=..bot.UserName..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=..bot.UserName..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=..bot.UserName..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=..bot.UserName..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=..bot.UserName..":RemBasicConstructor:"..Rio}},{{text="• تنزيل مالك •",callback_data=..bot.UserName..":RemOwner:"..Rio}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif Owner(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=..bot.UserName..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=..bot.UserName..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=..bot.UserName..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=..bot.UserName..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=..bot.UserName..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=..bot.UserName..":RemBasicConstructor:"..Rio}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif BasicConstructor(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=..bot.UserName..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=..bot.UserName..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=..bot.UserName..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=..bot.UserName..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=..bot.UserName..":RemCleaner:"..Rio}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=..bot.UserName..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=..bot.UserName..":RemAdmin:"..Rio}},{{text="• تنزيل منظف •",callback_data=..bot.UserName..":RemCleaner:"..Rio},{text="• تنزيل مدير •",callback_data=..bot.UserName..":RemManager:"..Rio}},{{text = '• David TeAM •',url="t.me/BLACK_TEAM_4"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=..bot.UserName..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=..bot.UserName..":RemAdmin:"..Rio}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=..bot.UserName..":RemMem:"..Rio}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
end
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
end
...
if tonumber(Rio) == tonumber(..bot.UserName) then
...
* ◉⤈ يمكنك مسح رتب المجموعه من خلال الازرار اسفل*
 ◉○━━━━ BlAcK  ◉━━━━○ ◉
 ◉⤈ [Ch BlAcK ](https://t.me/BLACK_TEAM_4)
]] 
keyboard = {} 
if Sudo(data) then
keyboard.inline_keyboard = {{{text="• مسح الاساسيين •",callback_data="/DelRioSudo:"..bot.UserName},{text="• مسح الثانويين •",callback_data="/DelSecondSudo:"..bot.UserName}},{{text="• مسح المطورين •",callback_data="/DelSudoBot:"..bot.UserName},{text="• مسح المالكين •",callback_data="/DelOwner:"..bot.UserName}},{{text="• مسح المنشئين الاساسيين •",callback_data="/DelBasicConstructor:"..bot.UserName},{text="• مسح المنشئين •",callback_data="/DelConstructor:"..bot.UserName}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..bot.UserName},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..bot.UserName}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..bot.UserName}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif RioSudo(data) then
keyboard.inline_keyboard = {{{text="• مسح الثانويين •",callback_data="/DelSecondSudo:"..bot.UserName}},{{text="• مسح المطورين •",callback_data="/DelSudoBot:"..bot.UserName},{text="• مسح المالكين •",callback_data="/DelOwner:"..bot.UserName}},{{text="• مسح المنشئين الاساسيين •",callback_data="/DelBasicConstructor:"..bot.UserName},{text="• مسح المنشئين •",callback_data="/DelConstructor:"..bot.UserName}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..bot.UserName},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..bot.UserName}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..bot.UserName}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif SecondSudo(data) then
keyboard.inline_keyboard = {{{text="• مسح المطورين •",callback_data="/DelSudoBot:"..bot.UserName},{text="• مسح المالكين •",callback_data="/DelOwner:"..bot.UserName}},{{text="• مسح المنشئين الاساسيين •",callback_data="/DelBasicConstructor:"..bot.UserName},{text="• مسح المنشئين •",callback_data="/DelConstructor:"..bot.UserName}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..bot.UserName},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..bot.UserName}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..bot.UserName}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif SudoBot(data) then
keyboard.inline_keyboard = {{{text="• مسح المالكين •",callback_data="/DelOwner:"..bot.UserName}},{{text="• مسح المنشئين الاساسيين •",callback_data="/DelBasicConstructor:"..bot.UserName},{text="• مسح المنشئين •",callback_data="/DelConstructor:"..bot.UserName}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..bot.UserName},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..bot.UserName}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..bot.UserName}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif Owner(data) then
keyboard.inline_keyboard = {{{text="• مسح المنشئين الاساسيين •",callback_data="/DelBasicConstructor:"..bot.UserName},{text="• مسح المنشئين •",callback_data="/DelConstructor:"..bot.UserName}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..bot.UserName},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..bot.UserName}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..bot.UserName}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif BasicConstructor(data) then
keyboard.inline_keyboard = {{{text="• مسح المنشئين •",callback_data="/DelConstructor:"..bot.UserName}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..bot.UserName},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..bot.UserName}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..bot.UserName}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="• مسح المدراء •",callback_data="/DelManagers:"..bot.UserName},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..bot.UserName}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..bot.UserName}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..bot.UserName}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..bot.UserName}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="• مسح المميزين •",callback_data="/DelVipMem:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..bot.UserName}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
end
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
if Sudo(data) then
if DataText and DataText:match('/DelRioSudo:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/DelRioSudo:'..tonumber(..bot.UserName)..'(.*)')
DevRio:del(David..'Rio:RioSudo:')
Text = "* ◉⤈ تم حذف الاساسيين*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..bot.UserName}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
if RioSudo(data) then
if DataText and DataText:match('/DelSecondSudo:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/DelSecondSudo:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/DelSudoBot:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/DelSudoBot:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/DelOwner:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/DelOwner:'..tonumber(..bot.UserName)..'(.*)')
...
if Owner(data) then
if DataText and DataText:match('/DelBasicConstructor:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/DelBasicConstructor:'..tonumber(..bot.UserName)..'(.*)')
DevRio:del(David..'Rio:UsersMsgs'..data.chat_id_..':'..bot.UserName)
...
if DataText and DataText:match('/DelConstructor:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/DelConstructor:'..tonumber(..bot.UserName)..'(.*)')
DevRio:del(David..'Rio:Constructor:'..data.chat_id_)
Text = "* ◉⤈ تم حذف المنشئين*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..bot.UserName}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
if Constructor(data) then
if DataText and DataText:match('/DelManager:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/DelManager:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/DelAdmins:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/DelAdmins:'..tonumber(..bot.UserName)..'(.*)')
...
if Admin(data) then
if DataText and DataText:match('/DelVipMem:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/DelVipMem:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/DelCleanr:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/DelCleanr:'..tonumber(..bot.UserName)..'(.*)')
...
if Admin(data) then
if DataText and DataText:match('/DelMute:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/DelMute:'..tonumber(..bot.UserName)..'(.*)')
DevRio:del(David..'Rio:Muted:'..data.chat_id_)
Text = "* ◉⤈ تم حذف المكتومين*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if DataText and DataText:match('/DelKeed:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/DelKeed:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/DelBan:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/DelBan:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/DelListAll:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/DelListAll:'..tonumber(..bot.UserName)..'(.*)')
...
--     Source David     --
if DataText and DataText:match('/DelGpRed:'..tonumber(..bot.UserName)..'(.*)') and not DevRio:get(David..'Rio:Lock:GpRd'..data.chat_id_) then
local Rio = DataText:match('/DelGpRed:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/DelGpRedAll:'..tonumber(..bot.UserName)..'(.*)') and not DevRio:get(David..'Rio:Lock:GpRd'..data.chat_id_) then
local Rio = DataText:match('/DelGpRedAll:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/ChangeRed:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/ChangeRed:'..tonumber(..bot.UserName)..'(.*)')
...
DevRio:set(David..'Rio:Add:GpRed'..bot.UserName..data.chat_id_,'SetGpRed')
EditMsg(Chat_Id2, Msg_Id2, " ◉⤈ حسنا ارسل الكلمه الان") 
return false
end end
if text and text:match("^(.*)$") then
local SetGpRed = DevRio:get(David..'Rio:Add:GpRed'..bot.UserName..data.chat_id_)
if SetGpRed == 'SetGpRed' then
if text == "الغاء" then 
Dev_Rio(data.chat_id_, data.id_, 1, " ◉⤈ تم الغاء الامر" ,  1, "md")
DevRio:del(David..'Rio:Add:GpRed'..bot.UserName..data.chat_id_)
return false
end
Text = " ◉⤈ ارسل لي الرد سواء كان ↫ ⤈\n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n ◉⤈ يمكنك اضافة الى النص ↫ ⤈\n ◉○━━━━ BlAcK  ◉━━━━○ ◉\n `#username` ↬ معرف المستخدم\n `#msgs` ↬ عدد الرسائل\n `#name` ↬ اسم المستخدم\n `#id` ↬ ايدي المستخدم\n `#stast` ↬ رتبة المستخدم\n `#edit` ↬ عدد السحكات\n ◉○━━━━ BlAcK  ◉━━━━○ ◉\n ◉⤈ للخروج ارسل ↫ ( الغاء )\n ✓"
DevRio:set(David..'Rio:Add:GpRed'..bot.UserName..data.chat_id_,'SaveGpRed')
DevRio:set(David..'Rio:Add:GpText'..bot.UserName..data.chat_id_,text)
DevRio:sadd(David..'Rio:Manager:GpRed'..data.chat_id_,text)
DevRio:set(David..'DelManagerRep'..data.chat_id_,text)
keyboard = {} 
keyboard.inline_keyboard = {{{text="• تغير الرد •",callback_data="/ChangeRed:"..bot.UserName}},{{text="• الغاء •",callback_data="/CancelRed:"..bot.UserName}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text or redod).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end end
--     Source David     --
if DataText and DataText:match('/ChangeAllRed:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/ChangeAllRed:'..tonumber(..bot.UserName)..'(.*)')
if not Bot(data) and DevRio:get(David..'Rio:Lock:Rd'..data.chat_id_) then 
...
DevRio:set(David.."Rio:Add:AllRed"..bot.UserName,'SetAllRed')
EditMsg(Chat_Id2, Msg_Id2, " ◉⤈ حسنا ارسل الكلمه الان") 
return false
end end
if text and text:match("^(.*)$") then
local SetAllRed = DevRio:get(David.."Rio:Add:AllRed"..bot.UserName)
if SetAllRed == 'SetAllRed' then
if text == "الغاء" then 
EditMsg(Chat_Id2, Msg_Id2, " ◉⤈ تم الغاء الامر") 
DevRio:del(David..'Rio:Add:AllRed'..bot.UserName)
return false
end
Text = " ◉⤈ ارسل لي الرد سواء كان ↫ ⤈\n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n ◉⤈ يمكنك اضافة الى النص ↫ ⤈\n ◉○━━━━ BlAcK  ◉━━━━○ ◉\n `#username` ↬ معرف المستخدم\n `#datas` ↬ عدد الرسائل\n `#name` ↬ اسم المستخدم\n `#id` ↬ ايدي المستخدم\n `#stast` ↬ رتبة المستخدم\n `#edit` ↬ عدد السحكات\n ◉○━━━━ BlAcK  ◉━━━━○ ◉\n ◉⤈ للخروج ارسل ↫ ( الغاء )\n ✓"
DevRio:set(David.."Rio:Add:AllRed"..bot.UserName,'SaveAllRed')
DevRio:set(David.."Rio:Add:AllText"..bot.UserName, text)
DevRio:sadd(David.."Rio:Sudo:AllRed",text)
DevRio:set(David.."DelSudoRep",text)
keyboard = {} 
keyboard.inline_keyboard = {{{text="• تغير الرد •",callback_data="/ChangeAllRed:"..bot.UserName}},{{text="• الغاء •",callback_data="/CancelAllRed:"..bot.UserName}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text or redod).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end end
--     Source David     --
if DataText and DataText:match('/DelCmd:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/DelCmd:'..tonumber(..bot.UserName)..'(.*)')
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName},{text="• رجوع •",callback_data="/CmdList:"..bot.UserName}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text or redod).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if DataText and DataText:match('/SetCmd:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/SetCmd:'..tonumber(..bot.UserName)..'(.*)')
...
--     Source David     --
if DataText and DataText:match('/CancelAllRed:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/CancelAllRed:'..tonumber(..bot.UserName)..'(.*)')
local DelSudoRep = DevRio:get(David..'DelSudoRep')
DevRio:del(David.."Rio:Sudo:AllRed",DelSudoRep)
DevRio:del(David.."Rio:Add:AllText"..bot.UserName)
DevRio:del(David.."Rio:Add:AllRed"..bot.UserName)
DevRio:del(David.."DelSudoRep")
Text = " ◉⤈ تم الغاء حفظ الرد"
keyboard = {} 
keyboard.inline_keyboard = {{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
if DataText and DataText:match('/CancelRed:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/CancelRed:'..tonumber(..bot.UserName)..'(.*)')
...
DevRio:del(David..'Rio:Add:GpText'..bot.UserName..data.chat_id_)
DevRio:del(David..'Rio:Add:GpRed'..bot.UserName..data.chat_id_)
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• ترتيب الاوامر •",callback_data="/SetCmd:"..bot.UserName},{text="• مسح الاوامر المضافه •",callback_data="/DelCmd:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح رسائلي •",callback_data="/DelMsg:"..bot.UserName},{text="• مسح سحكاتي •",callback_data="/DelEdit:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
...
--     Source David     --
if DataText and DataText:match('/DelEdit:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/DelEdit:'..tonumber(..bot.UserName)..'(.*)')
DevRio:del(David..'Rio:EditMsg'..data.chat_id_..':'..bot.UserName)
Text = "* ◉⤈ تم حذف جميع تعديلاتك بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• رجوع •",callback_data="/DelHome:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
--     Source David     --
if DataText and DataText:match('/DelMsg:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/DelMsg:'..tonumber(..bot.UserName)..'(.*)')
DevRio:del(David..'Rio:UsersMsgs'..data.chat_id_..':'..bot.UserName)
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المتحركات •",callback_data="/DelGif:"..bot.UserName},{text="• مسح الملصقات •",callback_data="/DelSticker:"..bot.UserName}},{{text="• مسح الصور •",callback_data="/DelPhoto:"..bot.UserName},{text="• مسح الكلمات •",callback_data="/DelTextfilter:"..bot.UserName}},{{text="• مسح قوائم المنع •",callback_data="/DelAllFilter:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
--     Source David     --
if DataText and DataText:match('/DelGif:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/DelGif:'..tonumber(..bot.UserName)..'(.*)')
DevRio:del(David.."Rio:FilterAnimation"..data.chat_id_)
Text = "* ◉⤈ تم حذف جميع المتحركات الممنوعه بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• رجوع •",callback_data="/FilterList:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if DataText and DataText:match('/DelSticker:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/DelSticker:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/DelPhoto:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/DelPhoto:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/DelTextfilter:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/DelTextfilter:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/DelAllFilter:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/DelAllFilter:'..tonumber(..bot.UserName)..'(.*)')
DevRio:del(David..'Rio:Filters:'..data.chat_id_)
DevRio:del(David.."Rio:FilterAnimation"..data.chat_id_)
DevRio:del(David.."Rio:FilterPhoto"..data.chat_id_)
DevRio:del(David.."Rio:FilterSteckr"..data.chat_id_)
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• قفل الدردشه •",callback_data="/lockText:"..bot.UserName},{text="• فتح الدردشه •",callback_data="/unlockText:"..bot.UserName}},{{text="• قفل الدخول •",callback_data="/lockjoin:"..bot.UserName},{text="• فتح الدخول •",callback_data="/unlockjoin:"..bot.UserName}},{{text="• قفل البوتات •",callback_data="/LockBotList:"..bot.UserName},{text="• فتح البوتات •",callback_data="/unlockBot:"..bot.UserName}},{{text="• قفل الاشعارات •",callback_data="/lockTagServr:"..bot.UserName},{text="• فتح الاشعارات •",callback_data="/unlockTagServr:"..bot.UserName}},{{text="• قفل التعديل •",callback_data="/lockEditMsgs:"..bot.UserName},{text="• فتح التعديل •",callback_data="/unlockEditMsgs:"..bot.UserName}},{{text="• قفل الملصقات •",callback_data="/lockStickers:"..bot.UserName},{text="• فتح الملصقات •",callback_data="/unlockStickers:"..bot.UserName}},{{text="• قفل المتحركه •",callback_data="/lockGifs:"..bot.UserName},{text="• فتح المتحركه •",callback_data="/unlockGifs:"..bot.UserName}},{{text="• قفل الفيديو •",callback_data="/lockVideos:"..bot.UserName},{text="• فتح الفيديو •",callback_data="/unlockVideos:"..bot.UserName}},{{text="• قفل الصور •",callback_data="/unlockPhoto:"..bot.UserName},{text="• فتح الصور •",callback_data="/unlockPhoto:"..bot.UserName}},{{text="• قفل التوجيه •",callback_data="/lockForwards:"..bot.UserName},{text="• فتح التوجيه •",callback_data="/unlockForwards:"..bot.UserName}},{{text="• قفل التكرار •",callback_data="/LockSpamList:"..bot.UserName},{text="• فتح التكرار •",callback_data="/unlockSpam:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName},{text="• القائمه الرئيسيه •",callback_data="/HelpList:"..bot.UserName}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
--     Source David     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• قفل البوتات بالطرد •",callback_data="/lockBotKick:"..bot.UserName},{text="• قفل البوتات بالتقيد •",callback_data="/lockBotKed:"..bot.UserName}},{{text="• قفل البوتات بالكتم •",callback_data="/lockBotDel:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName},{text="• رجوع •",callback_data="/locklist:"..bot.UserName}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
--     Source David     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• قفل التكرار بالطرد •",callback_data="/lockSpamKick:"..bot.UserName},{text="• قفل التكرار بالتقيد •",callback_data="/lockSpamKed:"..bot.UserName}},{{text="• قفل التكرار بالحذف •",callback_data="/lockSpamDel:"..bot.UserName},{text="• قفل التكرار بالكتم •",callback_data="/lockSpamMute:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName},{text="• رجوع •",callback_data="/locklist:"..bot.UserName}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
--     Source David     --
if DataText == '/lockjoin:'..bot.UserName then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName},{text="• رجوع •",callback_data="/locklist:"..bot.UserName}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
end
if DataText == '/unlockjoin:'..bot.UserName then
...
if DataText == '/lockText:'..bot.UserName then
...
if DataText == '/unlockText:'..bot.UserName then
...
if DataText == '/lockTagServr:'..bot.UserName then
...
if DataText == '/unlockTagServr:'..bot.UserName then
...
if DataText == '/lockEditMsgs:'..bot.UserName then
...
if DataText == '/unlockEditMsgs:'..bot.UserName then
...
if DataText == '/lockStickers:'..bot.UserName then
...
if DataText == '/unlockStickers:'..bot.UserName then
...
if DataText == '/lockGifs:'..bot.UserName then
...
if DataText == '/unlockGifs:'..bot.UserName then
...
if DataText == '/lockPhoto:'..bot.UserName then
...
if DataText == '/unlockPhoto:'..bot.UserName then
...
if DataText == '/lockVideos:'..bot.UserName then
...
if DataText == '/unlockVideos:'..bot.UserName then
...
if DataText == '/lockForwards:'..bot.UserName then
...
if DataText == '/unlockForwards:'..bot.UserName then
...
if DataText == '/lockBotKick:'..bot.UserName then
DevRio:set(David.."Rio:Lock:Bots"..data.chat_id_,"kick")  
Text = "* ◉⤈ تم قفل البوتات بالطرد بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName},{text="• رجوع •",callback_data="/LockBotList:"..bot.UserName}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if DataText == '/lockBotKed:'..bot.UserName then
...
if DataText == '/lockBotDel:'..bot.UserName then
...
if DataText == '/unlockBot:'..bot.UserName then
...
if DataText == '/lockSpamKick:'..bot.UserName then
DevRio:hset(David.."Rio:Spam:Group:User"..data.chat_id_ ,"Spam:User","kick")  
Text = "* ◉⤈ تم قفل التكرار بالطرد بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName},{text="• رجوع •",callback_data="/LockSpamList:"..bot.UserName}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if DataText == '/lockSpamKed:'..bot.UserName then
...
if DataText == '/lockSpamDel:'..bot.UserName then
...
if DataText == '/lockSpamMute:'..bot.UserName then
...
if DataText == '/unlockSpam:'..bot.UserName then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• تحديث السورس •",callback_data="/UpdateSource:"..bot.UserName},{text="• تحديث الملفات •",callback_data="/UpdateFile:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
--     Source David     -- 
if DataText and DataText:match('/UpdateSource:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/UpdateSource:'..tonumber(..bot.UserName)..'(.*)')
os.execute('rm -rf David.lua.lua') 
os.execute('wget https://raw.githubusercontent.com/jokerrr7/jokjtihg/main/David.lua') 
dofile('David.lua') 
io.popen("rm -rf ../.telegram-cli/*")
print("\27[31;47m\n          ( تم تحديث السورس )          \n\27[0;34;49m\n") 
Text = "* ◉⤈ تم تحديث السورس*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName},{text="• رجوع •",callback_data="/SourceList:"..bot.UserName}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if DataText and DataText:match('/UpdateFile:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/UpdateFile:'..tonumber(..bot.UserName)..'(.*)')
dofile('David.lua') 
io.popen("rm -rf ../.telegram-cli/*")
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح الميديا •",callback_data="/DelMedia:"..bot.UserName},{text="• مسح الاغاني •",callback_data="/DelMusic:"..bot.UserName}},{{text="• مسح الرسائل المعدله •",callback_data="/DelMsgEdit:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
--     Source David     -- 
if Cleaner(data) then
if DataText and DataText:match('/DelMedia:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/DelMedia:'..tonumber(..bot.UserName)..'(.*)')
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName},{text="• رجوع •",callback_data="/MediaHome:"..bot.UserName}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
if DataText and DataText:match('/DelMusic:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/DelMusic:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/DelMsgEdit:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/DelMsgEdit:'..tonumber(..bot.UserName)..'(.*)')
Rio_Del = {[0]= data.id_}
...
--     Source David     -- 
if DataText and DataText:match('/LeaveBot:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/LeaveBot:'..tonumber(..bot.UserName)..'(.*)')
...
--     Source David     -- 
if DataText and DataText:match('/Linkinline:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/Linkinline:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/LinkText:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/LinkText:'..tonumber(..bot.UserName)..'(.*)')
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• تعطيل الايدي بالصوره •",callback_data="/LockIdPhoto:"..bot.UserName},{text="• تفعيل الايدي بالصوره •",callback_data="/UnLockIdPhoto:"..bot.UserName}},{{text="• تعطيل الايدي •",callback_data="/LockId:"..bot.UserName},{text="• تفعيل الايدي •",callback_data="/UnLockId:"..bot.UserName}},{{text="• تعطيل الرابط •",callback_data="/LockGpLinks:"..bot.UserName},{text="• تفعيل الرابط •",callback_data="/UnLockGpLinks:"..bot.UserName}},{{text="• تعطيل الرابط انلاين •",callback_data="/LockGpLinksinline:"..bot.UserName},{text="• تفعيل الرابط انلاين •",callback_data="/UnLockGpLinksinline:"..bot.UserName}},{{text="• تعطيل الترحيب •",callback_data="/LockWelcome:"..bot.UserName},{text="• تفعيل الترحيب •",callback_data="/UnLockWelcome:"..bot.UserName}},{{text="• تعطيل الردود المطور •",callback_data="/LockAllRed:"..bot.UserName},{text="• تفعيل الردود المطور •",callback_data="/UnLockAllRed:"..bot.UserName}},{{text="• تعطيل ردود المدير •",callback_data="/LockGpRed:"..bot.UserName},{text="• تفعيل ردود المدير •",callback_data="/UnLockGpRed:"..bot.UserName}},{{text="• تعطيل نزلني •",callback_data="/LockDelMe:"..bot.UserName},{text="• تفعيل نزلني •",callback_data="/UnLockDelMe:"..bot.UserName}},{{text="• تعطيل اطردني •",callback_data="/LockKickMe:"..bot.UserName},{text="• تفعيل اطردني •",callback_data="/UnLockKickMe:"..bot.UserName}},{{text="• تعطيل الحظر •",callback_data="/LockKickBan:"..bot.UserName},{text="• تفعيل الحظر •",callback_data="/UnLockKickBan:"..bot.UserName}},{{text="• تعطيل الرفع •",callback_data="/LockProSet:"..bot.UserName},{text="• تفعيل الرفع •",callback_data="/UnLockProSet:"..bot.UserName}},{{text="• تعطيل الالعاب •",callback_data="/LockGames:"..bot.UserName},{text="• تفعيل الالعاب •",callback_data="/UnLockGames:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName},{text="• القائمه الرئيسيه •",callback_data="/HelpList:"..bot.UserName}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
...
--     Source David     --
if DataText and DataText:match('/LockIdPhoto:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/LockIdPhoto:'..tonumber(..bot.UserName)..'(.*)')
DevRio:set(David..'Rio:Lock:Id:Photo'..data.chat_id_,true)
Text = "* ◉⤈ تم تعطيل الايدي بالصوره*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName},{text="• رجوع •",callback_data="/lockorder:"..bot.UserName}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if DataText and DataText:match('/unLockIdPhoto:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/unLockIdPhoto:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/LockId:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/LockId:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/unLockId:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/unLockId:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/LockGpLinks:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/LockGpLinks:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/unLockGpLinks:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/unLockGpLinks:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/LockGpLinksinline:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/LockGpLinksinline:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/UnLockGpLinksinline:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/UnLockGpLinksinline:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/LockWelcome:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/LockWelcome:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/UnLockWelcome:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/UnLockWelcome:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/LockAllRed:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/LockAllRed:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/UnLockAllRed:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/UnLockAllRed:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/LockGpRed:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/LockGpRed:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/UnLockGpRed:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/UnLockGpRed:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/LockDelMe:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/LockDelMe:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/UnLockDelMe:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/UnLockDelMe:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/LockKickMe:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/LockKickMe:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/UnLockKickMe:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/UnLockKickMe:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/LockKickBan:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/LockKickBan:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/UnLockKickBan:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/UnLockKickBan:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/LockProSet:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/LockProSet:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/UnLocProSet:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/UnLocProSet:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/LockGames:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/LockGames:'..tonumber(..bot.UserName)..'(.*)')
...
if DataText and DataText:match('/UnLockGames:'..tonumber(..bot.UserName)..'(.*)') then
local Rio = DataText:match('/UnLockGames:'..tonumber(..bot.UserName)..'(.*)')
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اوامر الادمنيه •",callback_data="/HelpList2:"..bot.UserName},{text="• اوامر الحمايه •",callback_data="/HelpList1:"..bot.UserName}},{{text="• اوامر المنشئين •",callback_data="/HelpList4:"..bot.UserName},{text="• اوامر المدراء •",callback_data="/HelpList3:"..bot.UserName}},{{text="• اوامر الاعضاء •",callback_data="/HelpList6:"..bot.UserName},{text="• اوامر المطورين •",callback_data="/HelpList5:"..bot.UserName}},{{text="• اوامر الرتب •",callback_data="/DelList:"..bot.UserName}},{{text="• التفعيل و التعطيل •",callback_data="/lockorder:"..bot.UserName},{text="• القفل و الفتح •",callback_data="/locklist:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName}}}
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اوامر الادمنيه •",callback_data="/HelpList2:"..bot.UserName}},{{text="• اوامر المنشئين •",callback_data="/HelpList4:"..bot.UserName},{text="• اوامر المدراء •",callback_data="/HelpList3:"..bot.UserName}},{{text="• اوامر الاعضاء •",callback_data="/HelpList6:"..bot.UserName},{text="• اوامر المطورين •",callback_data="/HelpList5:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName}},{{text="• رجوع •",callback_data="/HelpList:"..bot.UserName}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("᥀ عذرا الامر ليس لك .")..'&show_alert=true')
end
...
keyboard = {} 
if SudoBot(data) then
keyboard.inline_keyboard = {{{text="• اوامر الحمايه •",callback_data="/HelpList1:"..bot.UserName}},{{text="• اوامر المنشئين •",callback_data="/HelpList4:"..bot.UserName},{text="• اوامر المدراء •",callback_data="/HelpList3:"..bot.UserName}},{{text="• اوامر الاعضاء •",callback_data="/HelpList6:"..bot.UserName},{text="• اوامر المطورين •",callback_data="/HelpList5:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName}},{{text="• رجوع •",callback_data="/HelpList:"..bot.UserName}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="• اوامر الحمايه •",callback_data="/HelpList1:"..bot.UserName}},{{text="• اوامر المنشئين •",callback_data="/HelpList4:"..bot.UserName},{text="• اوامر المدراء •",callback_data="/HelpList3:"..bot.UserName}},{{text="• اوامر الاعضاء •",callback_data="/HelpList6:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName}},{{text="• رجوع •",callback_data="/HelpList:"..bot.UserName}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="• اوامر الحمايه •",callback_data="/HelpList1:"..bot.UserName}},{{text="• اوامر المدراء •",callback_data="/HelpList3:"..bot.UserName}},{{text="• اوامر الاعضاء •",callback_data="/HelpList6:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName}},{{text="• رجوع •",callback_data="/HelpList:"..bot.UserName}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="• اوامر الحمايه •",callback_data="/HelpList1:"..bot.UserName}},{{text="• اوامر الاعضاء •",callback_data="/HelpList6:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName}},{{text="• رجوع •",callback_data="/HelpList:"..bot.UserName}}}
end
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("᥀ عذرا الامر ليس لك .")..'&show_alert=true')
...
keyboard = {} 
if SudoBot(data) then
keyboard.inline_keyboard = {{{text="• اوامر الادمنيه •",callback_data="/HelpList2:"..bot.UserName},{text="• اوامر الحمايه •",callback_data="/HelpList1:"..bot.UserName}},{{text="• اوامر المنشئين •",callback_data="/HelpList4:"..bot.UserName}},{{text="• اوامر الاعضاء •",callback_data="/HelpList6:"..bot.UserName},{text="• اوامر المطورين •",callback_data="/HelpList5:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName}},{{text="• رجوع •",callback_data="/HelpList:"..bot.UserName}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="• اوامر الادمنيه •",callback_data="/HelpList2:"..bot.UserName},{text="• اوامر الحمايه •",callback_data="/HelpList1:"..bot.UserName}},{{text="• اوامر المنشئين •",callback_data="/HelpList4:"..bot.UserName}},{{text="• اوامر الاعضاء •",callback_data="/HelpList6:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName}},{{text="• رجوع •",callback_data="/HelpList:"..bot.UserName}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="• اوامر الادمنيه •",callback_data="/HelpList2:"..bot.UserName},{text="• اوامر الحمايه •",callback_data="/HelpList1:"..bot.UserName}},{{text="• اوامر الاعضاء •",callback_data="/HelpList6:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName}},{{text="• رجوع •",callback_data="/HelpList:"..bot.UserName}}}
end
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("᥀ عذرا الامر ليس لك .")..'&show_alert=true')
...
keyboard = {} 
if SudoBot(data) then
keyboard.inline_keyboard = {{{text="• اوامر الادمنيه •",callback_data="/HelpList2:"..bot.UserName},{text="• اوامر الحمايه •",callback_data="/HelpList1:"..bot.UserName}},{{text="• اوامر المدراء •",callback_data="/HelpList3:"..bot.UserName}},{{text="• اوامر الاعضاء •",callback_data="/HelpList6:"..bot.UserName},{text="• اوامر المطورين •",callback_data="/HelpList5:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName}},{{text="• رجوع •",callback_data="/HelpList:"..bot.UserName}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="• اوامر الادمنيه •",callback_data="/HelpList2:"..bot.UserName},{text="• اوامر الحمايه •",callback_data="/HelpList1:"..bot.UserName}},{{text="• اوامر المدراء •",callback_data="/HelpList3:"..bot.UserName}},{{text="• اوامر الاعضاء •",callback_data="/HelpList6:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName}},{{text="• رجوع •",callback_data="/HelpList:"..bot.UserName}}}
end
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard = {} 
if SudoBot(data) then
keyboard.inline_keyboard = {{{text="• اوامر الادمنيه •",callback_data="/HelpList2:"..bot.UserName},{text="• اوامر الحمايه •",callback_data="/HelpList1:"..bot.UserName}},{{text="• اوامر المنشئين •",callback_data="/HelpList4:"..bot.UserName},{text="• اوامر المدراء •",callback_data="/HelpList3:"..bot.UserName}},{{text="• اوامر المطورين •",callback_data="/HelpList5:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName}},{{text="• رجوع •",callback_data="/HelpList:"..bot.UserName}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="• اوامر الادمنيه •",callback_data="/HelpList2:"..bot.UserName},{text="• اوامر الحمايه •",callback_data="/HelpList1:"..bot.UserName}},{{text="• اوامر المنشئين •",callback_data="/HelpList4:"..bot.UserName},{text="• اوامر المدراء •",callback_data="/HelpList3:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName}},{{text="• رجوع •",callback_data="/HelpList:"..bot.UserName}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="• اوامر الادمنيه •",callback_data="/HelpList2:"..bot.UserName},{text="• اوامر الحمايه •",callback_data="/HelpList1:"..bot.UserName}},{{text="• اوامر المدراء •",callback_data="/HelpList3:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName}},{{text="• رجوع •",callback_data="/HelpList:"..bot.UserName}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="• اوامر الادمنيه •",callback_data="/HelpList2:"..bot.UserName},{text="• اوامر الحمايه •",callback_data="/HelpList1:"..bot.UserName}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName}},{{text="• رجوع •",callback_data="/HelpList:"..bot.UserName}}}
else
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..bot.UserName}},{{text="• رجوع •",callback_data="/HelpList:"..bot.UserName}}}
end
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
return https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("᥀ عذرا الامر ليس لك .")..'&show_alert=true')
...
if text and text:match('^'..(DevRio:get(David..'Rio:NameBot') or "بلاك")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevRio:get(David..'Rio:NameBot') or "بلاك")..' ','')
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح الاوامر المضافه •",callback_data="/DelCmd:"..msg.sender_user_id_},{text="• ترتيب الاوامر •",callback_data="/SetCmd:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
...
Dev_Rio(msg.chat_id_, msg.id_, 1, ' ◉⤈ العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'BLACK_TEAM_4')..')'..' ❩\n ◉⤈ تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
...
if mrrio == "مميز" and VipMem(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, ' ◉⤈ العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'BLACK_TEAM_4')..')'..' ❩\n ◉⤈ تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
local inline = {{{text="• ᥀ المطور . •",url="t.me/"..(dp.username_ or "BLACK_TEAM_4")}},{{text="• ᥀ السورس . •",url="https://t.me/BLACK_TEAM_4"},{text="• ᥀ لتنصيب بوت . •",url="https://t.me/UUOUOU_7"}},{{text="• ᥀ اضفني في مجموعتك . •",url="t.me/"..dp.username_.."?startgroup=botstart"}}}
...
Dev_Rio(msg.sender_user_id_, msg.id_, 1, ' ◉⤈ تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "BLACK_TEAM_4")..')', 1, 'md') 
...
local BotName = (DevRio:get(David.."Rio:NameBot") or 'بلاك')
...
keyboard = {}  
keyboard.inline_keyboard = {{{text = '• Ch BlAcK  ◉ •',url="t.me/BLACK_TEAM_4"}},{{text = '• Ch JOKER  ◉ •',url="t.me/UU_KFUF"}}} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/MU_BL_K_BOT'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text and text == (DevRio:get(David..'Rio:NameBot') or 'بلاك') then 
NameBot = (DevRio:get(David..'Rio:NameBot') or 'بلاك')
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح رسائلي •",callback_data="/DelMsg:"..msg.sender_user_id_},{text="• مسح سحكاتي •",callback_data="/DelEdit:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• غنيلي •",callback_data="/Song:"..msg.sender_user_id_},{text="• اغنيه •",callback_data="/mp3:"..msg.sender_user_id_}},{{text="• متحركه •",callback_data="/gif:"..msg.sender_user_id_},{text="• صوره •",callback_data="/photo:"..msg.sender_user_id_}},{{text="• انمي •",callback_data="/anime:"..msg.sender_user_id_},{text="• ريمكس •",callback_data="/remix:"..msg.sender_user_id_}},{{text="• ميمز •",callback_data="/memz:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
if Sudo(msg) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="• تنزيل منشئ  اساسي •",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text="• تنزيل مالك •",callback_data=msg.sender_user_id_..":RemAbsConstructor:"..result.sender_user_id_},{text="• تنزيل مطور •",callback_data=msg.sender_user_id_..":RemSudoBot:"..result.sender_user_id_}},{{text="• تنزيل مطور ثانوي •",callback_data=msg.sender_user_id_..":RemSecondSudo:"..result.sender_user_id_},{text="• تنزيل مطور اساسي •",callback_data=msg.sender_user_id_..":RemRioSudo:"..result.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif RioSudo(msg) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text="• تنزيل مالك •",callback_data=msg.sender_user_id_..":RemOwner:"..Rio},{text="• تنزيل مطور •",callback_data=msg.sender_user_id_..":RemSudoBot:"..Rio}},{{text="• تنزيل مطور ثانوي •",callback_data=msg.sender_user_id_..":RemSecondSudo:"..Rio}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif SecondSudo(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text="• تنزيل مالك •",callback_data=msg.sender_user_id_..":RemOwner:"..Rio},{text="• تنزيل مطور •",callback_data=msg.sender_user_id_..":RemSudoBot:"..Rio}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif SudoBot(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text="• تنزيل مالك •",callback_data=msg.sender_user_id_..":RemOwner:"..Rio}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif Owner(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif BasicConstructor(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..Rio}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..Rio}},{{text = '• David TeAM •',url="t.me/BLACK_TEAM_4"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Rio}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
end
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text='..URL.escape(Text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الرابط نص •",callback_data="/LinkText:"..msg.sender_user_id_},{text="• الرابط انلاين •",callback_data="/Linkinline:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الالعاب المتطوره •",callback_data="/GameInline:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
...
Text = [[
Welcome To Source
 ◉⤈ [TeAm BlAcK](https://t.me/BLACK_TEAM_4)
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '᥀ Ch BlAcK ',url="https://t.me/BLACK_TEAM_4"}},{{text = '᥀ Developer',url="t.me/UUOUOU_7"}},{{text= '᥀ Developer .',url="https://t.me/V_P_E"}}}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/blacccckkko/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source David     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الغاء حظر •",callback_data=msg.sender_user_id_..":UnBan:"..result.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الغاء كتم •",callback_data=msg.sender_user_id_..":UnMute:"..result.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الغاء تقيد •",callback_data=msg.sender_user_id_..":UnTkeed:"..result.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الغاء العام •",callback_data=msg.sender_user_id_..":UnAll:"..result.sender_user_id_},{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
--     Source David     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
--     Source David     -- 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المدراء •",callback_data="/DelManagers:"..msg.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المنظفين •",callback_data="/DelCleanr:"..msg.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
--     Source David     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المنشئين •",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
--     Source David     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المالكين •",callback_data="/DelOwner:"..msg.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المكتومين •",callback_data="/DelMute:"..msg.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source David     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المقيدين •",callback_data="/DelKeed:"..msg.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source David     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المحظورين •",callback_data="/DelBan:"..msg.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source David     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح الاساسيين •",callback_data="/DelRioSudo:"..msg.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
--     Source David     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح الثانويين •",callback_data="/DelSecondSudo:"..msg.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source David     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح قائمه العام •",callback_data="/DelListAll:"..msg.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
--     Source David     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المطورين •",callback_data="/DelSudoBot:"..msg.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source David     --
...
local Text ='* ◉⤈ تم اختيار المتحركه لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/gif:"..msg.sender_user_id_}},{{text = '• 𝒄𝒉 BlAcK  ◉ •',url="t.me/BLACK_TEAM_4"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='* ◉⤈ تم اختيار مقطع الميمز لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/memz:"..msg.sender_user_id_}},{{text = '• 𝒄𝒉 BlAcK  ◉ •',url="t.me/BLACK_TEAM_4"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='* ◉⤈ تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/Song:"..msg.sender_user_id_}},{{text = '• 𝒄𝒉 BlAcK  ◉ •',url="t.me/BLACK_TEAM_4"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/mp3:"..msg.sender_user_id_}},{{text = '• 𝒄𝒉 BlAcK  ◉ •',url="t.me/BLACK_TEAM_4"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/remix:"..msg.sender_user_id_}},{{text = '• 𝒄𝒉 BlAcK  ◉ •',url="t.me/BLACK_TEAM_4"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='* ◉⤈ تم اختيار الصوره لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/photo:"..msg.sender_user_id_}},{{text = '• 𝒄𝒉 BlAcK  ◉ •',url="t.me/BLACK_TEAM_4"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='* ◉⤈ تم اختيار صورة الانمي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/anime:"..msg.sender_user_id_}},{{text = '• 𝒄𝒉 BlAcK  ◉ •',url="t.me/BLACK_TEAM_4"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/Movies:"..msg.sender_user_id_}},{{text = '• 𝒄𝒉 BlAcK  ◉ •',url="t.me/BLACK_TEAM_4"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/series:"..msg.sender_user_id_}},{{text = '• 𝒄𝒉 BlAcK  ◉ •',url="t.me/BLACK_TEAM_4"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• تغير الرد •",callback_data="/ChangeRed:"..msg.sender_user_id_}},{{text="• الغاء •",callback_data="/CancelRed:"..msg.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(Text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end end
...
DevRio:set(David.."DelSudoRep",text)
keyboard = {} 
keyboard.inline_keyboard = {{{text="• تغير الرد •",callback_data="/ChangeAllRed:"..msg.sender_user_id_}},{{text="• الغاء •",callback_data="/CancelAllRed:"..msg.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(Text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح ردود المدير •",callback_data="/DelGpRed:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح ردود المطور •",callback_data="/DelGpRedAll:"..msg.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
if Sudo(msg) then
keyboard.inline_keyboard = {{{text="• مسح الاساسيين •",callback_data="/DelRioSudo:"..msg.sender_user_id_},{text="• مسح الثانويين •",callback_data="/DelSecondSudo:"..msg.sender_user_id_}},{{text="• مسح المطورين •",callback_data="/DelSudoBot:"..msg.sender_user_id_},{text="• مسح المالكين •",callback_data="/DelOwner:"..msg.sender_user_id_}},{{text="• مسح المنشئين الاساسيين •",callback_data="/DelBasicConstructor:"..msg.sender_user_id_},{text="• مسح المنشئين •",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..msg.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif RioSudo(msg) then
keyboard.inline_keyboard = {{{text="• مسح الثانويين •",callback_data="/DelSecondSudo:"..msg.sender_user_id_}},{{text="• مسح المطورين •",callback_data="/DelSudoBot:"..msg.sender_user_id_},{text="• مسح المالكين •",callback_data="/DelOwner:"..msg.sender_user_id_}},{{text="• مسح المنشئين الاساسيين •",callback_data="/DelBasicConstructor:"..msg.sender_user_id_},{text="• مسح المنشئين •",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..msg.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif SecondSudo(msg) then
...
keyboard.inline_keyboard = {{{text="• مسح المنشئين الاساسيين •",callback_data="/DelBasicConstructor:"..msg.sender_user_id_},{text="• مسح المنشئين •",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..msg.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif BasicConstructor(msg) then
keyboard.inline_keyboard = {{{text="• مسح المنشئين •",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..msg.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif Constructor(msg) then
keyboard.inline_keyboard = {{{text="• مسح المدراء •",callback_data="/DelManagers:"..msg.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif Manager(msg) then
keyboard.inline_keyboard = {{{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
elseif Admin(msg) then
keyboard.inline_keyboard = {{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• Ch BlAcK •',url="t.me/BLACK_TEAM_4"}}}
end
Msg_id = msg.id_/2097152/0.5
...
local msg_id = msg.id_/2097152/0.5 
https.request('https://blackhackk.cf/api-youtube.php?Put=Search&TokenBot='..TokenBot..'&ChatId='..msg.chat_id_..'&UserId='..msg.sender_user_id_..'&Text='..URL.escape(Text)..'&MsgId='..msg_id..'&Name='..DirName)
end
--     Source David     --
if SecondSudo(msg) then
if text == "تحديث السورس" and ChCheck(msg) or text == "تحديث سورس" and ChCheck(msg) or text == "↫ تحديث السورس ᥀" and ChCheck(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, ' ◉⤈ جاري تحديث سورس بلاك', 1, 'md') 
os.execute('rm -rf David.lua.lua') 
os.execute('wget https://raw.githubusercontent.com/jokerrr7/jokjtihg/main/David.lua') 
dofile('David.lua') 
io.popen("rm -rf ../.telegram-cli/*")
...
DevRio:set(David..'Rio:NameBot',(DevRio:get(David..'Name:Bot') or 'بلاك'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '᥀ قناة السورس',url="t.me/BLACK_TEAM_4"}}}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '᥀ مبرمج السورس',url="t.me/UUOUOU_7"}}}
local msg_id = msg.id_/2097152/0.5
