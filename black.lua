...
--   This Is The ⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎ @BLACK_TEAM_4 .   --
--                - black -                 --
...
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𐇮︰[⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎](https://t.me/BLACK_TEAM_4)
]] 
keyboard = {} 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="‹ ترتيب الاوامر ›",callback_data="/SetCmdGp:"..data.sender_user_id_},{text="‹ رفع الادمنيه ›",callback_data="/UploadAdmin:"..data.sender_user_id_}},{{text="‹ غادر ›",callback_data="/LeaveBot:"..data.sender_user_id_},{text="‹ تعطيل ›",callback_data="/Stop:"..data.sender_user_id_}},{{text="‹ TeAm black ›",url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard = {}
keyboard.inline_keyboard = {{{text="‹ غادر ›",callback_data="/LeaveBot:"..data.sender_user_id_},{text="‹ تفعيل ›",callback_data="/On:"..data.sender_user_id_}},{{text="‹ TeAm black ›",url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
Text = "𐇮︰تم ترتيب الاوامر بالشكل التالي ~\n𐇮︰ ايدي - ا .\n𐇮︰ رفع مميز - م .\n𐇮︰رفع ادمن - اد .\n𐇮︰ رفع مدير - مد . \n𐇮︰ رفع منشى - من . \n𐇮︰ رفع منشئ الاساسي - اس  .\n𐇮︰ رفع مطور - مط .\n𐇮︰رفع مطور ثانوي - ثانوي .\n𐇮︰ تنزيل الكل - تك .\n𐇮︰ تعطيل الايدي بالصوره - تعط .\n𐇮︰ تفعيل الايدي بالصوره - تفع .\n𐇮︰ الرابط - ر .\n𐇮︰ ردود المدير - رر .\n𐇮︰ مسح المكتومين - ،، .\n𐇮︰ اضف رد - رد .\n𐇮︰ مسح سحكاتي - سح .\n𐇮︰ مسح رسائلي - رس .\n𐇮︰ غنيلي - غ .\n𐇮︰مسح قائمه العام"
keyboard = {} 
keyboard.inline_keyboard = {{{text="‹ رجوع ›",callback_data="/Reload:"..data.sender_user_id_}},{{text='‹ TeAm black ›',url="t.me/BLACK_TEAM_4"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source David     --
...
if text and text:match('^'..(DevRio:get(black..'Rio:NameBot') or "بلاك")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevRio:get(black..'Rio:NameBot') or "بلاك")..' ','')
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="مسح الاوامر المضافه",callback_data="/DelCmd:"..msg.sender_user_id_},{text="ترتيب الاوامر",callback_data="/SetCmd:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text="𐇮 اضفني في مجموعتك .",url="t.me/"..dpbot.username_.."?startgroup=botstart"}}}
Msg_id = msg.id_/2097152/0.5
...
local inline = {
{{text="𐇮 المطور .",url="t.me/"..(dp.username_ or "UUOUOU_7")}},
{{text="𐇮 السورس .",url="https://t.me/BLACK_TEAM_4"},{text="𐇮 لتنصيب بوت .",url="https://t.me/UUOUOU_7"}},{{"𐇮 لتنصيب بوت .",url="https://t.me/V_P_E"}},
...
local BotName = (DevRio:get(black.."Rio:NameBot") or 'بلاك')
...
NameBot = (DevRio:get(black..'Rio:NameBot') or 'بلاك')
local blackTeam = {' تفضل '..NameBot..' ',' اسمي  '..NameBot..' ',' اسمي الجميل '..NameBot..' '}
DevRio2 = math.random(#blackTeam) 
Dev_Rio(msg.chat_id_, msg.id_, 1, blackTeam[DevRio2] , 1, 'html') 
return false
end
if text == 'اسم البوت' or text == 'البوت اي اسمه' or text == 'ايه البوت' or text == 'البوت اي' then
NameBot = (DevRio:get(black..'Rio:NameBot') or 'بلاك') 
local blackTeam = {"اسمي الجميل "..NameBot.." "} 
DevRio2 = math.random(#blackTeam) 
Dev_Rio(msg.chat_id_, msg.id_, 1, blackTeam[DevRio2] , 1, 'html') 
return false
end
...
NameBot = (DevRio:get(black..'Rio:NameBot') or 'بلاك')
local namebot = {'تفضل '..NameBot..' ',' اتفضل '..NameBot..' '} 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="مسح رسائلي",callback_data="/DelMsg:"..msg.sender_user_id_},{text="مسح سحكاتي",callback_data="/DelEdit:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text="𐇮 اضفني في مجموعتك .",url="t.me/"..dpbot.username_.."?startgroup=botstart"}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="غنيلي",callback_data="/Song:"..msg.sender_user_id_},{text="اغنيه",callback_data="/mp3:"..msg.sender_user_id_}},{{text="متحركه",callback_data="/gif:"..msg.sender_user_id_},{text="صوره",callback_data="/photo:"..msg.sender_user_id_}},{{text="انمي",callback_data="/anime:"..msg.sender_user_id_},{text="ريمكس",callback_data="/remix:"..msg.sender_user_id_}},{{text="ميمز",callback_data="/memz:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text="𐇮 اضفني في مجموعتك .",url="t.me/"..dpbot.username_.."?startgroup=botstart"}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="الرابط نص",callback_data="/LinkText:"..msg.sender_user_id_},{text="الرابط انلاين",callback_data="/Linkinline:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text="𐇮 اضفني في مجموعتك .",url="t.me/"..dpbot.username_.."?startgroup=botstart"}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="الالعاب المتطوره",callback_data="/GameInline:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text="𐇮 اضفني في مجموعتك .",url="t.me/"..dpbot.username_.."?startgroup=botstart"}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '𐇮 sᴏᴜʀᴄᴇ ʙʟᴀᴄᴋ',url="t.me/BLACK_TEAM_4"},{text = '𐇮 Tws black',url="https://t.me/JOK_ER_7bot"}},{{text="𐇮 اضفني في مجموعتك .",url="t.me/"..dpbot.username_.."?startgroup=botstart"}}}
local msg_id = msg.id_/2097152/0.5
...
if text == "اطردني" and ChCheck(msg) or text == "خرجني" and ChCheck(msg) then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="الغاء العام",callback_data=msg.sender_user_id_..":UnAll:"..result.sender_user_id_},{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text="𐇮 اضفني في مجموعتك .",url="t.me/"..dpbot.username_.."?startgroup=botstart"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
...
sudobot = '\n𐇮︰عدد الكروبات ˓ '..(DevRio:get(black..'Rio:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
sudobot = '\n𐇮︰عدد الكروبات ˓ '..(DevRio:get(black..'Rio:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
sudobot = '\n𐇮︰عدد الكروبات ˓ '..(DevRio:get(black..'Rio:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1,'𐇮︰عدد الكروبات الان ˓ { '..#group..' }'..blackgp1..blackgp2..'\n𐇮︰العدد الحقيقي الان  ˓ ( '..blackgp3..' ) \n ', 1, 'md')
end end
end,nil)
end
return false
...
local Text ='*𐇮︰تم اختيار المتحركه لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى 𐇮",callback_data="/gif:"..msg.sender_user_id_}},{{text = '𐇮 black Team .',url="t.me/BLACK_TEAM_4"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*𐇮︰تم اختيار مقطع الميمز لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى 𐇮",callback_data="/memz:"..msg.sender_user_id_}},{{text = '𐇮 black Team .',url="t.me/BLACK_TEAM_4"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*𐇮︰تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى 𐇮",callback_data="/Song:"..msg.sender_user_id_}},{{text = '𐇮 black Team .',url="t.me/BLACK_TEAM_4"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى 𐇮",callback_data="/mp3:"..msg.sender_user_id_}},{{text = '𐇮 black Team .',url="t.me/BLACK_TEAM_4"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى 𐇮",callback_data="/remix:"..msg.sender_user_id_}},{{text = '𐇮 black Team .',url="t.me/BLACK_TEAM_4"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*𐇮︰تم اختيار الصوره لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى 𐇮",callback_data="/photo:"..msg.sender_user_id_}},{{text = '𐇮 black Team .',url="t.me/BLACK_TEAM_4"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*𐇮︰تم اختيار صورة الانمي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى 𐇮",callback_data="/anime:"..msg.sender_user_id_}},{{text = '𐇮 black Team .',url="t.me/BLACK_TEAM_4"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى 𐇮",callback_data="/Movies:"..msg.sender_user_id_}},{{text = '𐇮 black Team .',url="t.me/BLACK_TEAM_4"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text=". مره اخرى 𐇮",callback_data="/series:"..msg.sender_user_id_}},{{text = '𐇮 black Team .',url="t.me/BLACK_TEAM_4"}}} 
local msg_id = msg.id_/2097152/0.5 
...
Text = "𐇮︰تم تفعيل المجموعه "..dp.title_
local inline = {{{text="‹ ترتيب الاوامر ›",callback_data="/SetCmdGp:"..msg.sender_user_id_},{text="‹ رفع الادمنيه ›",callback_data="/UploadAdmin:"..msg.sender_user_id_}},{{text="‹ غادر ›",callback_data="/LeaveBot:"..msg.sender_user_id_},{text="‹ تعطيل ›",callback_data="/Stop:"..msg.sender_user_id_}},{{text="‹ TeAm black ›",url="t.me/BLACK_TEAM_4"}}}
...
Text = "𐇮︰تم تعطيل المجموعه "..dp.title_
local inline = {{{text="‹ غادر ›",callback_data="/LeaveBot:"..msg.sender_user_id_},{text="‹ تفعيل ›",callback_data="/On:"..msg.sender_user_id_}},{{text="‹ TeAm black ›",url="t.me/BLACK_TEAM_4"}}}
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
DevRio:srem(black.."Rio:Groups",msg.chat_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="مسح ردود المدير",callback_data="/DelGpRed:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text="𐇮 اضفني في مجموعتك .",url="t.me/"..dpbot.username_.."?startgroup=botstart"}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="مسح الميديا",callback_data="/DelMedia:"..msg.sender_user_id_},{text="مسح الاغاني",callback_data="/DelMusic:"..msg.sender_user_id_}},{{text="مسح الرسائل المعدله",callback_data="/DelMsgEdit:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text="𐇮 اضفني في مجموعتك .",url="t.me/"..dpbot.username_.."?startgroup=botstart"}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="تحديث السورس",callback_data="/UpdateSource:"..msg.sender_user_id_},{text="تحديث الملفات",callback_data="/UpdateFile:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text="𐇮 اضفني في مجموعتك .",url="t.me/"..dpbot.username_.."?startgroup=botstart"}}}
Msg_id = msg.id_/2097152/0.5
...
if text and text:match('^بحث (.*)$') and not DevRio:get(black.."Rio:WhyTube"..msg.chat_id_) and ChCheck(msg) then            
...
DevRio:set(black..'Rio:NameBot',(DevRio:get(black..'Name:Bot') or 'بلاك'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𐇮 ʙʟᴀᴄᴋ',url="t.me/BLACK_TEAM_4"}},
}
local msg_id = msg.id_/2097152/0.5
...
------joker-------
if text == 'المصنع' and ChCheck(msg) or text == '˓ مصنع مميزات بلاك 𐇮' and ChCheck(msg) or text == 'المميزات' and ChCheck(msg) or text == 'مميزات بلاك' and ChCheck(msg) or text == 'المصنوع' and ChCheck(msg) then 
Text = [[
𐇮︰[ʙʟᴀᴄᴋʙᴇʀʀʏ ғᴀᴄᴛᴏʀʏ᪣](https://t.me/F_T_B_T_BOT)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𐇮 ʙʟᴀᴄᴋ',url="t.me/BLACK_TEAM_4"}},
...
--     مبرمج السورس ¹     --
if text == "مبرمج السورس¹" and ChCheck(msg) or text == "مطور السورس" and ChCheck(msg) or text == "وين المبرمج" and ChCheck(msg) or text == "المبرمج" and ChCheck(msg) or text == "˓ يمبرمج السورس 𐇮" and ChCheck(msg) then 
Text = [[
...
if text == "مبرمج السورس²" and ChCheck(msg) or text == "مطور السورس" and ChCheck(msg) or text == "وين المبرمج" and ChCheck(msg) or text == "المبرمج" and ChCheck(msg) or text == "˓ يمبرمج السورس 𐇮" and ChCheck(msg) then 
Text = [[
𐇮︰[مبرمج السورس²](https://t.me/V_P_E)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𐇮 مبرمج السورس²',url="t.me/V_P_E"}},
}
local msg_id = msg.id_/2097152/0.5
