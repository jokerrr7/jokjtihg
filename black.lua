...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "       ‹ 𝘀𝗼𝘂𝗿𝗰𝗲 𝗯𝗹𝗮𝗰𝗸 ›        ‹ 𝘀𝗼𝘂𝗿𝗰𝗲 𝗯𝗹𝗮𝗰𝗸 › ┉ ┉ ┉ ┉ ┉"
...
> CH › @BLACK_TEAM_4
~> DEVELOPER › @php_cx
]]..'\27[m'.."\n\27[35mServer Information ↬ ⤈ \n       ‹ 𝘀𝗼𝘂𝗿𝗰𝗲 𝗯𝗹𝗮𝗰𝗸 › ┉ ┉ ┉ ┉\27[m\n\27[36m~ \27[mUser \27[36m: \27[10;32m"..User.."\27[m\n\27[36m~ \27[mIp \27[36m: \27[10;32m"..Ip.."\27[m\n\27[36m~ \27[mName \27[36m: \27[10;32m"..Name.."\27[m\n\27[36m~ \27[mPort \27[36m: \27[10;32m"..Port.."\27[m\n\27[36m~ \27[mUpTime \27[36m: \27[10;32m"..UpTime.."\27[m\n\27[35m       ‹ 𝘀𝗼𝘂𝗿𝗰𝗲 𝗯𝗹𝗮𝗰𝗸 › ┉ ┉ ┉ ┉\27[m")
Config = dofile("./config.lua")
DevId = Config.DevId
SudoIds = {Config.SudoIds,1003237899 ,1364212456,000000}
black = Config.black
TokenBot = Config.TokenBot
NameBot = (DevRio:get(black..'Rio:NameBot') or 'زورو بلص')
--     Joker     --
...
FilesPrint = FilesPrint.."\27[35m".."       ‹ 𝘀𝗼𝘂𝗿𝗰𝗲 𝗯𝗹𝗮𝗰𝗸 › ┉ ┉ ┉ ┉\n".."\27[m"
...
local Status = DevRio:sismember(black..'Rio:RioSudoGp:'..msg.chat_id_,msg.sender_user_id_) 
if Status or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
local Status = DevRio:sismember(black..'Rio:SecondSudoGp:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(black..'Rio:SudoBotGp:'..msg.chat_id_,msg.sender_user_id_) 
...
send(chat,msg.id_,"  ✯ هذا الملف ليس تابع لسورس زورو بلص")
return false 
end      
...
--     Joker     --
local RioRank = function(msg) if SudoId(msg.sender_user_id_) then blackTeam  = "المطور" elseif RioSudo(msg) then blackTeam = "المطور" elseif SecondSudo(msg) then blackTeam = "المطور" elseif SudoBot(msg) then blackTeam = "المطور" elseif Manager(msg) then blackTeam = "المدير" elseif Admin(msg) then blackTeam = "الادمن" else blackTeam = "العضو" end return blackTeam end
function IdRank(user_id,chat_id) if tonumber(user_id) == tonumber(1765160742) then blackTeam = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(1003237899) then blackTeam = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(black) then blackTeam = 'البوت' elseif SudoId(user_id) then blackTeam = 'المطور الاساسي' elseif DevRio:sismember(black..'Rio:RioSudo:', user_id) then blackTeam = 'المطور الاساسي' elseif DevRio:sismember(black..'Rio:SecondSudo:', user_id) then blackTeam = 'المطور الاساسي²' elseif DevRio:sismember(black..'Rio:SudoBot:', user_id) then blackTeam = DevRio:get(black.."Rio:SudoBot:Rd"..chat_id) or 'المطور' elseif DevRio:sismember(black..'Rio:RioSudoGp:'..chat_id, user_id) then blackTeam = DevRio:get(black.."Rio:RioSudoGp:Rd"..chat_id) or 'مطور اساسي المجموعه' elseif DevRio:sismember(black..'Rio:SecondSudoGp:'..chat_id, user_id) then blackTeam = DevRio:get(black.."Rio:SecondSudoGp:Rd"..chat_id) or 'ثانوي المجموعه' elseif DevRio:sismember(black..'Rio:SudoBotGp:'..chat_id, user_id) then blackTeam = DevRio:get(black.."Rio:SudoBotGp:Rd"..chat_id) or 'مطور المجموعه' elseif DevRio:sismember(black..'Rio:Owner:'..chat_id, user_id) then blackTeam = DevRio:get(black.."Rio:Owner:Rd"..chat_id) or 'المالك' elseif DevRio:sismember(black..'Rio:RioConstructor:'..chat_id, user_id) then blackTeam = 'المالك' elseif DevRio:sismember(black..'Rio:BasicConstructor:'..chat_id, user_id) then blackTeam = DevRio:get(black.."Rio:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' elseif DevRio:sismember(black..'Rio:Constructor:'..chat_id, user_id) then blackTeam = DevRio:get(black.."Rio:Constructor:Rd"..chat_id) or 'المنشئ' elseif DevRio:sismember(black..'Rio:Managers:'..chat_id, user_id) then blackTeam = DevRio:get(black.."Rio:Managers:Rd"..chat_id) or 'المدير' elseif DevRio:sismember(black..'Rio:Admins:'..chat_id, user_id) then blackTeam = DevRio:get(black.."Rio:Admins:Rd"..chat_id) or 'الادمن' elseif DevRio:sismember(black..'Rio:VipMem:'..chat_id, user_id) then  blackTeam = DevRio:get(black.."Rio:VipMem:Rd"..chat_id) or 'المميز' elseif DevRio:sismember(black..'Rio:Cleaner:'..chat_id, user_id) then  blackTeam = DevRio:get(black.."Rio:Cleaner:Rd"..chat_id) or 'المنظف' else blackTeam = DevRio:get(black.."Rio:mem:Rd"..chat_id) or 'العضو' end return blackTeam end
--     Joker     --
...
var = true 
elseif DevRio:sismember(black..'Rio:RioSudoGp:', user_id) then
var = true 
elseif DevRio:sismember(black..'Rio:SecondSudoGp:', user_id) then
var = true 
elseif DevRio:sismember(black..'Rio:SudoBotGp:', user_id) then
var = true 
...
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('http://ccccxcc.ml/black/YtAnTak.php?Put=Photo&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&UserId='..data.sender_user_id_..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("✯ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
https.request('http://ccccxcc.ml/black/YtAnTak.php?Put=Video&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("✯ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
https.request('http://ccccxcc.ml/black/YtAnTak.php?Put=Audio&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("✯ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('http://ccccxcc.ml/black/YtAnTak.php?Put=Voice&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
end
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/Song:"..data.sender_user_id_}},{{text="ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ",url="t.me/BLACK_TEAM_4"}}} 
return https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. data.chat_id_ .. '&voice=https://t.me/Audiosblack/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..Msg_Id2.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
else
end
--     Joker     --
...
local Text ='* ✯ تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/mp3:"..data.sender_user_id_}},{{text="ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ",url="t.me/BLACK_TEAM_4"}}} 
return https.request("https://api.telegram.org/bot"..TokenBot..'/sendAudio?chat_id=' .. data.chat_id_ .. '&audio=https://t.me/blackMp3/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..Msg_Id2.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
else
end
--     Joker     --
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/memz:"..data.sender_user_id_}},{{text="ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ",url="t.me/BLACK_TEAM_4"}}} 
return https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. data.chat_id_ .. '&voice=https://t.me/Memzblack/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..Msg_Id2.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
else
end
--     Joker     --
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/gif:"..data.sender_user_id_}},{{text="ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ",url="t.me/BLACK_TEAM_4"}}} 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendanimation?chat_id=' .. data.chat_id_ .. '&animation=https://t.me/Gifblack/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..Msg_Id2.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Joker     --
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/photo:"..data.sender_user_id_}},{{text="ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ",url="t.me/BLACK_TEAM_4"}}} 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. data.chat_id_ .. '&photo=https://t.me/Photosblack/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..Msg_Id2.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Joker     --
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/anime:"..data.sender_user_id_}},{{text="ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ",url="t.me/BLACK_TEAM_4"}}} 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. data.chat_id_ .. '&photo=https://t.me/Animeblack/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..Msg_Id2.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Joker     --
...
keyboard = {} 
if Sudo(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=data.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=data.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=data.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=data.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text="• تنزيل مالك •",callback_data=data.sender_user_id_..":RemOwner:"..Rio},{text="• تنزيل مطور •",callback_data=data.sender_user_id_..":RemSudoBot:"..Rio}},{{text="• تنزيل مطور ثانوي •",callback_data=data.sender_user_id_..":RemSecondSudo:"..Rio},{text="• تنزيل مطور اساسي •",callback_data=data.sender_user_id_..":RemRioSudo:"..Rio}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif RioSudo(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=data.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=data.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=data.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=data.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text="• تنزيل مالك •",callback_data=data.sender_user_id_..":RemOwner:"..Rio},{text="• تنزيل مطور •",callback_data=data.sender_user_id_..":RemSudoBot:"..Rio}},{{text="• تنزيل مطور ثانوي •",callback_data=data.sender_user_id_..":RemSecondSudo:"..Rio}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif SecondSudo(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=data.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=data.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=data.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=data.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text="• تنزيل مالك •",callback_data=data.sender_user_id_..":RemOwner:"..Rio},{text="• تنزيل مطور •",callback_data=data.sender_user_id_..":RemSudoBot:"..Rio}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif SudoBot(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=data.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=data.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=data.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=data.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text="• تنزيل مالك •",callback_data=data.sender_user_id_..":RemOwner:"..Rio}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif Owner(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=data.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=data.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=data.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=data.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif BasicConstructor(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=data.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=data.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=data.sender_user_id_..":RemCleaner:"..Rio}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منظف •",callback_data=data.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل مدير •",callback_data=data.sender_user_id_..":RemManager:"..Rio}},{{text = '• black TeAM •',url="t.me/BLACK_TEAM_4"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Rio}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Rio}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
end
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
end
...
* ✯ يمكنك مسح رتب المجموعه من خلال الازرار اسفل*
       ‹ 𝘀𝗼𝘂𝗿𝗰𝗲 𝗯𝗹𝗮𝗰𝗸 ›
 ✯ [ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ](https://t.me/BLACK_TEAM_4)
]] 
keyboard = {} 
if Sudo(data) then
keyboard.inline_keyboard = {{{text="• مسح الاساسيين •",callback_data="/DelRioSudo:"..data.sender_user_id_},{text="• مسح الثانويين •",callback_data="/DelSecondSudo:"..data.sender_user_id_}},{{text="• مسح المطورين •",callback_data="/DelSudoBot:"..data.sender_user_id_},{text="• مسح المالكين •",callback_data="/DelOwner:"..data.sender_user_id_}},{{text="• مسح المنشئين الاساسيين •",callback_data="/DelBasicConstructor:"..data.sender_user_id_},{text="• مسح المنشئين •",callback_data="/DelConstructor:"..data.sender_user_id_}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..data.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..data.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif RioSudo(data) then
...
elseif BasicConstructor(data) then
keyboard.inline_keyboard = {{{text="• مسح المنشئين •",callback_data="/DelConstructor:"..data.sender_user_id_}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..data.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..data.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="• مسح المدراء •",callback_data="/DelManagers:"..data.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..data.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..data.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="• مسح المميزين •",callback_data="/DelVipMem:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
end
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
...
if not Bot(data) and DevRio:get(black..'Rio:Lock:Rd'..data.chat_id_) then 
...
DevRio:set(black..'Rio:Add:GpRed'..data.sender_user_id_..data.chat_id_,'SetGpRed')
EditMsg(Chat_Id2, Msg_Id2, " ✯ حسنا ارسل الكلمه الان") 
return false
end end
if text and text:match("^(.*)$") then
local SetGpRed = DevRio:get(black..'Rio:Add:GpRed'..data.sender_user_id_..data.chat_id_)
...
DevRio:set(black..'Rio:Add:GpRed'..data.sender_user_id_..data.chat_id_,'SaveGpRed')
DevRio:set(black..'Rio:Add:GpText'..data.sender_user_id_..data.chat_id_,text)
DevRio:sadd(black..'Rio:Manager:GpRed'..data.chat_id_,text)
DevRio:set(black..'DelManagerRep'..data.chat_id_,text)
keyboard = {} 
keyboard.inline_keyboard = {{{text="• تغير الرد •",callback_data="/ChangeRed:"..data.sender_user_id_}},{{text="• الغاء •",callback_data="/CancelRed:"..data.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text or redod).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end end
--     Joker     --
...
DevRio:set(black.."Rio:Add:AllRed"..data.sender_user_id_,'SetAllRed')
EditMsg(Chat_Id2, Msg_Id2, " ✯ حسنا ارسل الكلمه الان") 
return false
end end
if text and text:match("^(.*)$") then
local SetAllRed = DevRio:get(black.."Rio:Add:AllRed"..data.sender_user_id_)
...
Text = " ✯ ارسل لي الرد سواء كان ↫ ⤈\n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n ✯ يمكنك اضافة الى النص ↫ ⤈\n       ‹ 𝘀𝗼𝘂𝗿𝗰𝗲 𝗯𝗹𝗮𝗰𝗸 ›\n `#username` ↬ معرف المستخدم\n `#datas` ↬ عدد الرسائل\n `#name` ↬ اسم المستخدم\n `#id` ↬ ايدي المستخدم\n `#stast` ↬ رتبة المستخدم\n `#edit` ↬ عدد السحكات\n       ‹ 𝘀𝗼𝘂𝗿𝗰𝗲 𝗯𝗹𝗮𝗰𝗸 ›\n ✯ للخروج ارسل ↫ ( الغاء )\n ✓"
DevRio:set(black.."Rio:Add:AllRed"..data.sender_user_id_,'SaveAllRed')
DevRio:set(black.."Rio:Add:AllText"..data.sender_user_id_, text)
DevRio:sadd(black.."Rio:Sudo:AllRed",text)
DevRio:set(black.."DelSudoRep",text)
keyboard = {} 
keyboard.inline_keyboard = {{{text="• تغير الرد •",callback_data="/ChangeAllRed:"..data.sender_user_id_}},{{text="• الغاء •",callback_data="/CancelAllRed:"..data.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text or redod).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end end
--     Joker     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/CmdList:"..data.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text or redod).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
DevRio:set(black.."Set:Cmd:Group:New1"..data.chat_id_..":ا","ايدي")
DevRio:sadd(black.."List:Cmd:Group:New"..data.chat_id_,"ا")
DevRio:set(black.."Set:Cmd:Group:New1"..data.chat_id_..":م","رفع مميز")
DevRio:sadd(black.."List:Cmd:Group:New"..data.chat_id_,"م")
DevRio:set(black.."Set:Cmd:Group:New1"..data.chat_id_..":اد","رفع ادمن")
DevRio:sadd(black.."List:Cmd:Group:New"..data.chat_id_,"اد")
DevRio:set(black.."Set:Cmd:Group:New1"..data.chat_id_..":مد","رفع مدير")
DevRio:sadd(black.."List:Cmd:Group:New"..data.chat_id_,"مد")
DevRio:set(black.."Set:Cmd:Group:New1"..data.chat_id_..":من","رفع منشئ")
DevRio:sadd(black.."List:Cmd:Group:New"..data.chat_id_,"من")
DevRio:set(black.."Set:Cmd:Group:New1"..data.chat_id_..":اس","رفع منشئ اساسي")
DevRio:sadd(black.."List:Cmd:Group:New"..data.chat_id_,"اس")
DevRio:set(black.."Set:Cmd:Group:New1"..data.chat_id_..":مط","رفع مطور")
DevRio:sadd(black.."List:Cmd:Group:New"..data.chat_id_,"مط")
DevRio:set(black.."Set:Cmd:Group:New1"..data.chat_id_..":ثانوي","رفع مطور ثانوي")
DevRio:sadd(black.."List:Cmd:Group:New"..data.chat_id_,"ثانوي")
DevRio:set(black.."Set:Cmd:Group:New1"..data.chat_id_..":تك","تنزيل الكل")
DevRio:sadd(black.."List:Cmd:Group:New"..data.chat_id_,"تك")
DevRio:set(black.."Set:Cmd:Group:New1"..data.chat_id_..":تعط","تعطيل الايدي بالصوره")
DevRio:sadd(black.."List:Cmd:Group:New"..data.chat_id_,"تعط")
DevRio:set(black.."Set:Cmd:Group:New1"..data.chat_id_..":تفع","تفعيل الايدي بالصوره")
DevRio:sadd(black.."List:Cmd:Group:New"..data.chat_id_,"تفع")
DevRio:set(black.."Set:Cmd:Group:New1"..data.chat_id_..":ر","الرابط")
DevRio:sadd(black.."List:Cmd:Group:New"..data.chat_id_,"ر")
DevRio:set(black.."Set:Cmd:Group:New1"..data.chat_id_..":رر","ردود المدير")
DevRio:sadd(black.."List:Cmd:Group:New"..data.chat_id_,"رر")
DevRio:set(black.."Set:Cmd:Group:New1"..data.chat_id_..":،،","مسح المكتومين")
DevRio:sadd(black.."List:Cmd:Group:New"..data.chat_id_,"،،")
DevRio:set(black.."Set:Cmd:Group:New1"..data.chat_id_..":رد","اضف رد")
DevRio:sadd(black.."List:Cmd:Group:New"..data.chat_id_,"رد")
DevRio:set(black.."Set:Cmd:Group:New1"..data.chat_id_..":غ","غنيلي")
DevRio:sadd(black.."List:Cmd:Group:New"..data.chat_id_,"غ")
DevRio:set(black.."Set:Cmd:Group:New1"..data.chat_id_..":#","مسح قائمه العام")
DevRio:sadd(black.."List:Cmd:Group:New"..data.chat_id_,"#")
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• ترتيب الاوامر •",callback_data="/SetCmd:"..data.sender_user_id_},{text="• مسح الاوامر المضافه •",callback_data="/DelCmd:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح رسائلي •",callback_data="/DelMsg:"..data.sender_user_id_},{text="• مسح سحكاتي •",callback_data="/DelEdit:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• رجوع •",callback_data="/DelHome:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
--     Joker     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• رجوع •",callback_data="/FilterList:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• قفل البوتات بالطرد •",callback_data="/lockBotKick:"..data.sender_user_id_},{text="• قفل البوتات بالتقيد •",callback_data="/lockBotKed:"..data.sender_user_id_}},{{text="• قفل البوتات بالكتم •",callback_data="/lockBotDel:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
--     Joker     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• قفل التكرار بالطرد •",callback_data="/lockSpamKick:"..data.sender_user_id_},{text="• قفل التكرار بالتقيد •",callback_data="/lockSpamKed:"..data.sender_user_id_}},{{text="• قفل التكرار بالحذف •",callback_data="/lockSpamDel:"..data.sender_user_id_},{text="• قفل التكرار بالكتم •",callback_data="/lockSpamMute:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
--     Joker     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/LockBotList:"..data.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/LockSpamList:"..data.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
os.execute('rm -rf black.lua.lua') 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/SourceList:"..data.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/MediaHome:"..data.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text and text:match('^'..(DevRio:get(black..'Rio:NameBot') or "زورو بلص")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevRio:get(black..'Rio:NameBot') or "زورو بلص")..' ','')
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح الاوامر المضافه •",callback_data="/DelCmd:"..msg.sender_user_id_},{text="• ترتيب الاوامر •",callback_data="/SetCmd:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
...
DevRio:set(black.."Set:Cmd:Group:New1"..msg.chat_id_..":ا","ايدي")
DevRio:sadd(black.."List:Cmd:Group:New"..msg.chat_id_,"ا")
DevRio:set(black.."Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
DevRio:sadd(black.."List:Cmd:Group:New"..msg.chat_id_,"م")
DevRio:set(black.."Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
DevRio:sadd(black.."List:Cmd:Group:New"..msg.chat_id_,"اد")
DevRio:set(black.."Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
DevRio:sadd(black.."List:Cmd:Group:New"..msg.chat_id_,"مد")
DevRio:set(black.."Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
DevRio:sadd(black.."List:Cmd:Group:New"..msg.chat_id_,"من")
DevRio:set(black.."Set:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
DevRio:sadd(black.."List:Cmd:Group:New"..msg.chat_id_,"اس")
DevRio:set(black.."Set:Cmd:Group:New1"..msg.chat_id_..":مط","رفع مطور")
DevRio:sadd(black.."List:Cmd:Group:New"..msg.chat_id_,"مط")
DevRio:set(black.."Set:Cmd:Group:New1"..msg.chat_id_..":ثانوي","رفع مطور ثانوي")
DevRio:sadd(black.."List:Cmd:Group:New"..msg.chat_id_,"ثانوي")
DevRio:set(black.."Set:Cmd:Group:New1"..msg.chat_id_..":تك","تنزيل الكل")
DevRio:sadd(black.."List:Cmd:Group:New"..msg.chat_id_,"تك")
DevRio:set(black.."Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصوره")
DevRio:sadd(black.."List:Cmd:Group:New"..msg.chat_id_,"تعط")
DevRio:set(black.."Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصوره")
DevRio:sadd(black.."List:Cmd:Group:New"..msg.chat_id_,"تفع")
DevRio:set(black.."Set:Cmd:Group:New1"..msg.chat_id_..":ر","الرابط")
DevRio:sadd(black.."List:Cmd:Group:New"..msg.chat_id_,"ر")
DevRio:set(black.."Set:Cmd:Group:New1"..msg.chat_id_..":رر","ردود المدير")
DevRio:sadd(black.."List:Cmd:Group:New"..msg.chat_id_,"رر")
DevRio:set(black.."Set:Cmd:Group:New1"..msg.chat_id_..":،،","مسح المكتومين")
DevRio:sadd(black.."List:Cmd:Group:New"..msg.chat_id_,"،،")
DevRio:set(black.."Set:Cmd:Group:New1"..msg.chat_id_..":رد","اضف رد")
DevRio:sadd(black.."List:Cmd:Group:New"..msg.chat_id_,"رد")
DevRio:set(black.."Set:Cmd:Group:New1"..msg.chat_id_..":سح","مسح سحكاتي")
DevRio:sadd(black.."List:Cmd:Group:New"..msg.chat_id_,"سح")
DevRio:set(black.."Set:Cmd:Group:New1"..msg.chat_id_..":رس","مسح رسائلي")
DevRio:sadd(black.."List:Cmd:Group:New"..msg.chat_id_,"رس")
DevRio:set(black.."Set:Cmd:Group:New1"..msg.chat_id_..":غ","غنيلي")
DevRio:sadd(black.."List:Cmd:Group:New"..msg.chat_id_,"غ")
DevRio:set(black.."Set:Cmd:Group:New1"..msg.chat_id_..":#","مسح قائمه العام")
DevRio:sadd(black.."List:Cmd:Group:New"..msg.chat_id_,"#")
...
if SecondSudo(msg) then 
local Sudo_Welcome = ' ✯ اهلا بك مجددا عزيزي المطور \n ✯ اليك الازرار الخاصه بتعديل وتغيير كلايش سورس زورو بلص فقط اضغط على الامر الذي تريد تنفيذه'
...
if text == '↫ السورس ✯' then 
if SecondSudo(msg) then 
local Sudo_Welcome = ' ✯ اهلا بك مجددا عزيزي المطور \n ✯ اليك الازرار الخاصه بتحديث  سورس زورو بلص فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = ' ✯ اهلا بك مجددا عزيزي المطور \n ✯ اليك الازرار الخاصه ب أحصائيات  سورس زورو بلص فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = ' ✯ اهلا بك مجددا عزيزي المطور \n ✯ اليك الازرار الخاصه ب المطورين لسورس زورو بلص فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = ' ✯ اهلا بك مجددا عزيزي المطور \n ✯ اليك الازرار الخاصه ب التفعيل والتعطيل لسورس زورو بلص فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = ' ✯ اهلا بك مجددا عزيزي المطور \n ✯ اليك الازرار الخاصه بالاذاعه لسورس زورو بلص فقط اضغط على الامر الذي تريد تنفيذه'
...
if text == '↫ العام ✯' then 
if SecondSudo(msg) then 
local Sudo_Welcome = ' ✯ اهلا بك مجددا عزيزي المطور \n ✯ اليك الازرار الخاصه بالعام لسورس زورو بلص فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = ' ✯ اهلا بك مجددا عزيزي المطور \n ✯ اليك الازرار الخاصه بردود الخاص لسورس زورو بلص فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = ' ✯ اهلا بك مجددا عزيزي المطور \n ✯ اليك الازرار الخاصه بالاشتراك الاجباري لسورس زورو بلص فقط اضغط على الامر الذي تريد تنفيذه'
...
local Sudo_Welcome = ' ✯ اهلا بك مجددا عزيزي \n ✯ اليك الازرار الخاصه بالاوامر الخدميه الخاصه بسورس زورو بلص فقط اضغط على الامر الذي تريد تنفيذه'
local key = {{'↫ اوامر التسليه ✯','↫ الاوامر الخدميه  ✯'},{'↫ اوامر النسب ✯','↫ البوتات ✯'},{'↫ العاب ✯'},{'↫  السورس ✯','↫  المطور ✯'},{'↫ رجوع ✯'}}
SendInline(msg.chat_id_,Sudo_Welcome,key)
return false
end
if text == '↫ اوامر التسليه ✯' then 
local Sudo_Welcome = ' ✯ اهلا بك مجددا عزيزي \n ✯ اليك الازرار الخاصه بأوامر التسليه الخاصه بسورس زورو بلص فقط اضغط على الامر الذي تريد تنفيذه'
...
local Sudo_Welcome = ' ✯ اهلا بك مجددا عزيزي \n ✯ اليك الازرار الخاصه بأوامر البوتات الخاصه بسورس زورو بلص فقط اضغط على الامر الذي تريد تنفيذه'
local key = {{'↫ بوت الحذف ✯','↫ بوت الهمسه ✯'},{'↫ بوت اليوتيوب ✯','↫ بوت الكت ✯'},{'↫ بوت الزخرفه ✯'},{'↫  رجوع  ✯'}}
SendInline(msg.chat_id_,Sudo_Welcome,key)
return false
end
if text == '↫ اوامر النسب ✯' then 
local Sudo_Welcome = ' ✯ اهلا بك مجددا عزيزي \n ✯ اليك الازرار الخاصه بأوامر النسب الخاصه بسورس زورو بلص فقط اضغط على الامر الذي تريد تنفيذه'
local key = {{'↫ نسبه الكره ✯','↫ نسبه الحب ✯'},{'↫ نسبه الرجوله ✯','↫ نسبه الانوثه ✯'},{'↫ نسبه الغباء ✯','↫ نسبه الجمال ✯'},{'↫ نسبه الخيانه ✯'},{'↫  رجوع  ✯'}}
SendInline(msg.chat_id_,Sudo_Welcome,key)
return false
end
if text == '↫ العاب ✯' then 
local Sudo_Welcome = ' ✯ اهلا بك مجددا عزيزي \n ✯ اليك الازرار الخاصه بألعاب سورس زورو بلص فقط اضغط على اللعبه الذي تريد لعبها'
...
local inline = {{{text="• ✯ المطور . •",url="t.me/"..(dp.username_ or "BLACK_TEAM_4")}},{{text="• ✯ السورس . •",url="https://t.me/BLACK_TEAM_4"},{text="• ✯ لتنصيب بوت . •",url="https://t.me/php_cx"}},{{text="• ✯ اضفني في مجموعتك . •",url="t.me/"..dp.username_.."?startgroup=botstart"}}}
...
Dev_Rio(msg.chat_id_, msg.id_, 1, ' ✯ عدد اعضاء المجموعه اقل من ↫ *'..(DevRio:get(black..'Rio:Num:Add:Bot') or 0)..'* عضو', 1, 'md')
return false
end
...
local blackTeam =  DevRio:smembers(black..'Rio:Text:KtTexts'..text..msg.chat_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '['..blackTeam[math.random(#blackTeam)]..']' , 1, 'md')  
end
end
--     Joker     --
...
if DevRio:sismember(black..'Rio:Groups',msg.chat_id_) then BotText = "مفعله في السابق\n ✯ ارسل ↫ الاوامر واستمتع بالمميزيات" else BotText = "معطله يجب رفعي مشرف\n ✯ بعد ذلك يرجى ارسال امر ↫ تفعيل\n ✯ سيتم رفع الادمنيه والمنشئ تلقائيا" end 
if DevRio:get(black.."Rio:Text:BotWelcome") then RioText = DevRio:get(black.."Rio:Text:BotWelcome") else RioText = " ✯ مرحبا انا بوت اسمي "..NameBot.."\n ✯ حالة المجموعه ↫ "..BotText.."\n       ‹ 𝘀𝗼𝘂𝗿𝗰𝗲 𝗯𝗹𝗮𝗰𝗸 ›" end 
...
local Users = DevRio:smembers(black..'Rio:Users') 
local BotName = (DevRio:get(black.."Rio:NameBot") or 'زورو بلص')
...
File:write(GetJson)
File:close()
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './'..black..'.json', ' ✯ يحتوي الملف على ↫ ⤈\n مجموعه '..#List..' \n مشترك '..#Users..' ' ,dl_cb, nil)
...
keyboard = {}  
keyboard.inline_keyboard = {{{text = '° 𝗕𝗟𝗔𝗖𝗞 𝗧𝗘𝗔𝗠 °',url="t.me/BLACK_TEAM_4"}},{{text = '° 𝗕𝗟𝗔𝗖𝗞 𝗙𝗜𝗟𝗘𝗦 °',url="t.me/J_F_A_I"}}} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Animeblack/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'اسم البوت' or text == 'البوت شنو اسمه' or text == 'شسمه البوت' or text == 'البوت شسمه' then
NameBot = (DevRio:get(black..'Rio:NameBot') or 'بلاك') 
local blackTeam = {"اسمي القميل "..NameBot.." "} 
DevRio2 = math.random(#blackTeam) 
Dev_Rio(msg.chat_id_, msg.id_, 1, blackTeam[DevRio2] , 1, 'html') 
return false
end
if text and text == (DevRio:get(black..'Rio:NameBot') or 'بلاك') then 
NameBot = (DevRio:get(black..'Rio:NameBot') or 'بلاك')
...
Dev_Rio(msg.chat_id_, msg.id_, 1,' ✯ عدد النقاط التي ربحتها ↫ '..(DevRio:get(black..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_)), 1, 'md')
end
end
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then DevRio:del(black..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, ' ✯ تم حذف جميع نقاطك', 1, 'md') end
--     Joker     --
...
Text = ''..blackTeam[math.random(#blackTeam)]..''
keyboard = {} 
keyboard.inline_keyboard = {{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح رسائلي •",callback_data="/DelMsg:"..msg.sender_user_id_},{text="• مسح سحكاتي •",callback_data="/DelEdit:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• غنيلي •",callback_data="/Song:"..msg.sender_user_id_},{text="• اغنيه •",callback_data="/mp3:"..msg.sender_user_id_}},{{text="• متحركه •",callback_data="/gif:"..msg.sender_user_id_},{text="• صوره •",callback_data="/photo:"..msg.sender_user_id_}},{{text="• انمي •",callback_data="/anime:"..msg.sender_user_id_},{text="• ريمكس •",callback_data="/remix:"..msg.sender_user_id_}},{{text="• ميمز •",callback_data="/memz:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
if Sudo(msg) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="• رفع ادمن •",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="• رفع منشئ •",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="• رفع مدير •",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="• رفع منظف •",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="• رفع منشئ اساسي •",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="• رفع مالك •",callback_data=msg.sender_user_id_..":SetOwner:"..result.sender_user_id_},{text="• رفع مطور •",callback_data=msg.sender_user_id_..":SetSudoBot:"..result.sender_user_id_}},{{text="• رفع مطور ثانوي •",callback_data=msg.sender_user_id_..":SetSecondSudo:"..result.sender_user_id_},{text="• رفع مطور اساسي •",callback_data=msg.sender_user_id_..":SetRioSudo:"..result.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif RioSudo(msg) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="• رفع ادمن •",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="• رفع منشئ •",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="• رفع مدير •",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="• رفع منظف •",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="• رفع منشئ اساسي •",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="• رفع مالك •",callback_data=msg.sender_user_id_..":SetOwner:"..result.sender_user_id_},{text="• رفع مطور •",callback_data=msg.sender_user_id_..":SetSudoBot:"..result.sender_user_id_}},{{text="• رفع مطور ثانوي •",callback_data=msg.sender_user_id_..":SetSecondSudo:"..result.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif SecondSudo(msg) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="• رفع ادمن •",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="• رفع منشئ •",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="• رفع مدير •",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="• رفع منظف •",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="• رفع منشئ اساسي •",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="• رفع مالك •",callback_data=msg.sender_user_id_..":SetOwner:"..result.sender_user_id_},{text="• رفع مطور •",callback_data=msg.sender_user_id_..":SetSudoBot:"..result.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif SudoBot(msg) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="• رفع ادمن •",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="• رفع منشئ •",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="• رفع مدير •",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="• رفع منظف •",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="• رفع منشئ اساسي •",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="• رفع مالك •",callback_data=msg.sender_user_id_..":SetOwner:"..result.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif Owner(msg) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="• رفع ادمن •",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="• رفع منشئ •",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="• رفع مدير •",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="• رفع منظف •",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="• رفع منشئ اساسي •",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif BasicConstructor(msg) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="• رفع ادمن •",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="• رفع منشئ •",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="• رفع مدير •",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="• رفع منظف •",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif Constructor(msg) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="• رفع ادمن •",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="• رفع منظف •",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="• رفع مدير •",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif Manager(msg) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="• رفع ادمن •",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif Admin(msg) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
end
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text='..URL.escape(Text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
...
keyboard = {} 
if Sudo(msg) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="• تنزيل منشئ  اساسي •",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text="• تنزيل مالك •",callback_data=msg.sender_user_id_..":RemAbsConstructor:"..result.sender_user_id_},{text="• تنزيل مطور •",callback_data=msg.sender_user_id_..":RemSudoBot:"..result.sender_user_id_}},{{text="• تنزيل مطور ثانوي •",callback_data=msg.sender_user_id_..":RemSecondSudo:"..result.sender_user_id_},{text="• تنزيل مطور اساسي •",callback_data=msg.sender_user_id_..":RemRioSudo:"..result.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif RioSudo(msg) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text="• تنزيل مالك •",callback_data=msg.sender_user_id_..":RemOwner:"..Rio},{text="• تنزيل مطور •",callback_data=msg.sender_user_id_..":RemSudoBot:"..Rio}},{{text="• تنزيل مطور ثانوي •",callback_data=msg.sender_user_id_..":RemSecondSudo:"..Rio}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif SecondSudo(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text="• تنزيل مالك •",callback_data=msg.sender_user_id_..":RemOwner:"..Rio},{text="• تنزيل مطور •",callback_data=msg.sender_user_id_..":RemSudoBot:"..Rio}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif SudoBot(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text="• تنزيل مالك •",callback_data=msg.sender_user_id_..":RemOwner:"..Rio}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif Owner(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل منشئ  اساسي •",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..Rio}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif BasicConstructor(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..Rio},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..Rio}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..Rio}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Rio}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..Rio},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..Rio}},{{text = '• black TeAM •',url="t.me/BLACK_TEAM_4"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Rio}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Rio}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
end
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text='..URL.escape(Text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الرابط نص •",callback_data="/LinkText:"..msg.sender_user_id_},{text="• الرابط انلاين •",callback_data="/Linkinline:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الالعاب المتطوره •",callback_data="/GameInline:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
...
Dev_Rio(msg.chat_id_, msg.id_, 1,' ✯ تم بيع '..(DevRio:get(black..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_))..' من نقاطك\n ✯ كل نقطه تساوي 50 رساله', 'md')
...
Text = [[
Welcome To Source
 ✯ [W𝗲𝗹𝗰𝗼𝗺𝗲 𝘁𝗼 𝘀𝗼𝘂𝗿𝗰𝗲 𝗯𝗹𝗮𝗰𝗸](https://t.me/BLACK_TEAM_4)
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = ' 𝘀𝗼𝘂𝗿𝗰𝗲 𝗯𝗹𝗮𝗰𝗸',url="https://t.me/BLACK_TEAM_4"}},{{text = 'چوڪرّ 𝐽𝑂𝐾𝐸𝑅𐇭',url="t.me/php_cx"}},{{text= '𝗝𝗔𝗖𝗞 .',url="V_P_E"}}}
local msg_id = msg.id_/2097152/0.5
...
--     Joker     --
if text == "جهاتي" and ChCheck(msg) or text == "اضافاتي" and ChCheck(msg) then add = (tonumber(DevRio:get(black..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0) Dev_Rio(msg.chat_id_, msg.id_, 1, " ✯ عدد جهاتك المضافه ↫ *❨ "..add.." ❩* ", 1, 'md') end
if text == "تعديلاتي" or text == "سحكاتي" and ChCheck(msg) then local edit_msg = DevRio:get(black..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0  Dev_Rio(msg.chat_id_, msg.id_, 1, " ✯ عدد تعديلاتك ↫ *❨ "..edit_msg.." ❩* ", 1, 'md') end
...
if text == 'مسح جهاتي' or text == 'مسح اضافاتي' or text == 'حذف جهاتي' or text == 'حذف اضافاتي' then DevRio:del(black..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, ' ✯ تم حذف جميع جهاتك المضافه' , 1, 'md') end
--     Joker     --
...
if DevRio:sismember(black..'Rio:RioSudoGp:'..msg.chat_id_, result.sender_user_id_) then
riosudogp = 'مطورين اساسيين المجموعه • ' else riosudogp = '' end
if DevRio:sismember(black..'Rio:SecondSudoGp:'..msg.chat_id_, result.sender_user_id_) then
secondsudogp = 'ثانويين المجموعه • ' else secondsudogp = '' end
if DevRio:sismember(black..'Rio:SudoBotGp:'..msg.chat_id_, result.sender_user_id_) then
...
DevRio:srem(black..'Rio:RioSudoGp:'..msg.chat_id_,result.sender_user_id_)
DevRio:srem(black..'Rio:SecondSudoGp:'..msg.chat_id_,result.sender_user_id_)
DevRio:srem(black..'Rio:SudoBotGp:'..msg.chat_id_,result.sender_user_id_)
...
sudobot = 'المطورين • ' else sudobot = '' end
if DevRio:sismember(black..'Rio:RioSudoGp:'..msg.chat_id_, result.id_) then
riosudogp = 'مطورين اساسيين المجموعه • ' else riosudogp = '' end
if DevRio:sismember(black..'Rio:SecondSudoGp:'..msg.chat_id_, result.id_) then
secondsudogp = 'ثانويين المجموعه • ' else secondsudogp = '' end
if DevRio:sismember(black..'Rio:SudoBotGp:'..msg.chat_id_, result.id_) then
sudobotgp = 'مطورين المجموعه • ' else sudobotgp = '' end
...
DevRio:srem(black..'Rio:RioSudoGp:'..msg.chat_id_,result.id_)
DevRio:srem(black..'Rio:SecondSudoGp:'..msg.chat_id_,result.id_)
DevRio:srem(black..'Rio:SudoBotGp:'..msg.chat_id_,result.id_)
...
DevRio:sadd(black..'Rio:RioSudoGp:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(black..'Rio:RioSudoGp:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.sender_user_id_,"Reply"," ✯ تم رفعه مطور اساسي مجموعه")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, ' ✯ *المعرف غير صحيح*', 1, 'md')
end end 
...
DevRio:sadd(black..'Rio:RioSudoGp:'..msg.chat_id_,user)
ReplyStatus(msg,result.sender_user_id_,"Reply"," ✯ تم رفعه مطور اساسي مجموعه")  
end
--     Joker     --
--  Rem RioSudoGp  --
...
DevRio:srem(black..'Rio:RioSudoGp:'..msg.chat_id_,user)
ReplyStatus(msg,result.sender_user_id_,"Reply"," ✯ تم تنزيله مطور اساسي مجموعه")  
end end
...
function raf_reply(extra, result, success)
DevRio:sadd(black..'Rio:SecondSudoGp:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(black..'Rio:SecondSudoGp:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.sender_user_id_,"Reply"," ✯ تم رفعه مطور ثانوي مجموعه")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, ' ✯ *المعرف غير صحيح*', 1, 'md')
end end 
...
DevRio:sadd(black..'Rio:SecondSudoGp:'..msg.chat_id_,user)
ReplyStatus(msg,result.sender_user_id_,"Reply"," ✯ تم رفعه مطور ثانوي مجموعه")  
end
--     Joker     --
--  Rem SecondSudoGp  --
...
DevRio:srem(black..'Rio:SecondSudoGp:'..msg.chat_id_,user)
ReplyStatus(msg,result.sender_user_id_,"Reply"," ✯ تم تنزيله مطور ثانوي مجموعه")  
end end
...
function raf_reply(extra, result, success)
DevRio:sadd(black..'Rio:SudoBotGp:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(black..'Rio:SudoBotGp:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.sender_user_id_,"Reply"," ✯ تم رفعه مطور مجموعه")  
else 
Dev_Rio(msg.chat_id_, msg.id_, 1, ' ✯ *المعرف غير صحيح*', 1, 'md')
end end 
...
DevRio:sadd(black..'Rio:SudoBotGp:'..msg.chat_id_,user)
ReplyStatus(msg,result.sender_user_id_,"Reply"," ✯ تم رفعه مطور مجموعه")  
end
--     Joker     --
--  Rem SudoBotGp  --
...
DevRio:srem(black..'Rio:SudoBotGp:'..msg.chat_id_,user)
ReplyStatus(msg,result.sender_user_id_,"Reply"," ✯ تم تنزيله مطور مجموعه")  
end end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الغاء حظر •",callback_data=msg.sender_user_id_..":UnBan:"..result.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الغاء كتم •",callback_data=msg.sender_user_id_..":UnMute:"..result.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الغاء تقيد •",callback_data=msg.sender_user_id_..":UnTkeed:"..result.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الغاء العام •",callback_data=msg.sender_user_id_..":UnAll:"..result.sender_user_id_},{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
...
--     Joker     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع مطي$") and not DevRio:get(black..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
...
--     Joker     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل مطي$") and not DevRio:get(black..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
--     Joker     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
--     Joker     -- 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المدراء •",callback_data="/DelManagers:"..msg.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المنظفين •",callback_data="/DelCleanr:"..msg.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
--     Joker     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المنشئين •",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
--     Joker     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المالكين •",callback_data="/DelOwner:"..msg.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المكتومين •",callback_data="/DelMute:"..msg.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Joker     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المقيدين •",callback_data="/DelKeed:"..msg.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Joker     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المحظورين •",callback_data="/DelBan:"..msg.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Joker     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح الاساسيين •",callback_data="/DelRioSudo:"..msg.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
--     Joker     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح الثانويين •",callback_data="/DelSecondSudo:"..msg.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Joker     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح قائمه العام •",callback_data="/DelListAll:"..msg.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
--     Joker     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المطورين •",callback_data="/DelSudoBot:"..msg.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Joker     --
...
if text == 'تحويل' and not DevRio:get(black..'Rio:Thwel:Rio'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then 
...
sudobot = '\n ✯ عدد الجروبات ↫ '..(DevRio:get(black..'Rio:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
sudobot = '\n ✯ عدد الجروبات ↫ '..(DevRio:get(black..'Rio:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
sudobot = '\n ✯ عدد الجروبات ↫ '..(DevRio:get(black..'Rio:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
if DevRio:sismember(black..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevRio:sismember(black..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevRio:sismember(black..'Rio:BanAll:',result.sender_user_id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevRio:sismember(black..'Rio:MuteAll:',result.sender_user_id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevRio:sismember(black..'Rio:Tkeed:',result.sender_user_id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
...
if result.id_ then
if DevRio:sismember(black..'Rio:Muted:'..msg.chat_id_,result.id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevRio:sismember(black..'Rio:Ban:'..msg.chat_id_,result.id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevRio:sismember(black..'Rio:BanAll:',result.id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevRio:sismember(black..'Rio:MuteAll:',result.id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevRio:sismember(black..'Rio:Tkeed:',result.id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
Dev_Rio(msg.chat_id_, msg.id_, 1, ' ✯ الحظر العام ↫ '..banall..'\n ✯ الكتم العام ↫ '..muteall..'\n ✯ الحظر ↫ '..banned..'\n ✯ الكتم ↫ '..muted..'\n ✯ التقيد ↫ '..tkeed, 1, 'md')  
else
Dev_Rio(msg.chat_id_, msg.id_, 1, ' ✯ *المعرف غير صحيح*', 1, 'md')  
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1,' ✯ عدد الجروبات الان ↫ { '..#group..' }'..blackgp1..blackgp2..'\n ✯ العدد الحقيقي الان  ↫ ( '..blackgp3..' ) \n ', 1, 'md')
end end
end,nil)
end
return false
...
if M ~= 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, " ✯ عدد الميديا ↫ "..M.."\n ✯ الحذف التلقائي ↫ "..(DevRio:get(black..'Rio:CleanNum'..msg.chat_id_) or 200), 1, 'md') 
else
...
DevRio:del(black..'Rio:SudoBotGp:'..msg.chat_id_)
end
end
if RioSudoGp(msg) then
...
DevRio:del(black..'Rio:SecondSudoGp:'..msg.chat_id_)
end
end
if RioSudo(msg) then
...
DevRio:del(black..'Rio:RioSudoGp:'..msg.chat_id_)
end
end
if SudoBot(msg) then
...
--     Joker     --
if DevRio:get(black..'Rio:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه'end
if DevRio:get(black..'Rio:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفله' else mute_photo = 'مفتوحه' end
if DevRio:get(black..'Rio:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفله' else mute_video = 'مفتوحه' end
if DevRio:get(black..'Rio:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفله' else mute_gifs = 'مفتوحه' end
if DevRio:get(black..'Rio:Lock:Music'..msg.chat_id_) then mute_music = 'مقفله' else mute_music = 'مفتوحه' end
if DevRio:get(black..'Rio:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفله' else mute_in = 'مفتوحه' end
if DevRio:get(black..'Rio:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفله' else mute_voice = 'مفتوحه' end
if DevRio:get(black..'Rio:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفله' else mute_edit = 'مفتوحه' end
if DevRio:get(black..'Rio:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end
if DevRio:get(black..'Rio:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفله' else lock_pin = 'مفتوحه' end
if DevRio:get(black..'Rio:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفله' else lock_sticker = 'مفتوحه' end
if DevRio:get(black..'Rio:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفله' else lock_tgservice = 'مفتوحه' end
if DevRio:get(black..'Rio:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفله' else lock_wp = 'مفتوحه' end
if DevRio:get(black..'Rio:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفله' else lock_htag = 'مفتوحه' end
if DevRio:get(black..'Rio:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفله' else lock_tag = 'مفتوحه' end
if DevRio:get(black..'Rio:Lock:Location'..msg.chat_id_) then lock_location = 'مقفله' else lock_location = 'مفتوحه' end
if DevRio:get(black..'Rio:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفله' else lock_contact = 'مفتوحه' end
if DevRio:get(black..'Rio:Lock:English'..msg.chat_id_) then lock_english = 'مقفله' else lock_english = 'مفتوحه' end
if DevRio:get(black..'Rio:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفله' else lock_arabic = 'مفتوحه' end
if DevRio:get(black..'Rio:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفله' else lock_forward = 'مفتوحه' end
if DevRio:get(black..'Rio:Lock:Document'..msg.chat_id_) then lock_file = 'مقفله' else lock_file = 'مفتوحه' end
if DevRio:get(black..'Rio:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفله' else markdown = 'مفتوحه' end
if DevRio:get(black..'Rio:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفله' else lock_spam = 'مفتوحه' end
if DevRio:get(black..'Rio:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفل' else lock_Join = 'مفتوح' end
if DevRio:get(black.."Rio:Lock:Welcome"..msg.chat_id_) then send_welcome = 'مقفله' else send_welcome = 'مفتوحه' end
if DevRio:get(black..'Rio:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end
if DevRio:get(black..'Rio:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end
if DevRio:get(black..'Rio:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end
if DevRio:get(black..'Rio:Lock:Farsi'..msg.chat_id_) then lock_farsi = 'مقفله' else lock_farsi = 'مفتوحه' end
...
if text and text:match("^انطق (.*)$") and not DevRio:get(black..'Rio:Antk:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local Text ='* ✯ تم اختيار المتحركه لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/gif:"..msg.sender_user_id_}},{{text = '• 𝒄𝒉 zoro plus  ✯ •',url="t.me/BLACK_TEAM_4"}}} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/Gifblack/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Joker     --
...
local Text ='* ✯ تم اختيار مقطع الميمز لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/memz:"..msg.sender_user_id_}},{{text = '• 𝒄𝒉 zoro plus  ✯ •',url="t.me/BLACK_TEAM_4"}}} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/Memzblack/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Joker     --
...
local Text ='* ✯ تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/Song:"..msg.sender_user_id_}},{{text = '• 𝒄𝒉 zoro plus  ✯ •',url="t.me/BLACK_TEAM_4"}}} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/Audiosblack/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Joker     --
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/mp3:"..msg.sender_user_id_}},{{text = '• 𝒄𝒉 zoro plus  ✯ •',url="t.me/BLACK_TEAM_4"}}} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendAudio?chat_id=' .. msg.chat_id_ .. '&audio=https://t.me/blackMp3/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Joker     --
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/remix:"..msg.sender_user_id_}},{{text = '• 𝒄𝒉 zoro plus  ✯ •',url="t.me/BLACK_TEAM_4"}}} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/Remixblack/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Joker     --
...
local Text ='* ✯ تم اختيار الصوره لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/photo:"..msg.sender_user_id_}},{{text = '• 𝒄𝒉 zoro plus  ✯ •',url="t.me/BLACK_TEAM_4"}}} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Photosblack/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Joker     --
...
local Text ='* ✯ تم اختيار صورة الانمي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/anime:"..msg.sender_user_id_}},{{text = '• 𝒄𝒉 zoro plus  ✯ •',url="t.me/BLACK_TEAM_4"}}} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Animeblack/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Joker     --
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/Movies:"..msg.sender_user_id_}},{{text = '• 𝒄𝒉 zoro plus  ✯ •',url="t.me/BLACK_TEAM_4"}}} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Moviesblack/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Joker     --
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/series:"..msg.sender_user_id_}},{{text = '• 𝒄𝒉 zoro plus  ✯ •',url="t.me/BLACK_TEAM_4"}}} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Seriesblack/'..Rio..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Joker     --
if Admin(msg) then
if DevRio:get(black..'Rio:LockSettings'..msg.chat_id_) then 
if text == "الروابط" then if DevRio:get(black..'Rio:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end local blackTeam = "\n" .." ✯ الروابط ↫ "..mute_links.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, blackTeam, 1, 'md') end
if text == "المعرف" or text == "المعرفات" then if DevRio:get(black..'Rio:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفوله' else lock_tag = 'مفتوحه' end local blackTeam = "\n" .." ✯ المعرف ↫ "..lock_tag.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, blackTeam, 1, 'md') end
if text == "المتحركه" or text == "الملصقات المتحركه" then if DevRio:get(black..'Rio:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفوله' else mute_gifs = 'مفتوحه' end local blackTeam = "\n" .." ✯ المتحركه ↫ "..mute_gifs.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, blackTeam, 1, 'md') end
if text == "الملصقات" then if DevRio:get(black..'Rio:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفوله' else lock_sticker = 'مفتوحه' end local blackTeam = "\n" .." ✯ الملصقات ↫ "..lock_sticker.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, blackTeam, 1, 'md') end
if text == "الصور" then if DevRio:get(black..'Rio:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفوله' else mute_photo = 'مفتوحه' end local blackTeam = "\n" .." ✯ الصور ↫ "..mute_photo.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, blackTeam, 1, 'md') end
if text == "الفيديو" or text == "الفيديوهات" then if DevRio:get(black..'Rio:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفوله' else mute_video = 'مفتوحه' end local blackTeam = "\n" .." ✯ الفيديو ↫ "..mute_video.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, blackTeam, 1, 'md') end
if text == "الاونلاين" then if DevRio:get(black..'Rio:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفل' else mute_in = 'مفتوح' end local blackTeam = "\n" .." ✯ الاونلاين ↫ "..mute_in.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, blackTeam, 1, 'md') end
if text == "الدردشه" then if DevRio:get(black..'Rio:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه' end local blackTeam = "\n" .." ✯ الدردشه ↫ "..mute_text.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, blackTeam, 1, 'md') end
if text == "التوجيه" or text == "اعاده التوجيه" then if DevRio:get(black..'Rio:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفل' else lock_forward = 'مفتوح' end local blackTeam = "\n" .." ✯ التوجيه ↫ "..lock_forward.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, blackTeam, 1, 'md') end
if text == "الاغاني" then if DevRio:get(black..'Rio:Lock:Music'..msg.chat_id_) then mute_music = 'مقفوله' else mute_music = 'مفتوحه' end local blackTeam = "\n" .." ✯ الاغاني ↫ "..mute_music.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, blackTeam, 1, 'md') end
if text == "الصوت" or text == "الصوتيات" then if DevRio:get(black..'Rio:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفول' else mute_voice = 'مفتوح' end local blackTeam = "\n" .." ✯ الصوت ↫ "..mute_voice.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, blackTeam, 1, 'md') end
if text == "الجهات" or text == "جهات الاتصال" then if DevRio:get(black..'Rio:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفوله' else lock_contact = 'مفتوحه' end local blackTeam = "\n" .." ✯ الجهات ↫ "..lock_contact.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, blackTeam, 1, 'md') end
if text == "الماركداون" then if DevRio:get(black..'Rio:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفل' else markdown = 'مفتوح' end local blackTeam = "\n" .." ✯ الماركداون ↫ "..markdown.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, blackTeam, 1, 'md') end
if text == "الهاشتاك" then if DevRio:get(black..'Rio:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفل' else lock_htag = 'مفتوح' end local blackTeam = "\n" .." ✯ الهاشتاك ↫ "..lock_htag.."\n"Dev_Rio(msg.chat_id_, msg.id_, 1, blackTeam, 1, 'md') end
if text == "التعديل" then if DevRio:get(black..'Rio:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفل' else mute_edit = 'مفتوح' end local blackTeam = "\n" .." ✯ التعديل ↫ "..mute_edit.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, blackTeam, 1, 'md') end
if text == "التثبيت" then if DevRio:get(black..'Rio:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفل' else lock_pin = 'مفتوح' end local blackTeam = "\n" .." ✯ التثبيت ↫ "..lock_pin.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, blackTeam, 1, 'md') end
if text == "الاشعارات" then if DevRio:get(black..'Rio:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفوله' else lock_tgservice = 'مفتوحه' end local blackTeam = "\n" .." ✯ الاشعارات ↫ "..lock_tgservice.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, blackTeam, 1, 'md') end
if text == "الكلايش" then if DevRio:get(black..'Rio:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفوله' else lock_spam = 'مفتوحه' end local blackTeam = "\n" .." ✯ الكلايش ↫ "..lock_spam.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, blackTeam, 1, 'md') end
if text == "الدخول" then if DevRio:get(black..'Rio:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفول' else lock_Join = 'مفتوح' end local blackTeam = "\n" .." ✯ الدخول ↫ "..lock_Join.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, blackTeam, 1, 'md') end
if text == "الشبكات" then if DevRio:get(black..'Rio:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفوله' else lock_wp = 'مفتوحه' end local blackTeam = "\n" .." ✯ الشبكات ↫ "..lock_wp.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, blackTeam, 1, 'md') end
if text == "المواقع" then if DevRio:get(black..'Rio:Lock:Location'..msg.chat_id_) then lock_location = 'مقفوله' else lock_location = 'مفتوحه' end local blackTeam = "\n" .." ✯ المواقع ↫ "..lock_location.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, blackTeam, 1, 'md') end
if text == "العربيه" then if DevRio:get(black..'Rio:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفوله' else lock_arabic = 'مفتوحه' end local blackTeam = "\n" .." ✯ العربيه ↫ "..lock_arabic.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, blackTeam, 1, 'md') end
if text == "الانكليزيه" then if DevRio:get(black..'Rio:Lock:English'..msg.chat_id_) then lock_english = 'مقفوله' else lock_english = 'مفتوحه' end local blackTeam = "\n" .." ✯ الانكليزيه ↫ "..lock_english.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, blackTeam, 1, 'md') end
if text == "الكفر" then if DevRio:get(black..'Rio:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end local blackTeam = "\n" .." ✯ الكفر ↫ "..lock_kaf.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, blackTeam, 1, 'md') end
if text == "الفشار" then if DevRio:get(black..'Rio:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end local blackTeam = "\n" .." ✯ الفشار ↫ "..lock_fshar.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, blackTeam, 1, 'md') end
if text == "الطائفيه" then if DevRio:get(black..'Rio:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end local blackTeam = "\n" .." ✯ الطائفيه ↫ "..lock_taf.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, blackTeam, 1, 'md') end
end
--     Joker     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• تغير الرد •",callback_data="/ChangeRed:"..msg.sender_user_id_}},{{text="• الغاء •",callback_data="/CancelRed:"..msg.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(Text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end end
...
DevRio:set(black.."DelSudoRep",text)
keyboard = {} 
keyboard.inline_keyboard = {{{text="• تغير الرد •",callback_data="/ChangeAllRed:"..msg.sender_user_id_}},{{text="• الغاء •",callback_data="/CancelAllRed:"..msg.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(Text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end end
...
for k,v in pairs(redod) do
MsgRep = MsgRep..k..'~ (`'..v..'`) • {*العدد ↫ '..#DevRio:smembers(black..'Rio:Text:GpTexts'..v..msg.chat_id_)..'*}\n' 
end
if #redod == 0 then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح ردود المدير •",callback_data="/DelGpRed:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح ردود المطور •",callback_data="/DelGpRedAll:"..msg.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
if Sudo(msg) then
keyboard.inline_keyboard = {{{text="• مسح الاساسيين •",callback_data="/DelRioSudo:"..msg.sender_user_id_},{text="• مسح الثانويين •",callback_data="/DelSecondSudo:"..msg.sender_user_id_}},{{text="• مسح المطورين •",callback_data="/DelSudoBot:"..msg.sender_user_id_},{text="• مسح المالكين •",callback_data="/DelOwner:"..msg.sender_user_id_}},{{text="• مسح المنشئين الاساسيين •",callback_data="/DelBasicConstructor:"..msg.sender_user_id_},{text="• مسح المنشئين •",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..msg.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif RioSudo(msg) then
keyboard.inline_keyboard = {{{text="• مسح الثانويين •",callback_data="/DelSecondSudo:"..msg.sender_user_id_}},{{text="• مسح المطورين •",callback_data="/DelSudoBot:"..msg.sender_user_id_},{text="• مسح المالكين •",callback_data="/DelOwner:"..msg.sender_user_id_}},{{text="• مسح المنشئين الاساسيين •",callback_data="/DelBasicConstructor:"..msg.sender_user_id_},{text="• مسح المنشئين •",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..msg.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif SecondSudo(msg) then
...
keyboard.inline_keyboard = {{{text="• مسح المنشئين الاساسيين •",callback_data="/DelBasicConstructor:"..msg.sender_user_id_},{text="• مسح المنشئين •",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..msg.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif BasicConstructor(msg) then
keyboard.inline_keyboard = {{{text="• مسح المنشئين •",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..msg.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif Constructor(msg) then
keyboard.inline_keyboard = {{{text="• مسح المدراء •",callback_data="/DelManagers:"..msg.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif Manager(msg) then
keyboard.inline_keyboard = {{{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
elseif Admin(msg) then
keyboard.inline_keyboard = {{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• ᴄʜᴀɴɴᴇʟ ѕᴏụʀᴄᴇ•',url="t.me/BLACK_TEAM_4"}}}
end
Msg_id = msg.id_/2097152/0.5
...
Dev_Rio(msg.chat_id_, msg.id_, 1, ' ✯ جاري تحديث سورس زورو بلص', 1, 'md') 
os.execute('rm -rf black.lua.lua') 
os.execute('wget https://raw.githubusercontent.com/jokerrr7/jokjtihg/main/black.lua') 
dofile('black.lua') 
io.popen("rm -rf ../.telegram-cli/*")
...
DevRio:set(black..'Rio:NameBot',(DevRio:get(black..'Name:Bot') or 'زورو بلص'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/blackTeam8/blackFiles/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ✯ قائمة ملفات متجر سورس زورو بلص\n ✯ الملفات المتوفره حاليا ↫ ⤈\n       ‹ 𝘀𝗼𝘂𝗿𝗰𝗲 𝗯𝗹𝗮𝗰𝗸 ›\n"
local TextE = "       ‹ 𝘀𝗼𝘂𝗿𝗰𝗲 𝗯𝗹𝗮𝗰𝗸 ›\n ✯ علامة ↫ (✔) تعني الملف مفعل\n ✯ علامة ↫ (✖️) تعني الملف معطل\n"
local NumFile = 0
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/blackTeam8/blackFiles/master/blackFiles/"..FileName)
if Res == 200 then
...
--     Joker     --
if text == "مبرمج السورس" and ChCheck(msg) or text == "مطور السورس" and ChCheck(msg) or text == "جوكر" and ChCheck(msg) or text == "المبرمج" and ChCheck(msg) or text == "↫ مبرمج السورس ✯" and ChCheck(msg) then 
Text = [[
 ✯⤈ [چوڪرّ 𝐽𝑂𝐾𝐸𝑅𐇭](https://t.me/php_cx)
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'چوڪرّ 𝐽𝑂𝐾𝐸𝑅𐇭',url="t.me/php_cx"}}}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/php_cx&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
if text == "مبرمج السورس ²" and ChCheck(msg) or text == "مطور السورس ²" and ChCheck(msg) or text == "جاك" and ChCheck(msg) or text == "المبرمج ²" and ChCheck(msg) or text == "↫ مبرمج السورس ² ✯" and ChCheck(msg) then 
Text = [[
 ✯⤈ [𝗝𝗔𝗖𝗞 ](https://t.me/V_P_E)
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = 'چوڪرّ 𝐽𝑂𝐾𝐸𝑅𐇭',url="t.me/php_cx"}}}
local msg_id = msg.id_/2097152/0.5
