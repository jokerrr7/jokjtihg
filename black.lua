------------------------------------------------
-- This Source Was Developed By (Joker) @black.--
--   This Is The Source Channel @BLACK_TEAM_4 .     --
--                 - black -                 --        --
--         -- https://t.me/BLACK_TEAM_4 --          --
------------------------------------------------ 
bot_data  = dofile("./libs/redis.lua").connect("127.0.0.1", 6379)
...
bot_data:set(Server_black.."Idblack",xBoT) 
else 
print('\27[1;31m┋⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎┋\nلم يتم حفظ ايدي المطور الاساسي ارسله مره اخرى\n┋⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎┋') 
end 
...
Config = {
xBoT = bot_data:get(Server_black.."Idblack"),
...
FilesPrint = FilesPrint.."\27[35m".."┋⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎┋ ≈ ┉ ≈ ┉\n".."\27[m"
...
local Status = bot_data:sismember(black..'MARTEN:SecondSudo:',msg.sender_user_id_) 
...
local Status = bot_data:sismember(black..'MARTEN:SudoBot:',msg.sender_user_id_) 
...
local Status = bot_data:sismember(black..'MARTEN:ManagerAll:',msg.sender_user_id_) 
...
local Status = bot_data:sismember(black..'MARTEN:AdminAll:',msg.sender_user_id_) 
...
------ Vip Member All ------
function VipAll(msg) 
local Status = bot_data:sismember(black..'MARTEN:VipAll:',msg.sender_user_id_) 
...
----   Owner   ----
function Owner(msg) 
local Status = bot_data:sismember(black..'MARTEN:Owner:'..msg.chat_id_,msg.sender_user_id_) 
if Status or SudoBot(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
local Status = bot_data:sismember(black..'MARTEN:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = bot_data:sismember(black..'MARTEN:Constructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = bot_data:sismember(black..'MARTEN:Managers:'..msg.chat_id_,msg.sender_user_id_) 
...
----------  Admin  ---------
function Admin(msg) 
local Status = bot_data:sismember(black..'MARTEN:Admins:'..msg.chat_id_,msg.sender_user_id_) 
...
---------Vip Member---------
function VipMem(msg) 
local Status = bot_data:sismember(black..'MARTEN:VipMem:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = bot_data:sismember(black..'MARTEN:Cleaner:'..msg.chat_id_,msg.sender_user_id_) 
...
if bot_data:sismember(black..'MARTEN:Ban:'..chat_id, user_id) then
var = true
else
var = false
end
...
if bot_data:sismember(black..'MARTEN:BanAll:', user_id) then
var = true
else
var = false
end
...
if bot_data:sismember(black..'MARTEN:Muted:'..chat_id, user_id) then
var = true
else
var = false
end
...
if bot_data:sismember(black..'MARTEN:MuteAll:', user_id) then
var = true
else
var = false
end
...
vardump(JsonInfo)
bot_data:set(black.."MARTEN:NameBot",JsonInfo.BotName) 
for IdGps,v in pairs(JsonInfo.GroupsList) do
bot_data:sadd(black.."MARTEN:Groups",IdGps) 
bot_data:set(black.."MARTEN:Lock:Bots"..IdGps,"del") bot_data:hset(black.."MARTEN:Spam:Group:User"..IdGps ,"Spam:User","keed") 
...
bot_data:sadd(black..'MARTEN:Users',mem) 
print("\27[30;42m\n         ( تم رفع ( "..mem.." ) المشتركين )    \27[37;42m100%") 
end
if v.Owners then
for k,IdOwners in pairs(v.Owners) do
bot_data:sadd(black..'MARTEN:Owner:'..IdGps,IdOwners)  
print("\27[31;42m\n        ( تم رفع منشئين المجموعات )    \27[37;42m100%") 
end
end
if v.BasicConstructors then
for k,IdBasicConstructors in pairs(v.BasicConstructors) do
bot_data:sadd(black..'MARTEN:BasicConstructor:'..IdGps,IdBasicConstructors)  
print("\27[34;42m\n      ( تم رفع ( "..k.." ) منشئين اساسيين )  \27[37;42m100%") 
end
end
if v.Constructors then
for k,IdConstructors in pairs(v.Constructors) do
bot_data:sadd(black..'MARTEN:Constructor:'..IdGps,IdConstructors)  
print("\27[35;42m\n          ( تم رفع ( "..k.." ) منشئين )      \27[37;42m100%") 
end
end
if v.Managers then
for k,IdManagers in pairs(v.Managers) do
bot_data:sadd(black..'MARTEN:Managers:'..IdGps,IdManagers)  
...
vardump(IdAdmins)
bot_data:sadd(black..'MARTEN:Admins:'..IdGps,IdAdmins)  
print("\27[35;42m\n         ( تم رفع ( "..k.." ) ادمنيه )      \27[37;42m100%") 
end
end
if v.Vips then
for k,IdVips in pairs(v.Vips) do
bot_data:sadd(black..'MARTEN:VipMem:'..IdGps,IdVips)  
print("\27[34;42m\n          ( تم رفع ( "..k.." ) مميزين )      \27[37;42m100%") 
end
end
if v.LinkGroups then
if v.LinkGroups ~= "" then
bot_data:set(black.."MARTEN:Groups:Links"..IdGps,v.LinkGroups)   
print("\27[35;42m\n         ( تم وضع روابط المجموعات )    \27[37;42m100%") 
end
end
if v.Welcomes then
if v.Welcomes ~= "" then
bot_data:set(black.."MARTEN:Groups:Welcomes"..IdGps,v.Welcomes)   
print("\27[34;42m\n         ( تم وضع ترحيب المجموعات )    \27[37;42m100%") 
end
end
end
local List = bot_data:smembers(black..'MARTEN:Groups') 
local Members = bot_data:smembers(black..'MARTEN:Users')
local text = "𐇮 تم رفع النسخه بنجاح \n𐇮 تم رفع ↫ ( "..#Members.." ) مشترك في البوت\n𐇮 تم رفع وتفعيل ↫ ( "..#List.." ) مجموعة\n𐇮 تم استرجاع مشرفين المجموعات \n𐇮 تم استرجاع اوامر القفل والفتح في جميع مجموعات البوت \n●○━━━--     Source black     --━━━○●"
local inline = {{{text = '• Source black •',url='t.me/BLACK_TEAM_4'}},}
...
XboT = 'أأنڪـل مأأࢪتٺـن' elseif tonumber(user_id) == tonumber(black) then 
...
XboT = 'المطور الاساسي' 
elseif bot_data:sismember(black..'MARTEN:SecondSudo:', user_id) then 
XboT = 'المطور الثانوي' 
elseif bot_data:sismember(black..'MARTEN:SudoBot:', user_id) then 
XboT = bot_data:get(black.."MARTEN:SudoBot:Rd"..chat_id) or 'المطور' 
elseif bot_data:sismember(black..'MARTEN:ManagerAll:', user_id) then 
XboT = bot_data:get(black.."MARTEN:Managers:Rd"..chat_id) or 'المدير العام' 
elseif bot_data:sismember(black..'MARTEN:AdminAll:', user_id) then 
XboT = bot_data:get(black.."MARTEN:Admins:Rd"..chat_id) or 'الادمن العام' 
elseif bot_data:sismember(black..'MARTEN:VipAll:', user_id) then 
XboT = bot_data:get(black.."MARTEN:VipMem:Rd"..chat_id) or 'المميز العام' 
elseif bot_data:sismember(black..'MARTEN:Owner:'..chat_id, user_id) then 
XboT = 'المالك' 
elseif bot_data:sismember(black..'MARTEN:BasicConstructor:'..chat_id, user_id) then 
XboT = bot_data:get(black.."MARTEN:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' 
elseif bot_data:sismember(black..'MARTEN:Constructor:'..chat_id, user_id) then 
XboT = bot_data:get(black.."MARTEN:Constructor:Rd"..chat_id) or 'المنشئ' 
elseif bot_data:sismember(black..'MARTEN:Managers:'..chat_id, user_id) then 
XboT = bot_data:get(black.."MARTEN:Managers:Rd"..chat_id) or 'المدير' 
elseif bot_data:sismember(black..'MARTEN:Admins:'..chat_id, user_id) then 
XboT = bot_data:get(black.."MARTEN:Admins:Rd"..chat_id) or 'الادمن' 
elseif bot_data:sismember(black..'MARTEN:VipMem:'..chat_id, user_id) then  
XboT = bot_data:get(black.."MARTEN:VipMem:Rd"..chat_id) or 'المميز' 
elseif bot_data:sismember(black..'MARTEN:Cleaner:'..chat_id, user_id) then  
XboT = bot_data:get(black.."MARTEN:Cleaner:Rd"..chat_id) or 'المنظف' 
else XboT = bot_data:get(black.."MARTEN:mem:Rd"..chat_id) or 'العضو' 
end 
return XboT 
end
--     Source -black-     --
...
local MARTEN = (black..'MARTEN:Filters:'..msg.chat_id_)
if MARTEN then
...
local xBoT = black[math.random(#black)]
...
local var = true 
if bot_data:get(black.."MARTEN:ChId") then
local url , res = https.request('https://api.telegram.org/bot'..TokenBot..'/getchatmember?chat_id='..bot_data:get(black..'MARTEN:ChId')..'&user_id='..msg.sender_user_id_)
local data = json:decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
var = false 
if bot_data:get(black..'MARTEN:ChText') then
local ChText = bot_data:get(black..'MARTEN:ChText')
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChat?chat_id='..bot_data:get(black.."MARTEN:ChId"))
local GetInfo = JSON.decode(Check)
...
if bot_data:sismember(black..'MARTEN:Constructor:'..data.chat_id_, data.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if bot_data:sismember(black..'MARTEN:Managers:'..data.chat_id_, data.sender_user_id_) then
Managers = 'المدراء • ' else Managers = '' end
if bot_data:sismember(black..'MARTEN:Admins:'..data.chat_id_, data.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if bot_data:sismember(black..'MARTEN:VipMem:'..data.chat_id_, data.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if bot_data:sismember(black..'MARTEN:Cleaner:'..data.chat_id_, data.sender_user_id_) then
...
if bot_data:sismember(black..'MARTEN:Constructor:'..data.chat_id_, data.sender_user_id_) or bot_data:sismember(black..'MARTEN:Managers:'..data.chat_id_, data.sender_user_id_) or bot_data:sismember(black..'MARTEN:Admins:'..data.chat_id_, data.sender_user_id_) or bot_data:sismember(black..'MARTEN:VipMem:'..data.chat_id_, data.sender_user_id_) or bot_data:sismember(black..'MARTEN:Cleaner:'..data.chat_id_, data.sender_user_id_) or bot_data:sismember(black..'User:Donky:'..data.chat_id_, data.sender_user_id_) or bot_data:sismember(black..'User:HaTa:'..data.chat_id_, data.sender_user_id_)or bot_data:sismember(black..'User:hlo:'..data.chat_id_, data.sender_user_id_)or bot_data:sismember(black..'User:Sakl:'..data.chat_id_, data.sender_user_id_)or bot_data:sismember(black..'User:Dog:'..data.chat_id_, data.sender_user_id_)or bot_data:sismember(black..'User:Monkey:'..data.chat_id_, data.sender_user_id_)or bot_data:sismember(black..'User:Bakra:'..data.chat_id_, data.sender_user_id_)or bot_data:sismember(black..'User:Tale:'..data.chat_id_, data.sender_user_id_)or bot_data:sismember(black..'User:Zahf:'..data.chat_id_, data.sender_user_id_)or bot_data:sismember(black..'User:Jred:'..data.chat_id_, data.sender_user_id_)or bot_data:sismember(black..'User:Bro:'..data.chat_id_, data.sender_user_id_)or bot_data:sismember(black..'User:Bro:Girl'..data.chat_id_, data.sender_user_id_) then
bot_data:srem(black..'MARTEN:Constructor:'..data.chat_id_,data.sender_user_id_)
bot_data:srem(black..'MARTEN:Managers:'..data.chat_id_,data.sender_user_id_)
bot_data:srem(black..'MARTEN:Admins:'..data.chat_id_,data.sender_user_id_)
bot_data:srem(black..'MARTEN:VipMem:'..data.chat_id_,data.sender_user_id_)
bot_data:srem(black..'MARTEN:Cleaner:'..data.chat_id_,data.sender_user_id_)
...
if bot_data:get(black.."MARTEN:NewDev"..data.sender_user_id_) then
if DataText == '/setno' then
EditMsg(Chat_Id2, Msg_Id2, "𐇮 تم الغاء امر تغير المطور الاساسي") 
bot_data:del(black.."MARTEN:NewDev"..data.sender_user_id_)
return false
end
if DataText == '/setyes' then
local NewDev = bot_data:get(black.."MARTEN:NewDev"..data.sender_user_id_)
...
if DataText == '/YesRolet' and bot_data:get(black.."MARTEN:WittingStartRolet"..data.chat_id_..data.sender_user_id_) then
local List = bot_data:smembers(black..'MARTEN:ListRolet'..data.chat_id_) 
local UserName = List[math.random(#List)]
tdcli_function ({ID="SearchPublicChat",username_ = UserName},function(arg,dp) 
bot_data:incrby(black..'MARTEN:GamesNumber'..data.chat_id_..dp.id_, 5) 
end,nil) 
bot_data:del(black..'MARTEN:ListRolet'..data.chat_id_) 
bot_data:del(black.."MARTEN:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
EditMsg(Chat_Id2, Msg_Id2, "𐇮 *صاحب الحظ* ↫ ["..UserName.."]\n𐇮 *مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*")
end
if DataText == '/NoRolet' then
bot_data:del(black..'MARTEN:ListRolet'..data.chat_id_) 
bot_data:del(black.."MARTEN:NumRolet"..data.chat_id_..data.sender_user_id_) 
bot_data:del(black.."MARTEN:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
...
if bot_data:sismember(black..'MARTEN:Tkeed:'..Chat_Id2, data.sender_user_id_) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..Chat_Id2.."&user_id="..data.sender_user_id_.."&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
bot_data:srem(black..'MARTEN:Tkeed:'..Chat_Id2, data.sender_user_id_)
...
bot_data:sadd(black..'MARTEN:VipMem:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = MARTENId},function(arg,dp) 
bot_data:sadd(black..'MARTEN:Cleaner:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = MARTENId},function(arg,dp) 
bot_data:sadd(black..'MARTEN:Admins:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = MARTENId},function(arg,dp) 
bot_data:sadd(black..'MARTEN:Managers:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = MARTENId},function(arg,dp) 
bot_data:sadd(black..'MARTEN:Constructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = MARTENId},function(arg,dp) 
bot_data:sadd(black..'MARTEN:BasicConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = MARTENId},function(arg,dp) 
bot_data:sadd(black..'MARTEN:Owner:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = MARTENId},function(arg,dp) 
bot_data:sadd(black..'MARTEN:SudoBot:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = MARTENId},function(arg,dp) 
bot_data:sadd(black..'MARTEN:SecondSudo:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = MARTENId},function(arg,dp) 
bot_data:srem(black..'MARTEN:VipMem:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = MARTENId},function(arg,dp) 
bot_data:srem(black..'MARTEN:Cleaner:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = MARTENId},function(arg,dp) 
bot_data:srem(black..'MARTEN:Admins:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = MARTENId},function(arg,dp) 
bot_data:srem(black..'MARTEN:Managers:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = MARTENId},function(arg,dp) 
bot_data:srem(black..'MARTEN:Constructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = MARTENId},function(arg,dp) 
bot_data:srem(black..'MARTEN:BasicConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = MARTENId},function(arg,dp) 
bot_data:srem(black..'MARTEN:Owner:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = MARTENId},function(arg,dp) 
bot_data:srem(black..'MARTEN:SudoBot:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = MARTENId},function(arg,dp) 
bot_data:srem(black..'MARTEN:SecondSudo:'..data.chat_id_,dp.id_)
...
bot_data:sadd(black..'MARTEN:Muted:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'𐇮 العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'BLACK_TEAM_4')..')\n𐇮 تم كتمه من المجموعه')
end
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = MARTENId},function(arg,dp) 
bot_data:srem(black..'MARTEN:Muted:'..data.chat_id_,dp.id_)
...
bot_data:sadd(black..'MARTEN:Ban:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'𐇮 العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'BLACK_TEAM_4')..')\n𐇮 تم حظره من المجموعه')
end
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = MARTENId},function(arg,dp) 
bot_data:srem(black..'MARTEN:Ban:'..data.chat_id_,dp.id_)
...
bot_data:sadd(black..'MARTEN:Tkeed:'..data.chat_id_,dp.id_)
...
bot_data:srem(black..'MARTEN:Tkeed:'..data.chat_id_,dp.id_)
...
keyboard = {} 
if Sudo(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..MARTENId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..MARTENId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..MARTENId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..MARTENId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..MARTENId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..MARTENId}},{{text="تنزيل مالك",callback_data=data.sender_user_id_..":RemOwner:"..MARTENId},{text="تنزيل مطور",callback_data=data.sender_user_id_..":RemSudoBot:"..MARTENId}},{{text="تنزيل مطور ثانوي",callback_data=data.sender_user_id_..":RemSecondSudo:"..MARTENId}},{{text = '• Source black •',url="t.me/BLACK_TEAM_4"}}}
elseif SecondSudo(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..MARTENId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..MARTENId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..MARTENId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..MARTENId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..MARTENId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..MARTENId}},{{text="تنزيل مالك",callback_data=data.sender_user_id_..":RemOwner:"..MARTENId},{text="تنزيل مطور",callback_data=data.sender_user_id_..":RemSudoBot:"..MARTENId}},{{text = '• Source black •',url="t.me/BLACK_TEAM_4"}}}
elseif SudoBot(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..MARTENId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..MARTENId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..MARTENId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..MARTENId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..MARTENId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..MARTENId}},{{text="تنزيل مالك",callback_data=data.sender_user_id_..":RemOwner:"..MARTENId}},{{text = '• Source black •',url="t.me/BLACK_TEAM_4"}}}
elseif Owner(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..MARTENId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..MARTENId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..MARTENId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..MARTENId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..MARTENId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..MARTENId}},{{text = '• Source black •',url="t.me/BLACK_TEAM_4"}}}
elseif BasicConstructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..MARTENId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..MARTENId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..MARTENId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..MARTENId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..MARTENId}},{{text = '• Source black •',url="t.me/BLACK_TEAM_4"}}}
elseif Constructor(data) then
...
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..MARTENId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..MARTENId}},{{text = '• Source black •',url="t.me/BLACK_TEAM_4"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..MARTENId}},{{text = '• Source black •',url="t.me/BLACK_TEAM_4"}}}
end 
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
end
...
local Del = bot_data:get(black..'MARTEN:Del')
local ListSecondSudo = bot_data:scard(black.."MARTEN:SecondSudo:")
local ListSudoBot = bot_data:scard(black.."MARTEN:SudoBot:")
local ListOwner = bot_data:scard(black.."MARTEN:Owner:"..data.chat_id_)
local ListBasicConstructor = bot_data:scard(black.."MARTEN:BasicConstructor:"..data.chat_id_)
local ListConstructor = bot_data:scard(black.."MARTEN:Constructor:"..data.chat_id_)
local ListManagers = bot_data:scard(black.."MARTEN:Managers:"..data.chat_id_)
local ListAdmins = bot_data:scard(black.."MARTEN:Admins:"..data.chat_id_)
local ListVipMem = bot_data:scard(black.."MARTEN:VipMem:"..data.chat_id_)
local ListCleaner = bot_data:scard(black.."MARTEN:Cleaner:"..data.chat_id_)
local Text = [[
𐇮 اهلاً بك في قائمـة اوامر الرتب ↫ ⤈ 🪜
┋⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎┋
𐇮 يمكنك مسح رتب المجموعـة من خلال الازرار اسفل ↫ ⤈ 
┋⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎┋
» [𝐬𝐨𝐮𝐫𝐜𝐞](https://t.me/BLACK_TEAM_4)➤
]] 
keyboard = {} 
if Sudo(data) then
...
bot_data:del(black..'MARTEN:SecondSudo:')
...
bot_data:del(black..'MARTEN:SudoBot:')
...
bot_data:del(black..'MARTEN:Owner:'..data.chat_id_)
...
bot_data:del(black..'MARTEN:BasicConstructor:'..data.chat_id_)
...
bot_data:del(black..'MARTEN:Constructor:'..data.chat_id_)
Text = "*𐇮 تم حذف المنشئين*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
...
bot_data:del(black..'MARTEN:Managers:'..data.chat_id_)
Text = "*𐇮 تم حذف المدراء*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
bot_data:del(black..'MARTEN:Admins:'..data.chat_id_)
...
bot_data:del(black..'MARTEN:VipMem:'..data.chat_id_)
...
bot_data:del(black..'MARTEN:Cleaner:'..data.chat_id_)
...
if tonumber(MARTEN) == tonumber(data.sender_user_id_) then
local Filter = bot_data:get(black..'MARTEN:Filter')
local Text = [[
...
bot_data:del(black.."MARTEN:FilterAnimation"..data.chat_id_)
Text = "*𐇮 تم حذف جميع المتحركات الممنوعه بنجاح*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• رجوع •",callback_data="/FilterList:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
bot_data:del(black.."MARTEN:FilterSteckr"..data.chat_id_)
...
bot_data:del(black.."MARTEN:FilterPhoto"..data.chat_id_)
...
bot_data:del(black..'MARTEN:Filters:'..data.chat_id_)
...
if tonumber(MARTEN) == tonumber(data.sender_user_id_) then
local locklist = bot_data:get(black..'MARTEN:locklist')
local Text = [[
...
--     source -black-     --
if bot_data:hget(black.."MARTEN:Spam:Group:User"..data.chat_id_, "Spam:User") == "kick" then     
flood = "بالطرد"     
elseif bot_data:hget(black.."MARTEN:Spam:Group:User"..data.chat_id_,"Spam:User") == "keed" then     
flood = "بالتقيد"     
elseif bot_data:hget(black.."MARTEN:Spam:Group:User"..data.chat_id_,"Spam:User") == "mute" then     
flood = "بالكتم"           
elseif bot_data:hget(black.."MARTEN:Spam:Group:User"..data.chat_id_,"Spam:User") == "del" then     
flood = "بالحذف"
else     
flood = "🟢"     
end
--     source -black-     --
if bot_data:get(black.."MARTEN:Lock:Bots"..data.chat_id_) == "del" then
lock_bots = "بالحذف"
elseif bot_data:get(black.."MARTEN:Lock:Bots"..data.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif bot_data:get(black.."MARTEN:Lock:Bots"..data.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "🟢"    
end
--     source -black-     --
if bot_data:get(black..'MARTEN:Lock:Text'..data.chat_id_) then mute_text = '🔴' else mute_text = '🟢'end
if bot_data:get(black..'MARTEN:Lock:Join'..data.chat_id_) then lock_Join = '🔴' else lock_Join = '🟢' end
if bot_data:get(black..'MARTEN:Lock:TagServr'..data.chat_id_) then lock_tgservice = '🔴' else lock_tgservice = '🟢' end
if bot_data:get(black..'MARTEN:Lock:EditMsgs'..data.chat_id_) then mute_edit = '🔴' else mute_edit = '🟢' end
if bot_data:get(black..'MARTEN:Lock:Stickers'..data.chat_id_) then lock_sticker = '🔴' else lock_sticker = '🟢' end
if bot_data:get(black..'MARTEN:Lock:Gifs'..data.chat_id_) then mute_gifs = '🔴' else mute_gifs = '🟢' end
if bot_data:get(black..'MARTEN:Lock:Videos'..data.chat_id_) then mute_video = '🔴' else mute_video = '🟢' end
if bot_data:get(black..'MARTEN:Lock:Photo'..data.chat_id_) then mute_photo = '🔴' else mute_photo = '🟢' end
if bot_data:get(black..'MARTEN:Lock:Forwards'..data.chat_id_) then lock_forward = '🔴' else lock_forward = '🟢' end
keyboard = {} 
keyboard.inline_keyboard = {
...
if tonumber(MARTEN) == tonumber(data.sender_user_id_) then
local LockBotList = bot_data:get(black..'MARTEN:LockBotList')
local Text = [[
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• قفل البوتات بالطرد •",callback_data="/lockBotKick:"..data.sender_user_id_},{text="• قفل البوتات بالتقيد •",callback_data="/lockBotKed:"..data.sender_user_id_}},{{text="• قفل البوتات بالكتم •",callback_data="/lockBotDel:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
--     source -black-     --
...
if tonumber(MARTEN) == tonumber(data.sender_user_id_) then
local LockSpamList = bot_data:get(black..'MARTEN:LockSpamList')
local Text = [[
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• قفل التكرار بالطرد •",callback_data="/lockSpamKick:"..data.sender_user_id_},{text="• قفل التكرار بالتقيد •",callback_data="/lockSpamKed:"..data.sender_user_id_}},{{text="• قفل التكرار بالحذف •",callback_data="/lockSpamDel:"..data.sender_user_id_},{text="• قفل التكرار بالكتم •",callback_data="/lockSpamMute:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
--     source -black-     --
if DataText =='/lockjoin:'..data.sender_user_id_ then
if not bot_data:get(black..'MARTEN:Lock:Join'..data.chat_id_) then
bot_data:set(black..'MARTEN:Lock:Join'..data.chat_id_,true)
Text = "*𐇮 تم قفل الدخول بنجاح*\n•-› X"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
...
if bot_data:get(black..'MARTEN:Lock:Join'..data.chat_id_) then
bot_data:del(black..'MARTEN:Lock:Join'..data.chat_id_)
...
if not bot_data:get(black..'MARTEN:Lock:Text'..data.chat_id_) then
bot_data:set(black..'MARTEN:Lock:Text'..data.chat_id_,true)
...
if bot_data:get(black..'MARTEN:Lock:Text'..data.chat_id_) then
bot_data:del(black..'MARTEN:Lock:Text'..data.chat_id_)
...
if not bot_data:get(black..'MARTEN:Lock:TagServr'..data.chat_id_) then
bot_data:set(black..'MARTEN:Lock:TagServr'..data.chat_id_,true)
...
if bot_data:get(black..'MARTEN:Lock:TagServr'..data.chat_id_) then
bot_data:del(black..'MARTEN:Lock:TagServr'..data.chat_id_) 
...
if not bot_data:get(black..'MARTEN:Lock:EditMsgs'..data.chat_id_) then
bot_data:set(black..'MARTEN:Lock:EditMsgs'..data.chat_id_,true)
...
if bot_data:get(black..'MARTEN:Lock:EditMsgs'..data.chat_id_) then
bot_data:del(black..'MARTEN:Lock:EditMsgs'..data.chat_id_)
...
if not bot_data:get(black..'MARTEN:Lock:Stickers'..data.chat_id_) then
bot_data:set(black..'MARTEN:Lock:Stickers'..data.chat_id_,true)
...
if bot_data:get(black..'MARTEN:Lock:Stickers'..data.chat_id_) then
bot_data:del(black..'MARTEN:Lock:Stickers'..data.chat_id_)
...
if not bot_data:get(black..'MARTEN:Lock:Gifs'..data.chat_id_) then
bot_data:set(black..'MARTEN:Lock:Gifs'..data.chat_id_,true)
...
if bot_data:get(black..'MARTEN:Lock:Gifs'..data.chat_id_) then
bot_data:del(black..'MARTEN:Lock:Gifs'..data.chat_id_)
...
if not bot_data:get(black..'MARTEN:Lock:Photo'..data.chat_id_) then
bot_data:set(black..'MARTEN:Lock:Photo'..data.chat_id_,true) 
...
if bot_data:get(black..'MARTEN:Lock:Photo'..data.chat_id_) then
bot_data:del(black..'MARTEN:Lock:Photo'..data.chat_id_)
...
if not bot_data:get(black..'MARTEN:Lock:Videos'..data.chat_id_) then
bot_data:set(black..'MARTEN:Lock:Videos'..data.chat_id_,true)
...
if bot_data:get(black..'MARTEN:Lock:Videos'..data.chat_id_) then
bot_data:del(black..'MARTEN:Lock:Videos'..data.chat_id_)
...
if not bot_data:get(black..'MARTEN:Lock:Forwards'..data.chat_id_) then
bot_data:set(black..'MARTEN:Lock:Forwards'..data.chat_id_,true)
...
if bot_data:get(black..'MARTEN:Lock:Forwards'..data.chat_id_) then
bot_data:del(black..'MARTEN:Lock:Forwards'..data.chat_id_) 
...
bot_data:set(black.."MARTEN:Lock:Bots"..data.chat_id_,"kick")  
Text = "*𐇮 تم قفل البوتات بالطرد بنجاح*\n•-› X"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/LockBotList:"..data.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if DataText =='/lockBotKed:'..data.sender_user_id_ then
bot_data:set(black.."MARTEN:Lock:Bots"..data.chat_id_,"ked")   
...
bot_data:set(black.."MARTEN:Lock:Bots"..data.chat_id_,"del")  
...
bot_data:del(black.."MARTEN:Lock:Bots"..data.chat_id_) 
...
bot_data:hset(black.."MARTEN:Spam:Group:User"..data.chat_id_ ,"Spam:User","kick")  
Text = "*𐇮 تم قفل التكرار بالطرد بنجاح*\n•-› X"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/LockSpamList:"..data.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if DataText =='/lockSpamKed:'..data.sender_user_id_ then
bot_data:hset(black.."MARTEN:Spam:Group:User"..data.chat_id_ ,"Spam:User","keed")  
...
bot_data:hset(black.."MARTEN:Spam:Group:User"..data.chat_id_ ,"Spam:User","del")  
...
bot_data:hset(black.."MARTEN:Spam:Group:User"..data.chat_id_ ,"Spam:User","mute")  
...
bot_data:hdel(black.."MARTEN:Spam:Group:User"..data.chat_id_ ,"Spam:User")  
...
local List = bot_data:smembers(black..'MARTEN:SecondSudo:')
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح الثانويين •",callback_data="/DelSecondSudo:"..data.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     source -black-     --
...
local List = bot_data:smembers(black..'MARTEN:SudoBot:')
text = "𐇮 قائمة المطورين ↫ ⤈ \n┋⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎┋\n"
for k,v in pairs(List) do
local sudouser = bot_data:get(black..'MARTEN:Sudos'..v) 
local username = bot_data:get(black..'Save:UserName'..v)
if username then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المطورين •",callback_data="/DelSudoBot:"..data.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     source -black-     --
...
local List = bot_data:smembers(black..'MARTEN:Owner:'..Chat_Id2)
text = "𐇮 قائمة المالكين ↫ ⤈ \n┋⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎┋\n"
for k,v in pairs(List) do
local username = bot_data:get(black..'Save:UserName'..v)
if username then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المالكين •",callback_data="/DelOwner:"..data.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     source -black-     --
...
local List = bot_data:smembers(black..'MARTEN:BasicConstructor:'..Chat_Id2)
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المنشئين الاساسيين •",callback_data="/DelBasicConstructor:"..data.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     source -black-     --
...
local List = bot_data:smembers(black..'MARTEN:Constructor:'..Chat_Id2)
text = "𐇮 قائمة المنشئين ↫ ⤈ \n┋⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎┋\n"
for k,v in pairs(List) do
local username = bot_data:get(black..'Save:UserName'..v)
if username then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المنشئين •",callback_data="/DelConstructor:"..data.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     source -black-     --
...
local List = bot_data:smembers(black..'MARTEN:Managers:'..Chat_Id2)
text = "𐇮 قائمة المدراء ↫ ⤈ \n┋⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎┋\n"
for k,v in pairs(List) do
local username = bot_data:get(black..'Save:UserName'..v)
if username then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المدراء •",callback_data="/DelManager:"..data.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     source -black-     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..data.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     source -black-     --
...
local List = bot_data:smembers(black..'MARTEN:VipMem:'..Chat_Id2)
text = "𐇮 قائمة المميزين ↫ ⤈ \n┋⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎┋\n"
for k,v in pairs(List) do
local username = bot_data:get(black..'Save:UserName'..v)
if username then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المميزين •",callback_data="/DelVipMem:"..data.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     source -black-     --
...
local List = bot_data:smembers(black..'MARTEN:Cleaner:'..Chat_Id2)
text = "𐇮 قائمة المنظفين ↫ ⤈ \n┋⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎┋\n"
for k,v in pairs(List) do
local username = bot_data:get(black..'Save:UserName'..v)
if username then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المنظفين •",callback_data="/DelCleanr:"..data.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     source -black-     --
...
DeleteMessage(Chat_Id2,{[0] = MsgId2})
keyboard = {} 
keyboard.inline_keyboard = {{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..Chat_Id2..'&text=' .. URL.escape(text).."&reply_to_message_id="..get.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if bot_data:get(black.."MARTEN:Left:Bot"..black) then
...
bot_data:srem(black.."MARTEN:Groups",data.chat_id_)
end           
--     source -black-     -- 
...
bot_data:sadd(black..'MARTEN:Admins:'..data.chat_id_, admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
bot_data:srem(black..'MARTEN:Admins:'..data.chat_id_, admins[i].user_id_)
end
end,nil)
else
bot_data:sadd(black..'MARTEN:Admins:'..data.chat_id_, admins[i].user_id_)
...
bot_data:sadd(black.."MARTEN:BasicConstructor:"..data.chat_id_,admins[i].user_id_)
bot_data:sadd(black.."MARTEN:Owner:"..data.chat_id_,admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
bot_data:srem(black.."MARTEN:BasicConstructor:"..data.chat_id_,admins[i].user_id_)
bot_data:srem(black.."MARTEN:Owner:"..data.chat_id_,admins[i].user_id_)
end
end,nil)  
end 
end
end,nil)
if bot_data:sismember(black..'MARTEN:Groups',data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, '𐇮 المجموعه بالتاكيد مفعله')
else
Text = "𐇮 تم تفعيل المجموعه "..dp.title_
keyboard = {} 
keyboard.inline_keyboard = {{{text="• ترتيب الاوامر •",callback_data="/SetCmdGpPic:"..data.sender_user_id_},{text="• رفع الادمنيه •",callback_data="/UploadAdminPic:"..data.sender_user_id_}},{{text="• غادر •",callback_data="/LeaveBotPic:"..data.sender_user_id_},{text="• تعطيل •",callback_data="/StopPic:"..data.sender_user_id_}},{{text="𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊",url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/EditMessagecaption?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&caption=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
bot_data:sadd(black.."MARTEN:Groups",data.chat_id_)
if not bot_data:get(black..'MARTEN:SudosGp'..data.sender_user_id_..data.chat_id_) and not SecondSudo(data) then 
bot_data:incrby(black..'MARTEN:Sudos'..data.sender_user_id_,1)
bot_data:set(black..'MARTEN:SudosGp'..data.sender_user_id_..data.chat_id_,"MArRten")
end
...
bot_data:set(black.."MARTEN:Groups:Links"..data.chat_id_,LinkGroup) 
...
tdcli_function ({ID = "GetUser",user_id_ = data.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=data.chat_id_},function(arg,dp) 
if not bot_data:sismember(black..'MARTEN:Groups',data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "𐇮 المجموعه بالتاكيد معطله") 
else
Text = "𐇮 تم تعطيل المجموعه "..dp.title_
keyboard = {}
keyboard.inline_keyboard = {{{text="• غادر •",callback_data="/LeaveBotPic:"..data.sender_user_id_},{text="• تفعيل •",callback_data="/OnPic:"..data.sender_user_id_}},{{text="𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊",url="t.me/BLACK_TEAM_4"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/EditMessagecaption?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&caption=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
bot_data:srem(black.."MARTEN:Groups",data.chat_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/CmdList:"..data.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• رجوع •",callback_data="/ReloadPic:"..data.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
...
bot_data:sadd(black..'MARTEN:BasicConstructor:'..data.chat_id_,Manager_id)  
bot_data:sadd(black..'MARTEN:Owner:'..data.chat_id_,Manager_id)   
end  
end  
if num == 0 then
...
if tonumber(MARTEN) == tonumber(data.sender_user_id_) then
local Media = bot_data:get(black..'MARTEN:Media')
local Text = [[
...
local List = bot_data:smembers(black.."MARTEN:cleaner"..data.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/MediaHome:"..data.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
...
local List = bot_data:smembers(black.."MARTEN:cleanermusic"..data.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
bot_data:del(black.."MARTEN:cleanermusic"..data.chat_id_)
else
...
bot_data:del(black..'MARTEN:Text:GpTexts'..S0FI..data.chat_id_)
bot_data:srem(black..'MARTEN:Manager:GpRedod'..data.chat_id_,S0FI)
end
if DataText and DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)') then
local S0FI = DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)')
local List = bot_data:smembers(black..'MARTEN:Text:GpTexts'..S0FI..data.chat_id_)
if bot_data:get(black..'MARTEN:Add:GpRedod'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "𐇮 تم انهاء وحفظ ↫ "..#List.." من الردود المتعدده للامر ↫ "..S0FI) 
bot_data:del(black..'MARTEN:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
else
...
bot_data:del(black..'MARTEN:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
bot_data:del(black..'MARTEN:Text:GpTexts'..S0FI..data.chat_id_)
bot_data:del(black..'MARTEN:Add:GpTexts'..data.sender_user_id_..data.chat_id_)
bot_data:srem(black..'MARTEN:Manager:GpRedod'..data.chat_id_,S0FI)
else
EditMsg(Chat_Id2, Msg_Id2, "𐇮 عذرا صلاحية الامر منتهيه !") 
end
...
if tonumber(S0FI) == tonumber(data.sender_user_id_) then
local Help = bot_data:get(black..'MARTEN:Help')
local Text = [[
...
local Help = bot_data:get(black..'MARTEN:Help1')
local Text = [[
...
local Help = bot_data:get(black..'MARTEN:Help2')
local Text = [[
𐇮 اوامر الادمنيه ↫ ⤈
┋⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎┋
𐇮 الاعدادت
...
local Help = bot_data:get(black..'MARTEN:Help3')
local Text = [[
𐇮 اوامر المدراء ↫ ⤈
┋⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎┋
𐇮 فحص البوت
...
local Help = bot_data:get(black..'MARTEN:Help4')
local Text = [[
𐇮 اوامر المنشئين ↫ ⤈
┋⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎┋
𐇮 تنزيل الكل
...
local Help = bot_data:get(black..'MARTEN:Help5')
local Text = [[
𐇮 اوامر المطورين ↫ ⤈
┋⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎┋
𐇮 الكروبات
...
if tonumber(S0FI) == tonumber(data.sender_user_id_) then
local Help = bot_data:get(black..'MARTEN:Help6')
local Text = [[
𐇮 اوامر الاعضاء ↫ ⤈
┋⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎┋
...
if text and text:match('^'..(bot_data:get(black..'MARTEN:NameBot') or "بلاك")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(bot_data:get(black..'MARTEN:NameBot') or "بلاك")..' ','')
end
...
for k,v in pairs(List) do
var = bot_data:get(black.."Comd:New:rt:MARTEN:"..v..msg.chat_id_)
if var then
t = t..k.."~ "..v.." • ("..var..")\n"
else
t = t..k.."~ "..v.."\n"
...
local List = bot_data:smembers(black.."Coomds"..msg.chat_id_)
for k,v in pairs(List) do
bot_data:del(black.."Comd:New:rt:MARTEN:"..v..msg.chat_id_)
...
bot_data:del(black.."Comd:New:rt:MARTEN:"..ComdNew..msg.chat_id_)
...
bot_data:set(black.."Comd:New:rt:MARTEN:"..textn..msg.chat_id_,text)
...
local mrMARTEN = bot_data:get(black.."Comd:New:rt:MARTEN:"..DEV_MaRTeN..msg.chat_id_)
...
bot_data:sadd(black..'MARTEN:VipMem:'..msg.chat_id_, result.sender_user_id_)
elseif mrMARTEN == "ادمن" and Admin(msg) then 
send_X(msg.chat_id_, msg.id_, 1, '𐇮 العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'BLACK_TEAM_4')..')'..' ❩\n𐇮 تم رفعه ❨ '..DEV_MaRTeN..' ❩ بنجاح', 1, 'md')
bot_data:set(black.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_MaRTeN)
bot_data:sadd(black..'MARTEN:Admins:'..msg.chat_id_, result.sender_user_id_)
elseif mrMARTEN == "مدير" and Manager(msg) then
send_X(msg.chat_id_, msg.id_, 1, '𐇮 العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'BLACK_TEAM_4')..')'..' ❩\n𐇮 تم رفعه ❨ '..DEV_MaRTeN..' ❩ بنجاح', 1, 'md')
bot_data:set(black.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_MaRTeN)  
bot_data:sadd(black..'MARTEN:Managers:'..msg.chat_id_, result.sender_user_id_)
...
bot_data:srem(black..'MARTEN:VipMem:'..msg.chat_id_, result.sender_user_id_)
bot_data:del(black.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrMARTEN == "ادمن" and Admin(msg) then 
send_X(msg.chat_id_, msg.id_, 1, '𐇮 العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'BLACK_TEAM_4')..')'..' ❩\n𐇮 تم تنزيله ❨ '..DEV_MaRTeN..' ❩ بنجاح', 1, 'md')
bot_data:srem(black..'MARTEN:Admins:'..msg.chat_id_, result.sender_user_id_)
bot_data:del(black.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrMARTEN == "مدير" and Manager(msg) then
send_X(msg.chat_id_, msg.id_, 1, '𐇮 العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'BLACK_TEAM_4')..')'..' ❩\n𐇮 تم تنزيله ❨ '..DEV_MaRTeN..' ❩ بنجاح', 1, 'md')
bot_data:srem(black..'MARTEN:Managers:'..msg.chat_id_, result.sender_user_id_)
bot_data:del(black.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrMARTEN == "عضو" then
send_X(msg.chat_id_, msg.id_, 1, '𐇮 العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'BLACK_TEAM_4')..')'..' ❩\n𐇮 تم تنزيله ❨ '..DEV_MaRTeN..' ❩ بنجاح', 1, 'md')
end
...
if result.id_ then
local mrMARTEN = bot_data:get(black.."Comd:New:rt:MARTEN:"..text1[2]..msg.chat_id_)
if mrMARTEN == "مميز" and VipMem(msg) then
send_X(msg.chat_id_, msg.id_, 1, '𐇮 العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'BLACK_TEAM_4')..')'..' ❩\n𐇮 تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
bot_data:sadd(black..'MARTEN:VipMem:'..msg.chat_id_, result.id_)
bot_data:set(black.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrMARTEN == "ادمن" and Admin(msg) then 
send_X(msg.chat_id_, msg.id_, 1, '𐇮 العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'BLACK_TEAM_4')..')'..' ❩\n𐇮 تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
bot_data:sadd(black..'MARTEN:Admins:'..msg.chat_id_, result.id_)
bot_data:set(black.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrMARTEN == "مدير" and Manager(msg) then
send_X(msg.chat_id_, msg.id_, 1, '𐇮 العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'BLACK_TEAM_4')..')'..' ❩\n𐇮 تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
bot_data:sadd(black..'MARTEN:Managers:'..msg.chat_id_, result.id_)
bot_data:set(black.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrMARTEN == "عضو" then
send_X(msg.chat_id_, msg.id_, 1, '𐇮 العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'BLACK_TEAM_4')..')'..' ❩\n𐇮 تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
bot_data:srem(black..'MARTEN:VipMem:'..msg.chat_id_, result.id_)
bot_data:del(black.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrMARTEN == "ادمن" and Admin(msg) then 
send_X(msg.chat_id_, msg.id_, 1, '𐇮 العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'BLACK_TEAM_4')..')'..' ❩\n𐇮 تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
bot_data:srem(black..'MARTEN:Admins:'..msg.chat_id_, result.id_)
bot_data:del(black.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrMARTEN == "مدير" and Manager(msg) then
send_X(msg.chat_id_, msg.id_, 1, '𐇮 العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'BLACK_TEAM_4')..')'..' ❩\n𐇮 تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
bot_data:srem(black..'MARTEN:Managers:'..msg.chat_id_, result.id_)
bot_data:del(black.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrMARTEN == "عضو" then
send_X(msg.chat_id_, msg.id_, 1, '𐇮 العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'BLACK_TEAM_4')..')'..' ❩\n𐇮 تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
bot_data:incr(black..'MARTEN:UsersMsgs'..black..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_)
bot_data:incr(black..'MARTEN:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
bot_data:incr(black..'MARTEN:MsgNumberDay'..msg.chat_id_..':'..os.date('%d'))  
ChatType = 'sp' 
elseif id:match("^(%d+)") then
if not bot_data:sismember(black.."MARTEN:Users",msg.chat_id_) then
bot_data:sadd(black.."MARTEN:Users",msg.chat_id_)
end
ChatType = 'pv' 
else
ChatType = 'gp' 
...
if not bot_data:get(black..'MARTEN:Start:Time'..msg.sender_user_id_) then
...
{{text="⌯ المطور .",url="t.me/"..dp.username_ or "BLACK_TEAM_4"},{text="⌯ شراء بوت .",url="t.me/BLACK_TEAM_4bot"}}}
local start = bot_data:get(black.."MARTEN:Start:Bot")
if start then 
Start_Source = start
else
...
bot_data:setex(black..'MARTEN:Start:Time'..msg.sender_user_id_,300,true)
return false
end 
--     Source -black-     --
if not SecondSudo(msg) and not bot_data:sismember(black..'MARTEN:Ban:Pv',msg.sender_user_id_) and not bot_data:get(black..'MARTEN:Texting:Pv') then
...
bot_data:sadd(black..'MARTEN:Ban:Pv',data.id_)  
return false  
end 
if text == 'الغاء الحظر' or text == 'الغاء حظر' then
local Text = '𐇮 العضو ↫ ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\n𐇮 تم الغاء حظره من التواصل'
SendText(xBoT,Text,msg.id_/2097152/0.5,'md') 
bot_data:srem(black..'MARTEN:Ban:Pv',data.id_)  
return false  
end 
...
--     Source -black-     --
if text and bot_data:get(black..'MARTEN:Start:Bots'..msg.sender_user_id_) then
if text == 'الغاء' then   
send_X(msg.chat_id_, msg.id_, 1, '𐇮 تم الغاء حفظ كليشة الستارت', 1, 'md')
bot_data:del(black..'MARTEN:Start:Bots'..msg.sender_user_id_) 
return false
end
bot_data:set(black.."MARTEN:Start:Bot",text)  
...
bot_data:set(black..'MARTEN:Start:Bots'..msg.sender_user_id_,true) 
...
bot_data:incr(black..'MARTEN:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)
bot_data:set(black.."Who:Added:Me"..msg.chat_id_..':'..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = bot_data:get(black.."MARTEN:Lock:Bots"..msg.chat_id_) 
for i=0,#mem_id do  
...
bot_data:sadd(black..'MARTEN:Tkeed:'..msg.chat_id_, msg.sender_user_id_)
GetInfo = https.request("https://api.telegram.org/bot"..TokenBot.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local JsonInfo = JSON.decode(GetInfo)
if JsonInfo.ok == true and #mem_id == i then
local Msgs = {}
...
bot_data:srem(black.."MARTEN:Groups", msg.chat_id_) 
...
if bot_data:get(black..'MARTEN:Lock:TagServr'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})    
end   
end
if msg.content_.ID == "MessageChatJoinByLink" or msg.content_.ID == "MessageChatAddMembers" then   
bot_data:incr(black..'MARTEN:EntryNumber'..msg.chat_id_..':'..os.date('%d'))  
elseif msg.content_.ID == "MessageChatDeleteMember" then   
bot_data:incr(black..'MARTEN:ExitNumber'..msg.chat_id_..':'..os.date('%d'))  
end
--     Source -black-     --
if text ==('تفعيل') and not SudoBot(msg) and ChCheck(msg) then
if not bot_data:get(black..'MARTEN:Lock:FreeBot'..black) then
if ChatType == 'pv' then
...
bot_data:sadd(black..'MARTEN:Admins:'..msg.chat_id_, admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
bot_data:srem(black..'MARTEN:Admins:'..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
bot_data:sadd(black..'MARTEN:Admins:'..msg.chat_id_, admins[i].user_id_)
...
bot_data:sadd(black.."MARTEN:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
bot_data:sadd(black.."MARTEN:Owner:"..msg.chat_id_,admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
bot_data:srem(black.."MARTEN:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
bot_data:srem(black.."MARTEN:Owner:"..msg.chat_id_,admins[i].user_id_)
end
end,nil)  
end 
end
end,nil)
if bot_data:sismember(black..'MARTEN:Groups',msg.chat_id_) then
send_X(msg.chat_id_, msg.id_, 1, '𐇮 المجموعه بالتاكيد مفعله', 1, 'md')
else
if tonumber(data.member_count_) < tonumber(bot_data:get(black..'MARTEN:Num:Add:Bot') or 0) and not SecondSudo(msg) then
send_X(msg.chat_id_, msg.id_, 1, '𐇮 عدد اعضاء المجموعه اقل من ↫ *'..(bot_data:get(black..'MARTEN:Num:Add:Bot') or 0)..'* عضو', 1, 'md')
return false
end
ReplyStatus(msg,result.id_,"ReplyBy","𐇮 تم تفعيل المجموعه "..dp.title_)  
bot_data:sadd(black.."MARTEN:Groups",msg.chat_id_)
bot_data:sadd(black..'MARTEN:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
local Name1 = Name1:gsub("`","") 
...
bot_data:set(black.."MARTEN:Groups:Links"..msg.chat_id_,LinkGroup) 
...
if not bot_data:sismember(black.."MARTEN:Groups",msg.chat_id_) and not ReFalse:match("^(%d+)") and not SudoBot(msg) then
...
if bot_data:get(black..'MARTEN:Lock:Robot'..msg.chat_id_) then
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,dp) 
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..dp.id_)
bot_data:sadd(black..'MARTEN:Tkeed:'..msg.chat_id_, dp.id_)
...
if bot_data:get(black.."MARTEN:Lock:Join"..msg.chat_id_) then
...
if not Manager(msg) then 
local filter = bot_data:smembers(black.."MARTEN:FilterPhoto"..msg.chat_id_)
...
if not Manager(msg) then 
local filter = bot_data:smembers(black.."MARTEN:FilterAnimation"..msg.chat_id_)
for k,v in pairs(filter) do
...
if not Manager(msg) then 
local filter = bot_data:smembers(black.."MARTEN:FilterSteckr"..msg.chat_id_)
for k,v in pairs(filter) do
...
local DelGpRedRedods = bot_data:get(black..'MARTEN:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
local GetGpTexts = bot_data:get(black..'MARTEN:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
if DelGpRedRedods == 'DelGpRedRedods' then
send_X(msg.chat_id_, msg.id_, 1,'𐇮 الرد ↫ '..msg.content_.text_..' للكلمه ↫ '..GetGpTexts..' تم حذفها',  1, "html")
bot_data:del(black..'MARTEN:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
bot_data:srem(black..'MARTEN:Text:GpTexts'..GetGpTexts..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = bot_data:get(black..'MARTEN:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRedod' then
send_X(msg.chat_id_, msg.id_, 1,'𐇮 الكلمه ↫ '..msg.content_.text_..' تم حذفها',  1, "html")
bot_data:del(black..'MARTEN:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
bot_data:del(black..'MARTEN:Text:GpTexts'..msg.content_.text_..msg.chat_id_)
bot_data:srem(black..'MARTEN:Manager:GpRedod'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = bot_data:get(black..'MARTEN:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRed' then
send_X(msg.chat_id_, msg.id_, 1,'𐇮 الكلمه ↫ '..msg.content_.text_..' تم حذفها',  1, "html")
bot_data:del(black..'MARTEN:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
bot_data:del(black..'MARTEN:Gif:GpRed'..msg.content_.text_..msg.chat_id_)
bot_data:del(black..'MARTEN:Voice:GpRed'..msg.content_.text_..msg.chat_id_)
bot_data:del(black..'MARTEN:Audio:GpRed'..msg.content_.text_..msg.chat_id_)
bot_data:del(black..'MARTEN:Photo:GpRed'..msg.content_.text_..msg.chat_id_)
bot_data:del(black..'MARTEN:Stecker:GpRed'..msg.content_.text_..msg.chat_id_)
bot_data:del(black..'MARTEN:Video:GpRed'..msg.content_.text_..msg.chat_id_)
bot_data:del(black..'MARTEN:File:GpRed'..msg.content_.text_..msg.chat_id_)
bot_data:del(black..'MARTEN:Text:GpRed'..msg.content_.text_..msg.chat_id_)
bot_data:srem(black..'MARTEN:Manager:GpRed'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelAllRed = bot_data:get(black.."MARTEN:Add:AllRed"..msg.sender_user_id_)
if DelAllRed == 'DelAllRed' then
send_X(msg.chat_id_, msg.id_, 1,'𐇮 الكلمه ↫ '..msg.content_.text_..' تم حذفها',  1, "html")
bot_data:del(black.."MARTEN:Add:AllRed"..msg.sender_user_id_)
bot_data:del(black.."MARTEN:Gif:AllRed"..msg.content_.text_)
bot_data:del(black.."MARTEN:Voice:AllRed"..msg.content_.text_)
bot_data:del(black.."MARTEN:Audio:AllRed"..msg.content_.text_)
bot_data:del(black.."MARTEN:Photo:AllRed"..msg.content_.text_)
bot_data:del(black.."MARTEN:Stecker:AllRed"..msg.content_.text_)
bot_data:del(black.."MARTEN:Video:AllRed"..msg.content_.text_)
bot_data:del(black.."MARTEN:File:AllRed"..msg.content_.text_)
bot_data:del(black.."MARTEN:Text:AllRed"..msg.content_.text_)
bot_data:del(black.."MARTEN:Sudo:AllRed",msg.content_.text_)
return false
end
end
--     Source -black-     --
if text and text:match("^(.*)$") then
local SaveGpRedod = bot_data:get(black..'MARTEN:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRedod == 'SaveGpRedod' then
local GetGpTexts = bot_data:get(black..'MARTEN:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
local List = bot_data:smembers(black..'MARTEN:Text:GpTexts'..GetGpTexts..msg.chat_id_)
if text == "الغاء" then 
send_X(msg.chat_id_, msg.id_, 1, "𐇮 𐇮 تم الغاء عملية حفظ الردود المتعدده للامر ↫ "..GetGpTexts ,  1, "md")
bot_data:del(black..'MARTEN:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
bot_data:del(black..'MARTEN:Text:GpTexts'..GetGpTexts..msg.chat_id_)
bot_data:del(black..'MARTEN:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
bot_data:srem(black..'MARTEN:Manager:GpRedod'..msg.chat_id_,GetGpTexts)
return false
end
Text = text:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","")
bot_data:sadd(black..'MARTEN:Text:GpTexts'..GetGpTexts..msg.chat_id_,Text)
if #List == 4 then 
...
if text and not bot_data:get(black..'MARTEN:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_) then
if bot_data:sismember(black..'MARTEN:Manager:GpRedod'..msg.chat_id_,text) then
local XboT =  bot_data:smembers(black..'MARTEN:Text:GpTexts'..text..msg.chat_id_)
send_X(msg.chat_id_, msg.id_, 1, '['..XboT[math.random(#XboT)]..']' , 1, 'md')  
end
end
--     Source -black-     --
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then 
local SaveGpRed = bot_data:get(black..'MARTEN:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRed == 'SaveGpRed' then 
if text == 'الغاء' then
local DelManagerRep = bot_data:get(black..'DelManagerRep'..msg.chat_id_)
bot_data:srem(black..'MARTEN:Manager:GpRed'..msg.chat_id_,DelManagerRep)
send_X(msg.chat_id_, msg.id_, 1, '𐇮 تم الغاء حفظ الرد', 1, 'md')
bot_data:del(black..'MARTEN:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
bot_data:del(black..'MARTEN:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
bot_data:del(black..'DelManagerRep'..msg.chat_id_)
return false
end
bot_data:del(black..'MARTEN:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
local SaveGpRed = bot_data:get(black..'MARTEN:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
if msg.content_.video_ then bot_data:set(black..'MARTEN:Video:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then bot_data:set(black..'MARTEN:File:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then bot_data:set(black..'MARTEN:Stecker:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_) 
end 
if msg.content_.voice_ then bot_data:set(black..'MARTEN:Voice:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_) 
end
if msg.content_.audio_ then bot_data:set(black..'MARTEN:Audio:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_) 
end
...
bot_data:set(black..'MARTEN:Photo:GpRed'..SaveGpRed..msg.chat_id_, photo_in_group) 
end
if msg.content_.animation_ then bot_data:set(black..'MARTEN:Gif:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_) 
end 
if msg.content_.text_ then
bot_data:set(black..'MARTEN:Text:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.text_)
end 
...
if msg.content_.text_ and not bot_data:get(black..'MARTEN:Lock:GpRed'..msg.chat_id_) then 
if bot_data:get(black..'MARTEN:Video:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, bot_data:get(black..'MARTEN:Video:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if bot_data:get(black..'MARTEN:File:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, bot_data:get(black..'MARTEN:File:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if bot_data:get(black..'MARTEN:Voice:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, bot_data:get(black..'MARTEN:Voice:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if bot_data:get(black..'MARTEN:Audio:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, bot_data:get(black..'MARTEN:Audio:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if bot_data:get(black..'MARTEN:Photo:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, bot_data:get(black..'MARTEN:Photo:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if bot_data:get(black..'MARTEN:Gif:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, bot_data:get(black..'MARTEN:Gif:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if bot_data:get(black..'MARTEN:Stecker:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, bot_data:get(black..'MARTEN:Stecker:GpRed'..msg.content_.text_..msg.chat_id_))
end
if bot_data:get(black..'MARTEN:Text:GpRed'..msg.content_.text_..msg.chat_id_) then
function XboT(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = bot_data:get(black..'MARTEN:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = bot_data:get(black..'MARTEN:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = bot_data:get(black..'MARTEN:Text:GpRed'..msg.content_.text_..msg.chat_id_)
...
text = msg.content_.text_
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then
local SaveAllRed = bot_data:get(black.."MARTEN:Add:AllRed"..msg.sender_user_id_)
if SaveAllRed == 'SaveAllRed' then
if text == 'الغاء' then
local DelSudoRep = bot_data:get(black..'DelSudoRep')
bot_data:del(black.."MARTEN:Sudo:AllRed",DelSudoRep)
send_X(msg.chat_id_, msg.id_, 1, '𐇮 تم الغاء حفظ الرد', 1, 'md')
bot_data:del(black.."MARTEN:Add:AllText"..msg.sender_user_id_)
bot_data:del(black.."MARTEN:Add:AllRed"..msg.sender_user_id_)
bot_data:del(black.."DelSudoRep")
return false
end
bot_data:del(black.."MARTEN:Add:AllRed"..msg.sender_user_id_)
local SaveAllRed = bot_data:get(black.."MARTEN:Add:AllText"..msg.sender_user_id_)
if msg.content_.video_ then
bot_data:set(black.."MARTEN:Video:AllRed"..SaveAllRed, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then
bot_data:set(black.."MARTEN:File:AllRed"..SaveAllRed, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then
bot_data:set(black.."MARTEN:Stecker:AllRed"..SaveAllRed, msg.content_.sticker_.sticker_.persistent_id_)
end
if msg.content_.voice_ then
bot_data:set(black.."MARTEN:Voice:AllRed"..SaveAllRed, msg.content_.voice_.voice_.persistent_id_)
end
if msg.content_.audio_ then
bot_data:set(black.."MARTEN:Audio:AllRed"..SaveAllRed, msg.content_.audio_.audio_.persistent_id_)
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
bot_data:set(black.."MARTEN:Photo:AllRed"..SaveAllRed, photo_in_all_groups)
end
if msg.content_.animation_ then
bot_data:set(black.."MARTEN:Gif:AllRed"..SaveAllRed, msg.content_.animation_.animation_.persistent_id_)
end
if msg.content_.text_ then
bot_data:set(black.."MARTEN:Text:AllRed"..SaveAllRed, msg.content_.text_)
end 
send_X(msg.chat_id_, msg.id_, 1, '𐇮 تم حفظ الرد الجديد', 1, 'md') 
bot_data:del(black.."MARTEN:Add:AllText"..msg.sender_user_id_)
bot_data:del(black..'DelSudoRep')
return false end end
if msg.content_.text_ and not bot_data:get(black..'MARTEN:Lock:AllRed'..msg.chat_id_) then
if bot_data:get(black.."MARTEN:Video:AllRed"..msg.content_.text_) then
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, bot_data:get(black.."MARTEN:Video:AllRed"..msg.content_.text_))
end
if bot_data:get(black.."MARTEN:File:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, bot_data:get(black.."MARTEN:File:AllRed"..msg.content_.text_))
end
if bot_data:get(black.."MARTEN:Voice:AllRed"..msg.content_.text_)  then
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, bot_data:get(black.."MARTEN:Voice:AllRed"..msg.content_.text_))
end
if bot_data:get(black.."MARTEN:Audio:AllRed"..msg.content_.text_)  then
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, bot_data:get(black.."MARTEN:Audio:AllRed"..msg.content_.text_))
end
if bot_data:get(black.."MARTEN:Photo:AllRed"..msg.content_.text_)  then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, bot_data:get(black.."MARTEN:Photo:AllRed"..msg.content_.text_))
end
if  bot_data:get(black.."MARTEN:Gif:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, bot_data:get(black.."MARTEN:Gif:AllRed"..msg.content_.text_))
end
if bot_data:get(black.."MARTEN:Stecker:AllRed"..msg.content_.text_) then
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, bot_data:get(black.."MARTEN:Stecker:AllRed"..msg.content_.text_))
end
if bot_data:get(black.."MARTEN:Text:AllRed"..msg.content_.text_) then
function XboT(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = bot_data:get(black..'MARTEN:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = bot_data:get(black..'MARTEN:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = bot_data:get(black.."MARTEN:Text:AllRed"..msg.content_.text_)
local Text = Text:gsub('#username',(username or 'لا يوجد')) 
local Text = Text:gsub('#name','['..result.first_name_..']')
local Text = Text:gsub('#id',msg.sender_user_id_)
local Text = Text:gsub('#edit',edit_msg)
...
if Type == "keed" and not bot_data:sismember(black..'MARTEN:Tkeed:'..msg.chat_id_, msg.sender_user_id_) then
...
if Type == "mute" and not bot_data:sismember(black..'MARTEN:Muted:'..msg.chat_id_, msg.sender_user_id_) then
bot_data:sadd(black..'MARTEN:Muted:'..msg.chat_id_,msg.sender_user_id_)
my_ide = msg.sender_user_id_
msgm = msg.id_
local num = 100
for i=1,tonumber(num) do
...
--     Source -black-     --
--       Spam Check       --
if not Admin(msg) and msg.content_.ID ~= "MessageChatAddMembers" and bot_data:hget(black.."MARTEN:Spam:Group:User"..msg.chat_id_,"Spam:User") then 
if msg.sender_user_id_ ~= black then
floods = bot_data:hget(black.."MARTEN:Spam:Group:User"..msg.chat_id_,"Spam:User") or "nil"
Num_Msg_Max = bot_data:hget(black.."MARTEN:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
Time_Spam = bot_data:hget(black.."MARTEN:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 5
local post_count = tonumber(bot_data:get(black.."MARTEN:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(bot_data:hget(black.."MARTEN:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5) then 
local ch = msg.chat_id_
local type = bot_data:hget(black.."MARTEN:Spam:Group:User"..msg.chat_id_,"Spam:User") 
NotSpam(msg,type)  
end
bot_data:setex(black.."MARTEN:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(bot_data:hget(black.."MARTEN:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if bot_data:hget(black.."MARTEN:Spam:Group:User"..msg.chat_id_,"Num:Spam") then
Num_Msg_Max = bot_data:hget(black.."MARTEN:Spam:Group:User"..msg.chat_id_,"Num:Spam") 
end
if bot_data:hget(black.."MARTEN:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") then
Time_Spam = bot_data:hget(black.."MARTEN:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") 
end 
end
end 
--     Source -black-     --
...
bot_data:set(black..'MARTEN:PinnedMsg'..msg.chat_id_,msg.content_.message_id_)
else
local pin_id = bot_data:get(black..'MARTEN:PinnedMsg'..msg.chat_id_)
if pin_id and bot_data:get(black..'MARTEN:Lock:Pin'..msg.chat_id_) then
pinmsg(msg.chat_id_,pin_id,0)
end
end
end
if bot_data:get(black..'MARTEN:viewget'..msg.sender_user_id_) then
if not msg.forward_info_ then
bot_data:del(black..'MARTEN:viewget'..msg.sender_user_id_)
else
...
if bot_data:get(black..'MARTEN:Lock:Forwards'..msg.chat_id_) then
if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
if bot_data:get(black..'MARTEN:Lock:Photo'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
if bot_data:get(black..'MARTEN:Lock:Links'..msg.chat_id_) then
if msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Dd][Oo][Gg]") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if bot_data:get(black..'MARTEN:Lock:Tags'..msg.chat_id_) then
if msg.content_.caption_:match("@") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("#") then
if bot_data:get(black..'MARTEN:Lock:Hashtak'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.content_.caption_:match("[Hh][Tt][Tt][Pp]://") or msg.content_.caption_:match(".[Ii][Rr]") or msg.content_.caption_:match(".[Cc][Oo][Mm]") or msg.content_.caption_:match(".[Oo][Rr][Gg]") or msg.content_.caption_:match(".[Ii][Nn][Ff][Oo]") or msg.content_.caption_:match("[Ww][Ww][Ww].") or msg.content_.caption_:match(".[Xx][Yy][Zz]") or msg.content_.caption_:match(".[Tt][Kk]") or msg.content_.ID == "MessageEntityTextUrl" or msg.content_.ID == "MessageEntityUrl" then
if bot_data:get(black..'MARTEN:Lock:WebLinks'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[\216-\219][\128-\191]") then
if bot_data:get(black..'MARTEN:Lock:Arabic'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[A-Z]") or msg.content_.caption_:match("[a-z]") then
if bot_data:get(black..'MARTEN:Lock:English'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
...
if bot_data:get(black..'MARTEN:Lock:Markdown'..msg.chat_id_) then
if not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if bot_data:get(black..'MARTEN:Lock:Document'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if not VipMem(msg) then
if bot_data:get(black..'MARTEN:Lock:Inline'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source -black-     --
...
elseif msg.content_.ID == "MessageSticker" then
if not VipMem(msg) then
if bot_data:get(black..'MARTEN:Lock:Stickers'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if bot_data:get(black..'MARTEN:Groups:Welcomes'..msg.chat_id_) then
Welcomes = bot_data:get(black..'MARTEN:Groups:Welcomes'..msg.chat_id_)
else
Welcomes = '• نورت حبي \n• firstname \n• username'
end
...
if bot_data:get(black.."MARTEN:Lock:Welcome"..msg.chat_id_) then
getUser(msg.sender_user_id_,get_welcome)
end
--     Source -black-     --
--      New User Add      --
elseif msg.content_.ID == "MessageChatAddMembers" then
if not bot_data:get(black..'MARTEN:Lock:BotWelcome') then 
...
if bot_data:sismember(black..'MARTEN:Groups',msg.chat_id_) then BotText = "مفعله في السابق\n𐇮 ارسل ↫ الاوامر واستمتع بالمميزيات" else BotText = "معطله يجب رفعي مشرف\n𐇮 بعد ذلك يرجى ارسال امر ↫ تفعيل\n𐇮 سيتم رفع الادمنيه والمنشئ تلقائيا" end 
if bot_data:get(black.."MARTEN:Text:BotWelcome") then MARTENText = bot_data:get(black.."MARTEN:Text:BotWelcome") else MARTENText = "𐇮 مرحبا انا بوت اسمي "..NameBot.."\n𐇮 حالة المجموعه ↫ "..BotText.."\n┋⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎┋" end 
if bot_data:get(black.."MARTEN:Photo:BotWelcome") then MARTENPhoto = bot_data:get(black.."MARTEN:Photo:BotWelcome") elseif MArRten.photos_[0] then MARTENPhoto = MArRten.photos_[0].sizes_[1].photo_.persistent_id_ else MARTENPhoto = nil end 
...
if bot_data:get(black..'MARTEN:Lock:Contact'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source -black-     --
...
if bot_data:get(black..'MARTEN:Lock:Music'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if bot_data:get(black..'MARTEN:Lock:Voice'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if bot_data:get(black..'MARTEN:Lock:Location'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
return
end
if msg.content_.caption_ then
...
if bot_data:get(black..'MARTEN:Lock:Videos'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if bot_data:get(black..'MARTEN:Lock:Gifs'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if bot_data:get(black..'MARTEN:Lock:Text'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
...
if not bot_data:get(black..'MARTEN:Spam:Text'..msg.chat_id_) then
sens = 400
else
sens = tonumber(bot_data:get(black..'MARTEN:Spam:Text'..msg.chat_id_))
end
if bot_data:get(black..'MARTEN:Lock:Spam'..msg.chat_id_) and string.len(msg.content_.text_) > (sens) or ctrl_chars > (sens) or real_digits > (sens) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
--     Source -black-     --
if (msg.content_.sticker_)  and msg.reply_to_message_id_ == 0 and bot_data:get(black.."MARTEN:MARTEN:Lock:Xn"..msg.chat_id_)=="del" then
sticker_id = msg.content_.sticker_.sticker_.persistent_id_
st = https.request('https://boyka-api.ml/ImageInfo.php?token='..TokenBot..'&url='..sticker_id.."&type=sticker")
eker = JSON.decode(st)
if eker.ok.Info == "Indecent" then
local list = bot_data:smembers(black.."MARTEN:BasicConstructor:"..msg.chat_id_)
...
if (msg.content_.photo_) and msg.reply_to_message_id_ == 0 and bot_data:get(black.."MARTEN:MARTEN:Lock:Xn"..msg.chat_id_)=="del" then
...
--     Source -black-     --
if bot_data:get(black.."MARTEN:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"𐇮 تم الغاء حفظ الرابط")       
bot_data:del(black.."MARTEN:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) 
return false
end
if msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)") then
local Link = msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)")
bot_data:set(black.."MARTEN:Groups:Links"..msg.chat_id_,Link)
...
if bot_data:get('XboT:'..black.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
bot_data:del('XboT:'..black..'id:user'..msg.chat_id_)  
send_X(msg.chat_id_, msg.id_, 1, '𐇮 تم الغاء الامر', 1, 'md')
bot_data:del('XboT:'..black.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
bot_data:del('XboT:'..black.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = bot_data:get('XboT:'..black..'id:user'..msg.chat_id_)  
bot_data:incrby(black..'MARTEN:UsersMsgs'..msg.chat_id_..':'..iduserr,numadded)
send_X(msg.chat_id_, msg.id_,  1, "𐇮 تم اضافة "..numadded..' رساله', 1, 'md')
bot_data:del('XboT:'..black..'id:user'..msg.chat_id_) 
end
end
if text and Constructor(msg) then 
if bot_data:get('XboT:'..black.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
bot_data:del('XboT:'..black..'ids:user'..msg.chat_id_)  
send_X(msg.chat_id_, msg.id_, 1, '𐇮 تم الغاء الامر', 1, 'md')
bot_data:del('XboT:'..black.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
bot_data:del('XboT:'..black.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = bot_data:get('XboT:'..black..'ids:user'..msg.chat_id_)  
bot_data:incrby(black..'MARTEN:GamesNumber'..msg.chat_id_..iduserr,numadded)  
...
if not bot_data:get(black.."MARTEN:Lock:Fshar"..msg.chat_id_) and not BasicConstructor(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if bot_data:get(black.."MARTEN:Lock:Farsi"..msg.chat_id_) and not Admin(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","𐇮 ممنوع التكلم بالغه الفارسيه هنا\n𐇮 لتصير ذيل\n✓")  
end end
if text and (text:match("ڬ") or text:match("ٺ") or text:match("چ") or text:match("ڇ") or text:match("ڿ") or text:match("ڀ") or text:match("ڎ") or text:match("ݫ") or text:match("ژ") or text:match("ڟ") or text:match("ݜ") or text:match("ڸ") or text:match("پ") or text:match("۴") or text:match("مک") or text:match("زدن") or text:match("دخترا") or text:match("دیوث") or text:match("کلیپشن") or text:match("خوششون") or text:match("میدا") or text:match("که") or text:match("بدانیم") or text:match("باید") or text:match("زناشویی") or text:match("آموزش") or text:match("راحتی") or text:match("خسته") or text:match("بیام") or text:match("بپوشم") or text:match("كرمه")) then
if bot_data:get(black.."MARTEN:Lock:FarsiBan"..msg.chat_id_) and not Admin(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ChatKick(msg.chat_id_, msg.sender_user_id_)
end end 
if text and (text:match("خره بالله") or text:match("خبربك") or text:match("كسدينربك") or text:match("خرب بالله") or text:match("خرب الله") or text:match("خره بربك") or text:match("الله الكواد") or text:match("خره بمحمد") or text:match("كسم الله") or text:match("كسم ربك") or text:match("كسربك") or text:match("كسختالله") or text:match("كسخت الله") or text:match("خره بدينك") or text:match("خرهبدينك") or text:match("كسالله") or text:match("خربالله")) then
if not bot_data:get(black.."MARTEN:Lock:Kfr"..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if not bot_data:get(black.."MARTEN:Lock:Taf"..msg.chat_id_) and not BasicConstructor(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
local List = bot_data:smembers(black..'MARTEN:Groups') 
local Members = bot_data:smembers(black..'MARTEN:Users') 
local BotName = (bot_data:get(black.."MARTEN:NameBot") or 'بلاك')
local GetJson = '{"BotId": '..black..',"BotName": "'..BotName..'","GroupsList":{'  
for k,v in pairs(List) do 
LinkGroups = bot_data:get(black.."MARTEN:Groups:Links"..v)
Welcomes = bot_data:get(black..'MARTEN:Groups:Welcomes'..v) or ''
Welcomes = Welcomes:gsub('"',"") Welcomes = Welcomes:gsub("'","") Welcomes = Welcomes:gsub(",","") Welcomes = Welcomes:gsub("*","") Welcomes = Welcomes:gsub(";","") Welcomes = Welcomes:gsub("`","") Welcomes = Welcomes:gsub("{","") Welcomes = Welcomes:gsub("}","") 
Owners = bot_data:smembers(black..'MARTEN:Owner:'..v)
Constructors = bot_data:smembers(black..'MARTEN:BasicConstructor:'..v)
BasicConstructors = bot_data:smembers(black..'MARTEN:Constructor:'..v)
Managers = bot_data:smembers(black..'MARTEN:Managers:'..v)
Admis = bot_data:smembers(black..'MARTEN:Admins:'..v)
Vips = bot_data:smembers(black..'MARTEN:VipMem:'..v)
if k == 1 then
GetJson = GetJson..'"'..v..'":{'
else
GetJson = GetJson..',"'..v..'":{'
...
bot_data:incrby(black..'MARTEN:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
...
bot_data:set(black..'MARTEN:ChId',data.id_)
else
...
--     Source -black-     --
if bot_data:get(black.."MARTEN:DevText"..msg.chat_id_..":" .. msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
bot_data:del(black.."MARTEN:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
send_X(msg.chat_id_, msg.id_, 1, '𐇮 تم الغاء الامر', 1, 'md')
return false 
end 
bot_data:del(black.."MARTEN:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
...
if bot_data:get(black..'MARTEN:NameBot'..msg.sender_user_id_) == 'msg' then
if text and text:match("^الغاء$") then 
bot_data:del(black..'MARTEN:NameBot'..msg.sender_user_id_)
send_X(msg.chat_id_, msg.id_, 1, '𐇮 تم الغاء الامر', 1, 'md')
return false 
end 
send_X(msg.chat_id_, msg.id_, 1, '𐇮 تم حفظ اسم البوت ', 1, 'html')
bot_data:del(black..'MARTEN:NameBot'..msg.sender_user_id_)
bot_data:set(black..'MARTEN:NameBot', text)
return false 
end
--     Source -black-     --
if text == "الرابط" then 
if not bot_data:get(black.."MARTEN:Lock:GpLinks"..msg.chat_id_) then
send_X(msg.chat_id_, msg.id_, 1, '𐇮 جلب رابط المجموعه معطل', 1, 'md') 
return false  
end
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
local link = bot_data:get(black.."MARTEN:Groups:Links"..msg.chat_id_)            
if link then  
...
if text and text == (bot_data:get(black..'MARTEN:NameBot') or 'بلاك') then 
local DRagon = {"❤️‍🔥","🏌🏼","🦋","🍧","🥲","🍇","🥲♥️","♥️","🍧🍇",""} 
local xBoT = DRagon[math.random(#DRagon)]
NameBot = (bot_data:get(black..'MARTEN:NameBot') or 'بلاك')
local namebot = {
...
if tonumber((bot_data:get(black..'MARTEN:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
send_X(msg.chat_id_, msg.id_, 1,'𐇮 لم تربح اي نقطه\n𐇮 ارسل ↫ الالعاب للعب', 1, 'md')
else 
send_X(msg.chat_id_, msg.id_, 1,'𐇮 عدد النقاط التي ربحتها ↫ '..(bot_data:get(black..'MARTEN:GamesNumber'..msg.chat_id_..msg.sender_user_id_)), 1, 'md')
end
end
if text ==  'حذف رسائلي' and ChCheck(msg) or text ==  'مسح رسائلي' and ChCheck(msg) then bot_data:del(black..'MARTEN:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_) send_X(msg.chat_id_, msg.id_, 1, '𐇮 تم حذف جميع رسائلك', 1, 'md') end
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then bot_data:del(black..'MARTEN:GamesNumber'..msg.chat_id_..msg.sender_user_id_) send_X(msg.chat_id_, msg.id_, 1, '𐇮 تم حذف جميع نقاطك', 1, 'md') end
--     Source -black-     --
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local Add_Mem = bot_data:get(black.."MARTEN:ContactNumber"..msg.chat_id_..":"..data.id_) or 0
if Add_Mem == 0 then 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local NumMsg = bot_data:get(black..'MARTEN:UsersMsgs'..msg.chat_id_..':'..data.id_) or 0
if NumMsg == 0 then 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local EditMsg = bot_data:get(black..'MARTEN:EditMsg'..msg.chat_id_..data.id_) or 0
if EditMsg == 0 then 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local Num = tonumber(bot_data:get(black..'MARTEN:GamesNumber'..msg.chat_id_..data.id_) or 0)
if Num == 0 then 
...
if not bot_data:get(black..'MARTEN:Lock:Games'..msg.chat_id_) then
bot_data2 = {'🍏','🍎','🍐','🍊','🍋','🍌','🍉','🍇','🍓','🍈','🍒','🍑','🍍','🥥','🥝','🍅','🍆','🥑','🥦','🥒','🌶','🌽','🥕','🥔','🍠','🥐','🍞','🥖','🥨','🧀','🥚','🍳','🥞','🥓','🥩','🍗','🍖','🌭','🍔','🍟','🍕','🥪','🥙','🍼','☕️','🍵','🥤','🍶','🍺','🍻','🏀','⚽️','🏈','⚾️','🎾','🏐','🏉','🎱','🏓','🏸','🥅','🎰','🎮','🎳','🎯','🏆','🎻','🎸','🎺','🥁','🎹','🎼','🎧','🎤','🎬','🎨','🎭','🎪','🛎','📤','🎗','🏵','🎖','🏆','🥌','🛷','🚕','🚗','🚙','🚌','🚎','🏎','🚓','🚑','🚚','🚛','🚜','🇮🇶','⚔️','🛡','🔮','🌡','💣','⏱','🛢','📓','📗','📂','📅','📪','📫','📬','📭','⏰','📺','🎚','☎️','📡'}
name = bot_data2[math.random(#bot_data2)]
bot_data:set(black..'MARTEN:GameNum'..msg.chat_id_,name)
bot_data:del(black..'MARTEN:Games:Ids'..msg.chat_id_)
...
if text == bot_data:get(black..'MARTEN:GameNum'..msg.chat_id_) and not bot_data:get(black..'MARTEN:Games:Ids'..msg.chat_id_) then
if not bot_data:get(black..'MARTEN:Games:Ids'..msg.chat_id_) then 
XboT = '𐇮 مبروك لقد ربحت في اللعبه \n𐇮 ارسل ↫ سمايلات للعب مره اخرى'
send_X(msg.chat_id_, msg.id_, 1,XboT, 1, 'md')
bot_data:incrby(black..'MARTEN:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
end
bot_data:set(black..'MARTEN:Games:Ids'..msg.chat_id_,true)
end
...
name = bot_data2[math.random(#bot_data2)]
bot_data:set(black..'MARTEN:GameNum2'..msg.chat_id_,name)
bot_data:del(black..'MARTEN:Games:Ids'..msg.chat_id_)
...
if text == bot_data:get(black..'MARTEN:GameNum2'..msg.chat_id_) and not bot_data:get(black..'MARTEN:Games:Ids'..msg.chat_id_) then
if not bot_data:get(black..'MARTEN:Games:Ids'..msg.chat_id_) then 
...
name = bot_data2[math.random(#bot_data2)]
bot_data:set(black..'MARTEN:GameNum3'..msg.chat_id_,name)
bot_data:del(black..'MARTEN:Games:Ids'..msg.chat_id_)
...
if text == bot_data:get(black..'MARTEN:GameNum3'..msg.chat_id_) and not bot_data:get(black..'MARTEN:Games:Ids'..msg.chat_id_) then
if not bot_data:get(black..'MARTEN:Games:Ids'..msg.chat_id_) then 
...
bot_data2 = {'😸','☠','🐼','🐇','🌑','🌚','⭐️','📥','⛈','🌥','⛄️','👨‍🔬','👨‍💻','👨‍🔧','👩‍🍳','🧚‍♀','🧚‍♂️','🧝‍♂','🙍‍♂','🧖‍♂','👬','👨‍👨‍👧','🕓','🕤','⌛️','📅','👩‍⚖️','👨‍🎨'};
name = bot_data2[math.random(#bot_data2)]
bot_data:set(black..'MARTEN:GameNum4'..msg.chat_id_,name)
bot_data:del(black..'MARTEN:Games:Ids'..msg.chat_id_)
name = string.gsub(name,'😸','😹😹😹😸😹😹😹😹')
name = string.gsub(name,'☠️','💀💀💀☠️💀💀💀💀')
name = string.gsub(name,'🐼','👻👻👻👻👻👻👻🐼')
...
if text == bot_data:get(black..'MARTEN:GameNum4'..msg.chat_id_) and not bot_data:get(black..'MARTEN:Games:Ids'..msg.chat_id_) then
if not bot_data:get(black..'MARTEN:Games:Ids'..msg.chat_id_) then 
...
name = bot_data2[math.random(#bot_data2)]
bot_data:set(black..'MARTEN:GameNum5'..msg.chat_id_,name)
bot_data:del(black..'MARTEN:Games:Ids'..msg.chat_id_)
...
if text == bot_data:get(black..'MARTEN:GameNum5'..msg.chat_id_) then
if not bot_data:get(black..'MARTEN:Games:Ids'..msg.chat_id_) then 
bot_data:incrby(black..'MARTEN:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
bot_data:del(black..'MARTEN:GameNum5'..msg.chat_id_)
...
name = bot_data2[math.random(#bot_data2)]
bot_data:set(black..'MARTEN:GameNum6'..msg.chat_id_,name)
bot_data:del(black..'MARTEN:Games:Ids'..msg.chat_id_)
...
if text == bot_data:get(black..'MARTEN:GameNum6'..msg.chat_id_) then
if not bot_data:get(black..'MARTEN:Games:Ids'..msg.chat_id_) then 
bot_data:incrby(black..'MARTEN:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
bot_data:del(black..'MARTEN:GameNum6'..msg.chat_id_)
...
name = bot_data2[math.random(#bot_data2)]
bot_data:set(black..'MARTEN:GameNum7'..msg.chat_id_,name)
bot_data:del(black..'MARTEN:Games:Ids'..msg.chat_id_)
...
if text == bot_data:get(black..'MARTEN:GameNum7'..msg.chat_id_) then
if not bot_data:get(black..'MARTEN:Games:Ids'..msg.chat_id_) then 
bot_data:incrby(black..'MARTEN:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
bot_data:del(black..'MARTEN:GameNum7'..msg.chat_id_)
...
name = bot_data2[math.random(#bot_data2)]
bot_data:set(black..'MARTEN:GameNum8'..msg.chat_id_,name)
bot_data:del(black..'MARTEN:Games:Ids'..msg.chat_id_)
...
if text == bot_data:get(black..'MARTEN:GameNum8'..msg.chat_id_) then
if not bot_data:get(black..'MARTEN:Games:Ids'..msg.chat_id_) then 
bot_data:incrby(black..'MARTEN:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
bot_data:del(black..'MARTEN:GameNum8'..msg.chat_id_)
...
if text == 'روليت' then
if not bot_data:get(black..'MARTEN:Lock:Games'..msg.chat_id_) then
bot_data:del(black.."MARTEN:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
bot_data:del(black..'MARTEN:ListRolet'..msg.chat_id_)  
bot_data:setex(black.."MARTEN:StartRolet"..msg.chat_id_..msg.sender_user_id_,3600,true)  
send_X(msg.chat_id_, msg.id_, 1, '𐇮 حسنا لنلعب , ارسل عدد اللاعبين للروليت .', 1, 'md')
return false  
end
end
if text and text:match("^(%d+)$") and bot_data:get(black.."MARTEN:StartRolet"..msg.chat_id_..msg.sender_user_id_) then
if text == "1" then
Text = "𐇮 لا استطيع بدء اللعبه بلاعب واحد فقط"
else
bot_data:set(black.."MARTEN:NumRolet"..msg.chat_id_..msg.sender_user_id_,text)  
Text = '𐇮 تم بدء تسجيل اللسته يرجى ارسال المعرفات \n𐇮 الفائز يحصل على 5 نقاط عدد المطلوبين ↫ '..text..' لاعب'
end
bot_data:del(black.."MARTEN:StartRolet"..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,Text)
return false
end
if text and text:match('^(@[%a%d_]+)$') and bot_data:get(black.."MARTEN:NumRolet"..msg.chat_id_..msg.sender_user_id_) then 
if bot_data:sismember(black..'MARTEN:ListRolet'..msg.chat_id_,text) then
...
bot_data:sadd(black..'MARTEN:ListRolet'..msg.chat_id_,text)
local CountAdd = bot_data:get(black.."MARTEN:NumRolet"..msg.chat_id_..msg.sender_user_id_)
local CountAll = bot_data:scard(black..'MARTEN:ListRolet'..msg.chat_id_)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
bot_data:del(black.."MARTEN:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
bot_data:setex(black.."MARTEN:WittingStartRolet"..msg.chat_id_..msg.sender_user_id_,1400,true) 
...
if not bot_data:get(black..'MARTEN:Lock:Gamesinline'..msg.chat_id_) then
Text =[[
...
bot_data0 = (bot_data:get(black..'MARTEN:GamesNumber'..msg.chat_id_..msg.sender_user_id_) * 50)
bot_data:incrby(black..'MARTEN:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_,bot_data0)
send_X(msg.chat_id_, msg.id_, 1,'𐇮 تم بيع '..(bot_data:get(black..'MARTEN:GamesNumber'..msg.chat_id_..msg.sender_user_id_))..' من نقاطك\n𐇮 كل نقطه تساوي 50 رساله', 'md')
bot_data:del(black..'MARTEN:GamesNumber'..msg.chat_id_..msg.sender_user_id_)
end
end
--     Source -black-     --
...
if MaRTeN.members_[i].status_.ID == "ChatMemberStatusCreator" then  
Manager_id = admins[i].user_id_  
bot_data:sadd(black..'MARTEN:BasicConstructor:'..msg.chat_id_,Manager_id)  
bot_data:sadd(black..'MARTEN:Owner:'..msg.chat_id_,Manager_id)   
end  
end  
if num == 0 then
...
if bot_data:get(black.."MARTEN:Left:Bot"..black) and not SecondSudo(msg) then
...
local msguser = tonumber(bot_data:get(black..'MARTEN:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_))
local user_msgs = bot_data:get(black..'MARTEN:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local cont = (tonumber(bot_data:get(black..'MARTEN:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
local user_nkt = tonumber(bot_data:get(black..'MARTEN:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
if result.username_ then username = '@'..result.username_ else username = 'لا يوجد' end
...
bot_data:del(black..'MARTEN:ChId')
...
function XboT(extra,result,success)
if bot_data:get(black.."MARTEN:Send:Bot"..black) and not SecondSudo(msg) then 
send(msg.chat_id_, msg.id_,"𐇮 الاذاعه معطله من قبل المطور الاساسي")
return false
end
local GpList = bot_data:smembers(black.."MARTEN:Groups")
for k,v in pairs(GpList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
local PvList = bot_data:smembers(black.."MARTEN:Users")
...
bot_data:set(black..'MARTEN:viewget'..msg.sender_user_id_,true)
...
if bot_data:get(black.."MARTEN:Kick:Me"..msg.chat_id_) then
send_X(msg.chat_id_, msg.id_, 1, '𐇮 عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
bot_data:set(black..'yes'..msg.sender_user_id_..'', 'delyes')
bot_data:set(black..'no'..msg.sender_user_id_..'', 'delno')
local black = {"𐇮︰هل انت متأكد من المغادره"} 
local Text = black[math.random(#black)]
local DrAgoN = {"نعم"}
...
bot_data:set(black.."MARTEN:Kick:Me"..msg.chat_id_, true)
ReplyStatus(msg,msg.sender_user_id_,"EbDsDrg","𐇮 تم تعطيل امر اطردني\n✓")
end
if text == 'تفعيل اطردني' and Manager(msg) and ChCheck(msg) then
bot_data:del(black.."MARTEN:Kick:Me"..msg.chat_id_)
ReplyStatus(msg,msg.sender_user_id_,"EbDsDrg","𐇮 تم تفعيل امر اطردني\n✓")
end
--     Source -black-     --
if text == "نزلني" and ChCheck(msg) then
if bot_data:get(black.."MARTEN:Del:Me"..msg.chat_id_) then
send_X(msg.chat_id_, msg.id_, 1, '𐇮 عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
bot_data:set(black..'yesdel'..msg.sender_user_id_..'', 'delyes')
bot_data:set(black..'nodel'..msg.sender_user_id_..'', 'delno')
local black = {"𐇮︰هل انت متأكد"}
local Text = black[math.random(#black)]
local DrAgoN = {"نعم"}
local DragoN = DrAgoN[math.random(#DrAgoN)]
local DrAgON = {"لا"}
...
bot_data:set(black.."MARTEN:Del:Me"..msg.chat_id_, true)
ReplyStatus(msg,msg.sender_user_id_,"EbDsDrg","𐇮 تم تعطيل امر نزلني\n✓")
end
if text == 'تفعيل نزلني' and BasicConstructor(msg) and ChCheck(msg) then
bot_data:del(black.."MARTEN:Del:Me"..msg.chat_id_)
...
bot_data:del(black..'MARTEN:Lock:TagAll'..msg.chat_id_)
end
...
bot_data:set(black..'MARTEN:Lock:TagAll'..msg.chat_id_,true)
end
--     source -black-     --
if text == "كشف الرتب" or text == "الرتب" then
local Text = '*𐇮 اليك الرتب الاتيـة وعددها ⤈*'
local ListSudo = bot_data:scard(black.."MARTEN:MARTENSudo:")
local ListSecondSudo = bot_data:scard(black.."MARTEN:SecondSudo:")
local ListSudoBot = bot_data:scard(black.."MARTEN:SudoBot:")
local ListOwner = bot_data:scard(black.."MARTEN:Owner:"..msg.chat_id_)
local ListBasicConstructor = bot_data:scard(black.."MARTEN:BasicConstructor:"..msg.chat_id_)
local ListConstructor = bot_data:scard(black.."MARTEN:Constructor:"..msg.chat_id_)
local ListManagers = bot_data:scard(black.."MARTEN:Managers:"..msg.chat_id_)
local ListAdmins = bot_data:scard(black.."MARTEN:Admins:"..msg.chat_id_)
local ListVipMem = bot_data:scard(black.."MARTEN:VipMem:"..msg.chat_id_)
local ListCleaner = bot_data:scard(black.."MARTEN:Cleaner:"..msg.chat_id_)
local inline = {
...
if not bot_data:get(black..'MARTEN:Lock:TagAll'..msg.chat_id_) then
function TagAll(dp1,dp2)
local text = "𐇮 وينكم \n┋⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎┋\n"
i = 0
for k, v in pairs(dp2.members_) do
...
local EntryNumber = (bot_data:get(black..'MARTEN:EntryNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local ExitNumber = (bot_data:get(black..'MARTEN:ExitNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local MsgNumberDay = (bot_data:get(black..'MARTEN:MsgNumberDay'..msg.chat_id_..':'..os.date('%d')) or 0)
...
local inline = {{{text="• Telegram •",url="https://my.telegram.org/auth?to=delete"}},{{text="• instagram •",url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"}},{{text="• Facebook •",url="https://www.facebook.com/help/deleteaccount"}},{{text="• Snspchat •",url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount"}},{{text="┋⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎┋ ",url="https://t.me/BLACK_TEAM_4"}}} SendInline(msg.chat_id_,'𐇮 رابط الحذف في جميع مواقع التواصل \nفكر قبل لا تتسرع وتروح',nil,inline) return false end
...
if text == "جهاتي" and ChCheck(msg) or text == "اضافاتي" and ChCheck(msg) then add = (tonumber(bot_data:get(black..'MARTEN:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0) send_X(msg.chat_id_, msg.id_, 1, "𐇮 عدد جهاتك المضافه ↫ *❨ "..add.." ❩* ", 1, 'md') end
if text == "تعديلاتي" or text == "سحكاتي" and ChCheck(msg) then local edit_msg = bot_data:get(black..'MARTEN:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0  send_X(msg.chat_id_, msg.id_, 1, "𐇮 عدد تعديلاتك ↫ *❨ "..edit_msg.." ❩* ", 1, 'md') end
...
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' or text == 'حذف سحكاتي' or text == 'حذف تعديلاتي' then bot_data:del(black..'MARTEN:EditMsg'..msg.chat_id_..msg.sender_user_id_) send_X(msg.chat_id_, msg.id_, 1, '𐇮 تم حذف جميع تعديلاتك بنجاح' , 1, 'md') end
if text == 'مسح جهاتي' or text == 'مسح اضافاتي' or text == 'حذف جهاتي' or text == 'حذف اضافاتي' then bot_data:del(black..'MARTEN:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_) send_X(msg.chat_id_, msg.id_, 1, '𐇮 تم حذف جميع جهاتك المضافه' , 1, 'md') end
--     Source -black-     --
if text == "المطور" then 
local DevText = bot_data:get(black.."DevText")
if bot_data:get(black.."MARTEN:ChId") then local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChat?chat_id='..bot_data:get(black.."MARTEN:ChId")) local GetInfo = JSON.decode(Check) 
...
Text = "• *The developer and programmer of this source is* : [‹ ᴊᴏᴋᴇʀ ،|](https://t.me/UUOUOU_7)."
keyboard = {} 
keyboard.inline_keyboard = {{{text='• ‹ ᴊᴏᴋᴇʀ ،| •',url="t.me/UUOUOU_7"}}}
local msg_id = msg.id_/2097152/0.5
...
if not bot_data:get(black..'MARTEN:Lock:Stupid'..msg.chat_id_) then
...
if bot_data:sismember(black.."MARTEN:Owner:"..msg.chat_id_,result.id_) then
send_X(msg.chat_id_, msg.id_, 1, 'دي لڪك تريد اهينن تاج راسڪك؟😏🖕🏿', 1, 'md')
return false
end 
...
if bot_data:sismember(black.."MARTEN:Owner:"..msg.chat_id_,result.sender_user_id_) then
send_X(msg.chat_id_, msg.id_, 1, 'دي لڪك تريد اهينن تاج راسڪك؟😏🖕🏿', 1, 'md')
return false
end 
local XboT = {"صاࢪࢪ ستاذيي 🏃🏻‍♂️♥️","تأمࢪ آمࢪ","دقـيقهۂَ","لـححضهۂ","هسههہ","هَـسۿ ، ثوانيي"} 
...
if bot_data:sismember(black..'MARTEN:SecondSudo:',result.sender_user_id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if bot_data:sismember(black..'MARTEN:SudoBot:',result.sender_user_id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if bot_data:sismember(black..'MARTEN:ManagerAll:',result.sender_user_id_) then
managerall = 'المدراء العامين • ' else managerall = '' end
if bot_data:sismember(black..'MARTEN:AdminAll:',result.sender_user_id_) then
adminall = 'الادمنيه العامين • ' else adminall = '' end
if bot_data:sismember(black..'MARTEN:VipAll:',result.sender_user_id_) then
vpall = 'المميزين العامين • ' else vpall = '' end
if bot_data:sismember(black..'MARTEN:Owner:'..msg.chat_id_, result.sender_user_id_) then
lordConstructor = 'المالكين • ' else lordConstructor = '' end
if bot_data:sismember(black..'MARTEN:BasicConstructor:'..msg.chat_id_, result.sender_user_id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if bot_data:sismember(black..'MARTEN:Constructor:'..msg.chat_id_, result.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if bot_data:sismember(black..'MARTEN:Managers:'..msg.chat_id_, result.sender_user_id_) then
manager = 'المدراء • ' else manager = '' end
if bot_data:sismember(black..'MARTEN:Admins:'..msg.chat_id_, result.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if bot_data:sismember(black..'MARTEN:VipMem:'..msg.chat_id_, result.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if bot_data:sismember(black..'MARTEN:Cleaner:'..msg.chat_id_, result.sender_user_id_) then
...
bot_data:srem(black..'MARTEN:SecondSudo:', result.sender_user_id_)
bot_data:srem(black..'MARTEN:SudoBot:', result.sender_user_id_)
bot_data:srem(black..'MARTEN:ManagerAll:', result.sender_user_id_)
bot_data:srem(black..'MARTEN:AdminAll:', result.sender_user_id_)
bot_data:srem(black..'MARTEN:VipAll:', result.sender_user_id_)
bot_data:srem(black..'MARTEN:Owner:'..msg.chat_id_,result.sender_user_id_)
bot_data:srem(black..'MARTEN:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
bot_data:srem(black..'MARTEN:Constructor:'..msg.chat_id_,result.sender_user_id_)
bot_data:srem(black..'MARTEN:Managers:'..msg.chat_id_, result.sender_user_id_)
bot_data:srem(black..'MARTEN:Admins:'..msg.chat_id_, result.sender_user_id_)
bot_data:srem(black..'MARTEN:VipMem:'..msg.chat_id_, result.sender_user_id_)
bot_data:srem(black..'MARTEN:Cleaner:'..msg.chat_id_, result.sender_user_id_)
...
if bot_data:sismember(black..'MARTEN:SecondSudo:',result.id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if bot_data:sismember(black..'MARTEN:SudoBot:',result.id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if bot_data:sismember(black..'MARTEN:ManagerAll:',result.id_) then
managerall = 'المدراء العامين • ' else managerall = '' end
if bot_data:sismember(black..'MARTEN:AdminAll:',result.id_) then
adminall = 'الادمنيه العامين • ' else adminall = '' end
if bot_data:sismember(black..'MARTEN:VipAll:',result.id_) then
vpall = 'المميزين العامين • ' else vpall = '' end
if bot_data:sismember(black..'MARTEN:Owner:'..msg.chat_id_, result.id_) then
lordConstructor = 'المالكين • ' else lordConstructor = '' end
if bot_data:sismember(black..'MARTEN:BasicConstructor:'..msg.chat_id_, result.id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if bot_data:sismember(black..'MARTEN:Constructor:'..msg.chat_id_, result.id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if bot_data:sismember(black..'MARTEN:Managers:'..msg.chat_id_, result.id_) then
manager = 'المدراء • ' else manager = '' end
if bot_data:sismember(black..'MARTEN:Admins:'..msg.chat_id_, result.id_) then
admins = 'الادمنيه • ' else admins = '' end
if bot_data:sismember(black..'MARTEN:VipMem:'..msg.chat_id_, result.id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if bot_data:sismember(black..'MARTEN:Cleaner:'..msg.chat_id_, result.id_) then
cleaner = 'المنظفين • ' else cleaner = ''
end
...
if MARTENDelAll(msg.sender_user_id_,msg.chat_id_) == 'sudoid' then
bot_data:srem(black..'MARTEN:SecondSudo:', result.id_)
bot_data:srem(black..'MARTEN:SudoBot:', result.id_)
bot_data:srem(black..'MARTEN:ManagerAll:', result.id_)
bot_data:srem(black..'MARTEN:AdminAll:', result.id_)
bot_data:srem(black..'MARTEN:VipAll:', result.id_)
bot_data:srem(black..'MARTEN:Owner:'..msg.chat_id_,result.id_)
bot_data:srem(black..'MARTEN:BasicConstructor:'..msg.chat_id_,result.id_)
bot_data:srem(black..'MARTEN:Constructor:'..msg.chat_id_,result.id_)
bot_data:srem(black..'MARTEN:Managers:'..msg.chat_id_, result.id_)
bot_data:srem(black..'MARTEN:Admins:'..msg.chat_id_, result.id_)
bot_data:srem(black..'MARTEN:VipMem:'..msg.chat_id_, result.id_)
bot_data:srem(black..'MARTEN:Cleaner:'..msg.chat_id_, result.id_)
elseif MARTENDelAll(msg.sender_user_id_,msg.chat_id_) == 'secondsudo' then
bot_data:srem(black..'MARTEN:SudoBot:', result.id_)
bot_data:srem(black..'MARTEN:ManagerAll:', result.id_)
bot_data:srem(black..'MARTEN:AdminAll:', result.id_)
...
bot_data:sadd(black..'MARTEN:SecondSudo:',result.sender_user_id_)
...
if result.id_ then
bot_data:sadd(black..'MARTEN:SecondSudo:',result.id_)
...
bot_data:sadd(black..'MARTEN:SecondSudo:',user)
...
bot_data:srem(black..'MARTEN:SecondSudo:',user)
...
function sudo_reply(extra, result, success)
bot_data:sadd(black..'MARTEN:SudoBot:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
bot_data:sadd(black..'MARTEN:SudoBot:',result.id_)
...
bot_data:sadd(black..'MARTEN:SudoBot:',user)
...
bot_data:srem(black..'MARTEN:SudoBot:',user)
...
bot_data:sadd(black..'MARTEN:ManagerAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
bot_data:sadd(black..'MARTEN:ManagerAll:',result.id_)
...
bot_data:sadd(black..'MARTEN:ManagerAll:',user)
...
bot_data:srem(black..'MARTEN:ManagerAll:',user)
...
function raf_reply(extra, result, success)
bot_data:sadd(black..'MARTEN:AdminAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
bot_data:sadd(black..'MARTEN:AdminAll:',result.id_)
...
bot_data:sadd(black..'MARTEN:AdminAll:',user)
...
bot_data:srem(black..'MARTEN:AdminAll:',user)
...
function raf_reply(extra, result, success)
bot_data:sadd(black..'MARTEN:VipAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
bot_data:sadd(black..'MARTEN:VipAll:',result.id_)
...
bot_data:sadd(black..'MARTEN:VipAll:',user)
...
bot_data:srem(black..'MARTEN:VipAll:',user)
...
function raf_reply(extra, result, success)
bot_data:sadd(black..'MARTEN:Owner:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
bot_data:sadd(black..'MARTEN:Owner:'..msg.chat_id_,result.id_)
...
bot_data:sadd(black..'MARTEN:Owner:'..msg.chat_id_,user)
...
bot_data:srem(black..'MARTEN:Owner:'..msg.chat_id_,user)
...
function raf_reply(extra, result, success)
bot_data:sadd(black..'MARTEN:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
bot_data:sadd(black..'MARTEN:BasicConstructor:'..msg.chat_id_,result.id_)
...
bot_data:sadd(black..'MARTEN:BasicConstructor:'..msg.chat_id_,user)
...
bot_data:srem(black..'MARTEN:BasicConstructor:'..msg.chat_id_,user)
...
function raf_reply(extra, result, success)
bot_data:sadd(black..'MARTEN:Constructor:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
bot_data:sadd(black..'MARTEN:Constructor:'..msg.chat_id_,result.id_)
...
bot_data:sadd(black..'MARTEN:Constructor:'..msg.chat_id_,user)
...
bot_data:srem(black..'MARTEN:Constructor:'..msg.chat_id_,user)
...
bot_data:sadd(black..'MARTEN:Managers:'..msg.chat_id_,user)
...
bot_data:srem(black..'MARTEN:Managers:'..msg.chat_id_,user)
...
function prom_reply(extra, result, success)
bot_data:sadd(black..'MARTEN:Cleaner:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
bot_data:sadd(black..'MARTEN:Cleaner:'..msg.chat_id_,result.id_)
...
bot_data:sadd(black..'MARTEN:Cleaner:'..msg.chat_id_,user)
...
bot_data:srem(black..'MARTEN:Cleaner:'..msg.chat_id_,user)
...
function prom_reply(extra, result, success)
if not BasicConstructor(msg) and bot_data:get(black.."MARTEN:Lock:ProSet"..msg.chat_id_) then 
...
bot_data:sadd(black..'MARTEN:Admins:'..msg.chat_id_,user)
...
bot_data:srem(black..'MARTEN:Admins:'..msg.chat_id_,user)
...
bot_data:sadd(black..'MARTEN:VipMem:'..msg.chat_id_,user)
...
bot_data:srem(black..'MARTEN:VipMem:'..msg.chat_id_,user)
...
keyboard = {} 
if Sudo(msg) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="• رفع ادمن •",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="• رفع منشئ •",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="• رفع مدير •",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="• رفع منظف •",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="• رفع منشئ اساسي •",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="• رفع مالك •",callback_data=msg.sender_user_id_..":SetOwner:"..result.sender_user_id_},{text="• رفع مطور •",callback_data=msg.sender_user_id_..":SetSudoBot:"..result.sender_user_id_}},{{text="• رفع مطور ثانوي •",callback_data=msg.sender_user_id_..":SetSecondSudo:"..result.sender_user_id_},{text="• رفع مطور اساسي •",callback_data=msg.sender_user_id_..":SetMARTENSudo:"..result.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
elseif SecondSudo(msg) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="• رفع ادمن •",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="• رفع منشئ •",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="• رفع مدير •",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="• رفع منظف •",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="• رفع منشئ اساسي •",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="• رفع مالك •",callback_data=msg.sender_user_id_..":SetOwner:"..result.sender_user_id_},{text="• رفع مطور •",callback_data=msg.sender_user_id_..":SetSudoBot:"..result.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
elseif SudoBot(msg) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="• رفع ادمن •",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="• رفع منشئ •",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="• رفع مدير •",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="• رفع منظف •",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="• رفع منشئ اساسي •",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="• رفع مالك •",callback_data=msg.sender_user_id_..":SetOwner:"..result.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
elseif Owner(msg) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="• رفع ادمن •",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="• رفع منشئ •",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="• رفع مدير •",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="• رفع منظف •",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="• رفع منشئ اساسي •",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
elseif BasicConstructor(msg) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="• رفع ادمن •",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="• رفع منشئ •",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="• رفع مدير •",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="• رفع منظف •",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
elseif Constructor(msg) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="• رفع ادمن •",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="• رفع منظف •",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="• رفع مدير •",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
elseif Manager(msg) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="• رفع ادمن •",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
elseif Admin(msg) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
end
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text='..URL.escape(Text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
...
elseif SecondSudo(msg) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="• تنزيل منشئ  اساسي •",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text="• تنزيل مالك •",callback_data=msg.sender_user_id_..":RemOwner:"..result.sender_user_id_},{text="• تنزيل مطور •",callback_data=msg.sender_user_id_..":RemSudoBot:"..result.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
elseif SudoBot(msg) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="• تنزيل منشئ  اساسي •",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text="• تنزيل مالك •",callback_data=msg.sender_user_id_..":RemOwner:"..result.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
elseif Owner(msg) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="• تنزيل منشئ  اساسي •",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
elseif BasicConstructor(msg) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
elseif Constructor(msg) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
elseif Manager(msg) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
elseif Admin(msg) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
end
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text='..URL.escape(Text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
...
bot_data:del(black..'MARTEN:Bio:MARTEN'..msg.chat_id_) 
end
...
bot_data:set(black..'MARTEN:Bio:MARTEN'..msg.chat_id_,true)  
end
if text == 'نبذتي' or text == 'بايو' then
if not bot_data:get(black..'MARTEN:Bio:MARTEN'..msg.chat_id_) then
...
bot_data:del(black.."MARTEN:Lock:KickBan"..msg.chat_id_)
...
bot_data:set(black.."MARTEN:Lock:KickBan"..msg.chat_id_,"true")
...
bot_data:del(black.."MARTEN:Lock:MuteTked"..msg.chat_id_)
...
bot_data:set(black.."MARTEN:Lock:MuteTked"..msg.chat_id_,"true")
...
bot_data:del(black.."MARTEN:Lock:ProSet"..msg.chat_id_)
...
bot_data:set(black.."MARTEN:Lock:ProSet"..msg.chat_id_,"true")
...
if not Constructor(msg) and bot_data:get(black.."MARTEN:Lock:KickBan"..msg.chat_id_) then 
...
ChatKick(result.chat_id_, result.sender_user_id_)
bot_data:sadd(black..'MARTEN:Ban:'..msg.chat_id_, result.sender_user_id_)
...
ChatKick(msg.chat_id_, result.id_)
bot_data:sadd(black..'MARTEN:Ban:'..msg.chat_id_, result.id_)
...
ChatKick(msg.chat_id_, user)
bot_data:sadd(black..'MARTEN:Ban:'..msg.chat_id_, user)
...
bot_data:srem(black..'MARTEN:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
bot_data:srem(black..'MARTEN:Ban:'..msg.chat_id_, result.id_)
...
bot_data:srem(black..'MARTEN:Ban:'..msg.chat_id_, user)
...
if not Constructor(msg) and bot_data:get(black.."MARTEN:Lock:MuteTked"..msg.chat_id_) then 
...
if bot_data:sismember(black..'MARTEN:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","𐇮 هو بالفعل مكتوم من المجموعه")  
else
bot_data:sadd(black..'MARTEN:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if bot_data:sismember(black..'MARTEN:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","𐇮 هو بالفعل مكتوم من المجموعه")  
else
bot_data:sadd(black..'MARTEN:Muted:'..msg.chat_id_, result.id_)
...
if bot_data:sismember(black..'MARTEN:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","𐇮 هو بالفعل مكتوم من المجموعه")  
else
bot_data:sadd(black..'MARTEN:Muted:'..msg.chat_id_, user)
...
if not bot_data:sismember(black..'MARTEN:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","𐇮 هو ليس مكتوم لالغاء كتمه")  
else
bot_data:srem(black..'MARTEN:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
if not bot_data:sismember(black..'MARTEN:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","𐇮 هو ليس مكتوم لالغاء كتمه")  
else
bot_data:srem(black..'MARTEN:Muted:'..msg.chat_id_, result.id_)
...
if not bot_data:sismember(black..'MARTEN:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","𐇮 هو ليس مكتوم لالغاء كتمه")  
else
bot_data:srem(black..'MARTEN:Muted:'..msg.chat_id_, user)
...
bot_data:sadd(black..'MARTEN:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
bot_data:sadd(black..'MARTEN:Tkeed:'..msg.chat_id_, result.id_)
...
bot_data:sadd(black..'MARTEN:Tkeed:'..msg.chat_id_, user)
...
bot_data:srem(black..'MARTEN:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
bot_data:srem(black..'MARTEN:Tkeed:'..msg.chat_id_, result.id_)
...
bot_data:srem(black..'MARTEN:Tkeed:'..msg.chat_id_, user)
...
if bot_data:sismember(black..'MARTEN:SecondSudo:',result.sender_user_id_) and not Sudo(msg) then
send_X(msg.chat_id_, msg.id_, 1, "𐇮 *لاتستطيع حظر المطور الثانوي*", 1, 'md')
return false 
end
ChatKick(result.chat_id_, result.sender_user_id_)
bot_data:sadd(black..'MARTEN:BanAll:', result.sender_user_id_)
...
if bot_data:sismember(black..'MARTEN:SecondSudo:',result.id_) and not Sudo(msg) then
send_X(msg.chat_id_, msg.id_, 1, "𐇮 *لاتستطيع حظر المطور الثانوي*", 1, 'md')
return false 
end
if result.id_ then
ChatKick(msg.chat_id_, result.id_)
bot_data:sadd(black..'MARTEN:BanAll:', result.id_)
...
if bot_data:sismember(black..'MARTEN:SecondSudo:',user) and not Sudo(msg) then
send_X(msg.chat_id_, msg.id_, 1, "𐇮 *لاتستطيع حظر المطور الثانوي*", 1, 'md')
return false 
end
ChatKick(msg.chat_id_, user)
bot_data:sadd(black..'MARTEN:BanAll:', user)
...
bot_data:sadd(black..'MARTEN:MuteAll:', result.sender_user_id_)
...
if result.id_ then
bot_data:sadd(black..'MARTEN:MuteAll:', result.id_)
...
bot_data:sadd(black..'MARTEN:MuteAll:', user)
...
bot_data:srem(black..'MARTEN:BanAll:', result.sender_user_id_)
bot_data:srem(black..'MARTEN:MuteAll:', result.sender_user_id_)
...
if result.id_ then
bot_data:srem(black..'MARTEN:BanAll:', result.id_)
bot_data:srem(black..'MARTEN:MuteAll:', result.id_)
...
bot_data:srem(black..'MARTEN:BanAll:', user)
bot_data:srem(black..'MARTEN:MuteAll:', user)
...
bot_data:setex(black.."MARTEN:EditDev"..msg.sender_user_id_,300,true)
end
if bot_data:get(black.."MARTEN:EditDev"..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,'𐇮 تم الغاء امر تغير المطور الاساسي')
bot_data:del(black.."MARTEN:EditDev"..msg.sender_user_id_)
return false
end
if text and text:match("^(%d+)$") then 
...
if dp.first_name_ ~= false then
bot_data:del(black.."MARTEN:EditDev"..msg.sender_user_id_)
bot_data:set(black.."MARTEN:NewDev"..msg.sender_user_id_,dp.id_)
...
--     Source -black-     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع مطي$") and not bot_data:get(black..'MARTEN:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
...
--     Source -black-     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل مطي$") and not bot_data:get(black..'MARTEN:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
...
--     Source -black-     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع حاته$") and not bot_data:get(black..'MARTEN:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
...
--     Source -black-     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل حاته$") and not bot_data:get(black..'MARTEN:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function HaTa_by_reply(extra, result, success)
...
--     Source -black-     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع صاك$") and not bot_data:get(black..'MARTEN:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
...
--     Source -black-     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل صاك$") and not bot_data:get(black..'MARTEN:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function hlo_by_reply(extra, result, success)
...
--     Source -black-     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع صخل$") and not bot_data:get(black..'MARTEN:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
...
--     Source -black-     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل صخل$") and not bot_data:get(black..'MARTEN:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function Sakl_by_reply(extra, result, success)
...
--     Source -black-     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع جلب$") and not bot_data:get(black..'MARTEN:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
...
--     Source -black-     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل جلب$") and not bot_data:get(black..'MARTEN:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function Dog_by_reply(extra, result, success)
...
--     Source -black-     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع ضلعه$") and not bot_data:get(black..'MARTEN:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
...
--     Source -black-     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل ضلعه$") and not bot_data:get(black..'MARTEN:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function Bro_Gir_lby_reply(extra, result, success)
...
--     Source -black-     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع ضلع$") and not bot_data:get(black..'MARTEN:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
...
--     Source -black-     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل ضلع$") and not bot_data:get(black..'MARTEN:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function Bro_by_reply(extra, result, success)
...
--     Source -black-     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع بقره$") and not bot_data:get(black..'MARTEN:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
...
--     Source -black-     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل بقره$") and not bot_data:get(black..'MARTEN:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function Bakra_lby_reply(extra, result, success)
...
--     Source -black-     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع طلي$") and not bot_data:get(black..'MARTEN:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
...
--     Source -black-     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل طلي$") and not bot_data:get(black..'MARTEN:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function Tale_lby_reply(extra, result, success)
...
--     Source -black-     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع زاحف$") and not bot_data:get(black..'MARTEN:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
...
--     Source -black-     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل زاحف$") and not bot_data:get(black..'MARTEN:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function Zahf_lby_reply(extra, result, success)
...
--     Source -black-     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع جريذي$") and not bot_data:get(black..'MARTEN:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
...
--     Source -black-     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل جريذي$") and not bot_data:get(black..'MARTEN:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function Jred_lby_reply(extra, result, success)
...
bot_data:set('XboT:'..black..'id:user'..msg.chat_id_,TXT)  
bot_data:setex('XboT:'..black.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
bot_data:del(black..'MARTEN:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_) 
bot_data:incrby(black..'MARTEN:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_,Num) 
...
bot_data:set('XboT:'..black..'ids:user'..msg.chat_id_,TXT)  
bot_data:setex('XboT:'..black.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
function Reply(extra, result, success)
bot_data:incrby(black..'MARTEN:GamesNumber'..msg.chat_id_..result.sender_user_id_,Num) 
send_X(msg.chat_id_, msg.id_, 1, "𐇮 تم اضافة "..Num..' نقطه', 1, 'md') 
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},Reply, nil)
return false
end
if bot_data:get(black..'MARTEN:Lock:Clean'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ then if msg.reply_to_message_id_ ~= 0 then bot_data:sadd(black.."MARTEN:cleaner"..msg.chat_id_, msg.id_) else bot_data:sadd(black.."MARTEN:cleaner"..msg.chat_id_, msg.id_) end end end
if Manager(msg) and msg.reply_to_message_id_ ~= 0 then
if text and text:match("^تثبيت$") and ChCheck(msg) then 
if bot_data:sismember(black.."MARTEN:Lock:Pinpin",msg.chat_id_) and not BasicConstructor(msg) then
...
if data.ID == "Ok" then
bot_data:set(black..'MARTEN:PinnedMsg'..msg.chat_id_,msg.reply_to_message_id_)
...
local List = bot_data:smembers(black..'MARTEN:VipMem:'..msg.chat_id_)
text = "𐇮 قائمة المميزين ↫ ⤈ \nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ\n"
for k,v in pairs(List) do
local username = bot_data:get(black..'Save:UserName'..v)
if username then
...
local inline = {{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
SendInline(msg.chat_id_,text,nil,inline,msg.id_/2097152/0.5)
end end
--     source -black-     --
if Manager(msg) then
...
local inline = {{{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
SendInline(msg.chat_id_,text,nil,inline,msg.id_/2097152/0.5)
end end
--     source -black-     -- 
if Constructor(msg) then
if text == "المدراء" and ChCheck(msg) or text == "مدراء" and ChCheck(msg) then 
local List = bot_data:smembers(black..'MARTEN:Managers:'..msg.chat_id_)
text = "𐇮 قائمة المدراء ↫ ⤈ \nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ\n"
for k,v in pairs(List) do
local username = bot_data:get(black..'Save:UserName'..v)
if username then
...
local inline = {{{text="• مسح المدراء •",callback_data="/DelManager:"..msg.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
SendInline(msg.chat_id_,text,nil,inline,msg.id_/2097152/0.5)
end 
if text == "المنظفين" and ChCheck(msg) then 
local List = bot_data:smembers(black..'MARTEN:Cleaner:'..msg.chat_id_)
text = "𐇮 قائمة المنظفين ↫ ⤈ \nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ\n"
for k,v in pairs(List) do
local username = bot_data:get(black..'Save:UserName'..v)
if username then
...
local inline = {{{text="• مسح المنظفين •",callback_data="/DelCleanr:"..msg.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
SendInline(msg.chat_id_,text,nil,inline,msg.id_/2097152/0.5)
end end
--     source -black-     --
if BasicConstructor(msg) then
if text == "المنشئين" and ChCheck(msg) then 
local List = bot_data:smembers(black..'MARTEN:Constructor:'..msg.chat_id_)
text = "𐇮 قائمة المنشئين ↫ ⤈ \nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ\n"
for k,v in pairs(List) do
local username = bot_data:get(black..'Save:UserName'..v)
if username then
...
local inline = {{{text="• مسح المنشئين •",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
SendInline(msg.chat_id_,text,nil,inline,msg.id_/2097152/0.5)
end end
--     source -black-     --
if Owner(msg) then
if text == "المالكين" and ChCheck(msg) then 
local List = bot_data:smembers(black..'MARTEN:Owner:'..msg.chat_id_)
text = "𐇮 قائمة المالكين ↫ ⤈ \nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ\n"
for k,v in pairs(List) do
local username = bot_data:get(black..'Save:UserName'..v)
if username then
...
local inline = {{{text="• مسح المالكين •",callback_data="/DelOwner:"..msg.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
SendInline(msg.chat_id_,text,nil,inline,msg.id_/2097152/0.5)
end
...
local inline = {{{text="• مسح المنشئين الاساسيين •",callback_data="/DelBasicConstructor:"..msg.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
SendInline(msg.chat_id_,text,nil,inline,msg.id_/2097152/0.5)
end 
end 
...
local List = bot_data:smembers(black..'MARTEN:Muted:'..msg.chat_id_)
...
local List = bot_data:smembers(black..'MARTEN:Tkeed:'..msg.chat_id_)
text = "𐇮 قائمة المقيدين ↫ ⤈ \n┋⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎┋\n"
for k,v in pairs(List) do
local username = bot_data:get(black..'Save:UserName'..v)
if username then
...
local List = bot_data:smembers(black..'MARTEN:Ban:'..msg.chat_id_)
...
local List = bot_data:hkeys(black..'MARTEN:Filters:'..msg.chat_id_)
text = "𐇮 قائمة المنع ↫ ⤈ \n┋⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎┋\n"
for k, v in pairs(List) do
text = text..k..'~ ❨ '..v..' ❩\n'
end
...
local inline = {{{text="• مسح الثانويين •",callback_data="/DelSecondSudo:"..msg.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
SendInline(msg.chat_id_,text,nil,inline,msg.id_/2097152/0.5)
end
--     Source -black-     --
if SudoBot(msg) then
...
local BanAll = bot_data:smembers(black..'MARTEN:BanAll:')
local MuteAll = bot_data:smembers(black..'MARTEN:MuteAll:')
if #BanAll ~= 0 then 
...
local inline = {{{text="• مسح المطورين •",callback_data="/DelSudoBot:"..msg.sender_user_id_}},{{text='𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊',url="t.me/BLACK_TEAM_4"}}}
SendInline(msg.chat_id_,text,nil,inline,msg.id_/2097152/0.5)
end
--     Source -black-     --
if text == "المدراء العامين" and ChCheck(msg) then 
local List = bot_data:smembers(black..'MARTEN:ManagerAll:')
...
local List = bot_data:smembers(black..'MARTEN:VipAll:')
...
local List = bot_data:smembers(black..MARTEN)
...
bot_data:sadd(black.."MARTEN:Owner:"..msg.chat_id_,dp.id_)
end,nil)   
end,nil)   
end
end 
...
bot_data:sadd(black.."MARTEN:FilterSteckr"..msg.chat_id_,idsticker)
send_X(msg.chat_id_, msg.id_, 1, '𐇮 تم منع الملصق بنجاح لن يتم ارساله مجددا', 1, 'md')
return false
end
if result.content_.ID == "MessagePhoto" then
local photo = result.content_.photo_.id_
bot_data:sadd(black.."MARTEN:FilterPhoto"..msg.chat_id_,photo)
send_X(msg.chat_id_, msg.id_, 1, '𐇮 تم منع الصوره بنجاح لن يتم ارسالها مجددا', 1, 'md')
return false
end
if result.content_.animation_ then
local idanimation = result.content_.animation_.animation_.persistent_id_
bot_data:sadd(black.."MARTEN:FilterAnimation"..msg.chat_id_,idanimation)
...
if result.content_.sticker_ then
local idsticker = result.content_.sticker_.sticker_.persistent_id_
bot_data:srem(black.."MARTEN:FilterSteckr"..msg.chat_id_,idsticker)
send_X(msg.chat_id_, msg.id_, 1, '𐇮 تم الغاء منع الملصق يمكنهم ارساله الان', 1, 'md')
return false
end
if result.content_.ID == "MessagePhoto" then
local photo = result.content_.photo_.id_
bot_data:srem(black.."MARTEN:FilterPhoto"..msg.chat_id_,photo)
send_X(msg.chat_id_, msg.id_, 1, '𐇮 تم الغاء منع الصوره يمكنهم ارسالها الان', 1, 'md')
return false
end
if result.content_.animation_.animation_ then
local idanimation = result.content_.animation_.animation_.persistent_id_
bot_data:srem(black.."MARTEN:FilterAnimation"..msg.chat_id_,idanimation)
...
bot_data:del(black..'MARTEN:Thwel:MARTEN'..msg.chat_id_) 
end
...
bot_data:set(black..'MARTEN:Thwel:MARTEN'..msg.chat_id_,true)  
end
if text == 'تحويل' and not bot_data:get(black..'MARTEN:Thwel:MARTEN'..msg.chat_id_) and ChCheck(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local user_msgs = bot_data:get(black..'MARTEN:UsersMsgs'..msg.chat_id_..':'..data.id_) or 0
local user_nkt = tonumber(bot_data:get(black..'MARTEN:GamesNumber'..msg.chat_id_..data.id_) or 0)
if bot_data:sismember(black..'MARTEN:BanAll:',result.sender_user_id_) then
Tkeed = 'محظور عام'
elseif bot_data:sismember(black..'MARTEN:MuteAll:',result.sender_user_id_) then
Tkeed = 'مكتوم عام'
elseif bot_data:sismember(black..'MARTEN:Ban:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'محظور'
elseif bot_data:sismember(black..'MARTEN:Muted:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مكتوم'
elseif bot_data:sismember(black..'MARTEN:Tkeed:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if bot_data:sismember(black..'MARTEN:SudoBot:',result.sender_user_id_) and SudoBot(msg) then
sudobot = '\n𐇮 عدد الكروبات ↫ '..(bot_data:get(black..'MARTEN:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = bot_data:get(black..'MARTEN:UsersMsgs'..msg.chat_id_..':'..res.id_) or 0
local user_nkt = tonumber(bot_data:get(black..'MARTEN:GamesNumber'..msg.chat_id_..res.id_) or 0)
if bot_data:sismember(black..'MARTEN:BanAll:',res.id_) then
Tkeed = 'محظور عام'
elseif bot_data:sismember(black..'MARTEN:MuteAll:',res.id_) then
Tkeed = 'مكتوم عام'
elseif bot_data:sismember(black..'MARTEN:Ban:'..msg.chat_id_,res.id_) then
Tkeed = 'محظور'
elseif bot_data:sismember(black..'MARTEN:Muted:'..msg.chat_id_,res.id_) then
Tkeed = 'مكتوم'
elseif bot_data:sismember(black..'MARTEN:Tkeed:'..msg.chat_id_,res.id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if bot_data:sismember(black..'MARTEN:SudoBot:',res.id_) and SudoBot(msg) then
sudobot = '\n𐇮 عدد الكروبات ↫ '..(bot_data:get(black..'MARTEN:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = bot_data:get(black..'MARTEN:UsersMsgs'..msg.chat_id_..':'..iduser) or 0
local user_nkt = tonumber(bot_data:get(black..'MARTEN:GamesNumber'..msg.chat_id_..iduser) or 0)
if bot_data:sismember(black..'MARTEN:BanAll:',iduser) then
Tkeed = 'محظور عام'
elseif bot_data:sismember(black..'MARTEN:MuteAll:',iduser) then
Tkeed = 'مكتوم عام'
elseif bot_data:sismember(black..'MARTEN:Ban:'..msg.chat_id_,iduser) then
Tkeed = 'محظور'
elseif bot_data:sismember(black..'MARTEN:Muted:'..msg.chat_id_,iduser) then
Tkeed = 'مكتوم'
elseif bot_data:sismember(black..'MARTEN:Tkeed:'..msg.chat_id_,iduser) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if bot_data:sismember(black..'MARTEN:SudoBot:',iduser) and SudoBot(msg) then
sudobot = '\n𐇮 عدد الكروبات ↫ '..(bot_data:get(black..'MARTEN:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
if bot_data:sismember(black..'MARTEN:Muted:'..msg.chat_id_,result.sender_user_id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if bot_data:sismember(black..'MARTEN:Ban:'..msg.chat_id_,result.sender_user_id_) then banned = 'محظور' else banned = 'غير محظور' end
if bot_data:sismember(black..'MARTEN:BanAll:',result.sender_user_id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if bot_data:sismember(black..'MARTEN:MuteAll:',result.sender_user_id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if bot_data:sismember(black..'MARTEN:Tkeed:',result.sender_user_id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
...
if result.id_ then
if bot_data:sismember(black..'MARTEN:Muted:'..msg.chat_id_,result.id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if bot_data:sismember(black..'MARTEN:Ban:'..msg.chat_id_,result.id_) then banned = 'محظور' else banned = 'غير محظور' end
if bot_data:sismember(black..'MARTEN:BanAll:',result.id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if bot_data:sismember(black..'MARTEN:MuteAll:',result.id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if bot_data:sismember(black..'MARTEN:Tkeed:',result.id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
send_X(msg.chat_id_, msg.id_, 1, '𐇮 الحظر العام ↫ '..banall..'\n𐇮 الكتم العام ↫ '..muteall..'\n𐇮 الحظر ↫ '..banned..'\n𐇮 الكتم ↫ '..muted..'\n𐇮 التقيد ↫ '..tkeed, 1, 'md')  
else
send_X(msg.chat_id_, msg.id_, 1, '𐇮 *المعرف غير صحيح*', 1, 'md')  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
bot_data:srem(black..'MARTEN:Tkeed:'..msg.chat_id_,result.sender_user_id_) bot_data:srem(black..'MARTEN:Ban:'..msg.chat_id_,result.sender_user_id_) bot_data:srem(black..'MARTEN:Muted:'..msg.chat_id_,result.sender_user_id_) bot_data:srem(black..'MARTEN:BanAll:',result.sender_user_id_) bot_data:srem(black..'MARTEN:MuteAll:',result.sender_user_id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
bot_data:srem(black..'MARTEN:Tkeed:'..msg.chat_id_,result.sender_user_id_) bot_data:srem(black..'MARTEN:Ban:'..msg.chat_id_,result.sender_user_id_) bot_data:srem(black..'MARTEN:Muted:'..msg.chat_id_,result.sender_user_id_) 
end
end
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),unbanreply) 
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
bot_data:srem(black..'MARTEN:Tkeed:'..msg.chat_id_,user) bot_data:srem(black..'MARTEN:Ban:'..msg.chat_id_,user) bot_data:srem(black..'MARTEN:Muted:'..msg.chat_id_,user) bot_data:srem(black..'MARTEN:BanAll:',user) bot_data:srem(black..'MARTEN:MuteAll:',user)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
bot_data:srem(black..'MARTEN:Tkeed:'..msg.chat_id_,user) bot_data:srem(black..'MARTEN:Ban:'..msg.chat_id_,user) bot_data:srem(black..'MARTEN:Muted:'..msg.chat_id_,user) 
end  
end,nil)  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
bot_data:srem(black..'MARTEN:Tkeed:'..msg.chat_id_,result.id_) bot_data:srem(black..'MARTEN:Ban:'..msg.chat_id_,result.id_) bot_data:srem(black..'MARTEN:Muted:'..msg.chat_id_,result.id_) bot_data:srem(black..'MARTEN:BanAll:',result.id_) bot_data:srem(black..'MARTEN:MuteAll:',result.id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
bot_data:srem(black..'MARTEN:Tkeed:'..msg.chat_id_,result.id_) bot_data:srem(black..'MARTEN:Ban:'..msg.chat_id_,result.id_) bot_data:srem(black..'MARTEN:Muted:'..msg.chat_id_,result.id_) 
end
end,nil)   
end  
...
bot_data:set(black.."MARTEN:GpIds:Text"..msg.chat_id_,Text_Rand)
...
bot_data:set("black:New:id:"..black..msg.sender_user_id_,'XboT')
return "XboT"
end
...
bot_data:set(black.."MARTEN:AllIds:Text",text)
return false
end
...
bot_data:del(black.."MARTEN:AllIds:Text")
end
end
--     Source -black-     --
if text and text:match("^تعيين الايدي$") and ChCheck(msg) or text and text:match("^تعين الايدي$") and ChCheck(msg) then
send_X(msg.chat_id_, msg.id_, 1, '𐇮 رجائا اتبع التعليمات للتعيين \n𐇮 لطبع كليشة الايدي ارسل كليشه تحتوي على النصوص التي باللغه الانجليزيه ادناه ↫ ⤈\n┋⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎┋\n `#username` ↬ لطبع المعرف\n `#id` ↬ لطبع الايدي \n `#photos` ↬ لطبع عدد الصور \n `#stast` ↬ لطبع الرتب \n `#msgs` ↬ لطبع عدد الرسائل \n `#msgday` ↬ لطبع الرسائل اليوميه \n `#CustomTitle` ↬ لطبع اللقب \n `#bio` ↬ لطبع البايو \n `#auto` ↬ لطبع التفاعل \n `#game` ↬ لطبع عدد النقاط \n `#cont` ↬ لطبع عدد الجهات \n `#edit` ↬ لطبع عدد السحكات \n `#Description` ↬ لطبع تعليق الصور\n┋⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎┋', 1, 'md')
bot_data:set("black:New:id:"..black..msg.chat_id_..msg.sender_user_id_,'XboT')
return "XboT"
end
...
bot_data:set(black.."MARTEN:GpIds:Text"..msg.chat_id_,text)
return false
end
if text and text:match("^حذف الايدي$") and ChCheck(msg) or text and text:match("^مسح الايدي$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𐇮 تم حذف كليشة الايدي")  
bot_data:del(black.."MARTEN:GpIds:Text"..msg.chat_id_)
end
end
--     Source -black-     --
if msg.reply_to_message_id_ ~= 0 then
...
local msgsday = bot_data:get(black..'MARTEN:UsersMsgs'..black..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local edit_msg = bot_data:get(black..'MARTEN:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = bot_data:get(black..'MARTEN:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local user_nkt = tonumber(bot_data:get(black..'MARTEN:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
local cont = (tonumber(bot_data:get(black..'MARTEN:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
...
if MaRTeN.photos_[0] then
if not bot_data:get(black..'MARTEN:Lock:Id'..msg.chat_id_) then 
if not bot_data:get(black..'MARTEN:Lock:Id:Photo'..msg.chat_id_) then 
if bot_data:get(black.."MARTEN:AllIds:Text") then
newpicid = bot_data:get(black.."MARTEN:AllIds:Text")
...
if not bot_data:get(black.."MARTEN:GpIds:Text"..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, MaRTeN.photos_[0].sizes_[1].photo_.persistent_id_,newpicid,msg.id_,msg.id_.."")
else 
local new_id = bot_data:get(black.."MARTEN:GpIds:Text"..msg.chat_id_)
...
if bot_data:get(black.."MARTEN:AllIds:Text") then
newallid = bot_data:get(black.."MARTEN:AllIds:Text")
...
if bot_data:get(black.."MARTEN:AllIds:Text") then
notpicid = bot_data:get(black.."MARTEN:AllIds:Text")
...
if not bot_data:get(black..'MARTEN:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𐇮 تم قفل التعديل")  
bot_data:set(black..'MARTEN:Lock:EditMsgs'..msg.chat_id_,true)
else
...
bot_data:set(black.."MARTEN:Lock:Bots"..msg.chat_id_,"del")  
end
if LockText[2] == "البوتات بالطرد" then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𐇮 تم قفل البوتات بالطرد")  
bot_data:set(black.."MARTEN:Lock:Bots"..msg.chat_id_,"kick")  
end
...
bot_data:set(black.."MARTEN:Lock:Bots"..msg.chat_id_,"ked")  
end
if LockText[2] == "التكرار" or LockText[2] == "التكرار بالحذف" then 
bot_data:hset(black.."MARTEN:Spam:Group:User"..msg.chat_id_ ,"Spam:User","del")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𐇮 تم قفل التكرار بالحذف")  
end
if LockText[2] == "التكرار بالطرد" then 
bot_data:hset(black.."MARTEN:Spam:Group:User"..msg.chat_id_ ,"Spam:User","kick")  
...
bot_data:hset(black.."MARTEN:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𐇮 تم قفل التكرار بالتقيد")  
end
if LockText[2] == "التكرار بالكتم" then 
bot_data:hset(black.."MARTEN:Spam:Group:User"..msg.chat_id_ ,"Spam:User","mute")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𐇮 تم قفل التكرار بالكتم")  
end
if BasicConstructor(msg) then
if LockText[2] == "التثبيت" then
if not bot_data:get(black..'MARTEN:Lock:Pin'..msg.chat_id_) then
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  bot_data:set(black.."MARTEN:PinnedMsg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𐇮 تم قفل التثبيت")  
bot_data:set(black..'MARTEN:Lock:Pin'..msg.chat_id_,true)
bot_data:sadd(black.."MARTEN:Lock:Pinpin",msg.chat_id_) 
else
...
bot_data:hset(black.."MARTEN:Spam:Group:User"..msg.chat_id_ ,"Num:Spam" ,TextSpam) 
end
end
if text and (text:match("^ضع زمن التكرار (%d+)$") or text:match("^وضع زمن التكرار (%d+)$")) then  
local TextSpam = text:match("ضع زمن التكرار (%d+)$") or text:match("وضع زمن التكرار (%d+)$")
bot_data:hset(black.."MARTEN:Spam:Group:User"..msg.chat_id_ ,"Num:Spam:Time" ,TextSpam) 
...
bot_data:del(black..'MARTEN:Lock:Id:Photo'..msg.chat_id_)
end end
if text and text == 'تعطيل الايدي بالصوره' and ChCheck(msg) then
if bot_data:get(black..'MARTEN:Lock:Id:Photo'..msg.chat_id_) then
...
bot_data:set(black..'MARTEN:Lock:Id:Photo'..msg.chat_id_,true)
end end 
...
bot_data:del(black..'MARTEN:Lock:Id'..msg.chat_id_)
end end 
if text and text == 'تعطيل الايدي' and ChCheck(msg) then
if bot_data:get(black..'MARTEN:Lock:Id'..msg.chat_id_) then
send_X(msg.chat_id_, msg.id_, 1, '𐇮 الايدي بالتاكيد معطل ', 1, 'md')
else
ReplyStatus(msg,msg.sender_user_id_,"EbDsDrg","𐇮 تم تعطيل الايدي بنجاح")
bot_data:set(black..'MARTEN:Lock:Id'..msg.chat_id_,true)
end end
end
--     Source -black-     --
...
bot_data:setex(black.."MARTEN:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_,300,true) 
end
if text == 'انشاء رابط' or text == 'انشاء الرابط' then
local LinkGp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if not bot_data:get(black.."MARTEN:Groups:Links"..msg.chat_id_)  then 
if LinkGp.ok == true then 
LinkGroup = LinkGp.result
bot_data:set(black.."MARTEN:Groups:Links"..msg.chat_id_,LinkGroup) 
...
bot_data:set(black.."MARTEN:Lock:Welcome"..msg.chat_id_,true)
end
if text and text:match("^تعطيل الترحيب$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"EbDsDrg","𐇮 تم تعطيل الترحيب بنجاح")
bot_data:del(black.."MARTEN:Lock:Welcome"..msg.chat_id_)
end
if bot_data:get(black..'MARTEN:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
send_X(msg.chat_id_, msg.id_, 1, '𐇮 تم الغاء حفظ كليشة الترحيب', 1, 'md')
bot_data:del(black..'MARTEN:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
bot_data:del(black..'MARTEN:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
Welcomes = text:gsub('"',"") Welcomes = text:gsub("'","") Welcomes = text:gsub(",","") Welcomes = text:gsub("*","") Welcomes = text:gsub(";","") Welcomes = text:gsub("`","") Welcomes = text:gsub("{","") Welcomes = text:gsub("}","") 
bot_data:set(black..'MARTEN:Groups:Welcomes'..msg.chat_id_,Welcomes)
...
bot_data:set(black..'MARTEN:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
if text and text:match("^حذف الترحيب$") and ChCheck(msg) or text and text:match("^حذف ترحيب$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𐇮 تم حذف الترحيب")  
bot_data:del(black..'MARTEN:Groups:Welcomes'..msg.chat_id_)
end
if text and text:match("^جلب الترحيب$") and ChCheck(msg) or text and text:match("^جلب ترحيب$") and ChCheck(msg) or text and text:match("^الترحيب$") and ChCheck(msg) then
local Welcomes = bot_data:get(black..'MARTEN:Groups:Welcomes'..msg.chat_id_)
if Welcomes then
send_X(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
else
...
--     Source -black-     --
if bot_data:get(black..'MARTEN:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_) then  
if text == 'الغاء' then 
send_X(msg.chat_id_, msg.id_, 1, "𐇮 تم الغاء حفظ الوصف", 1, 'md')
bot_data:del(black..'MARTEN:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
bot_data:del(black..'MARTEN:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
...
bot_data:set(black..'MARTEN:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_,true)
...
bot_data:set(black.."MARTEN:SetFilters"..msg.sender_user_id_..msg.chat_id_,"add")  
return false  
end    
if bot_data:get(black.."MARTEN:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "add" then
if text == 'الغاء' then 
send_X(msg.chat_id_, msg.id_, 1, '𐇮 تم الغاء امر المنع', 1, 'md')
bot_data:del(black.."MARTEN:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
send_X(msg.chat_id_, msg.id_, 1, "𐇮 تم منع الكلمه ↫ "..text, 1, 'html')
bot_data:del(black.."MARTEN:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
bot_data:hset(black..'MARTEN:Filters:'..msg.chat_id_, text,'newword')
return false
end
if text and text == "الغاء منع" and msg.reply_to_message_id_ == 0 and ChCheck(msg) then       
send_X(msg.chat_id_, msg.id_, 1, "𐇮 ارسل لي الكلمه الان", 1, 'md') 
bot_data:set(black.."MARTEN:SetFilters"..msg.sender_user_id_..msg.chat_id_,"del")  
return false  
end    
if bot_data:get(black.."MARTEN:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "del" then   
if text == 'الغاء' then 
send_X(msg.chat_id_, msg.id_, 1, '𐇮 تم الغاء امر الغاء المنع', 1, 'md')
bot_data:del(black.."MARTEN:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
if not bot_data:hget(black..'MARTEN:Filters:'..msg.chat_id_, text) then  
send_X(msg.chat_id_, msg.id_, 1, "𐇮 الكلمه ↫ "..text.." غير ممنوعه", 1, 'html')
bot_data:del(black.."MARTEN:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
else
bot_data:hdel(black..'MARTEN:Filters:'..msg.chat_id_, text)
...
local gps = bot_data:scard(black.."MARTEN:Groups") local users = bot_data:scard(black.."MARTEN:Users") 
...
local users = bot_data:scard(black.."MARTEN:Users")
send_X(msg.chat_id_, msg.id_, 1, '𐇮 عدد المشتركين ↫ ❨ '..users..' ❩', 1, 'md')
end
if text and text == "المجموعات" and ChCheck(msg) or text and text == "↫ المجموعات ⌯" then
local gps = bot_data:scard(black.."MARTEN:Groups")
...
local pv = bot_data:smembers(black.."MARTEN:Users")
local sendok = 0
for i = 1, #pv do
...
bot_data:srem(black.."MARTEN:Users",pv[i])
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
local group = bot_data:smembers(black.."MARTEN:Groups")
local w = 0
local q = 0
for i = 1, #group do
tdcli_function({ID='GetChat',chat_id_ = group[i]},function(arg,data)
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
bot_data:srem(black.."MARTEN:Groups",group[i]) 
...
send_X(msg.chat_id_, msg.id_, 1,'𐇮 عدد الكروبات الان ↫ { '..#group..' }'..blackgp1..blackgp2..'\n𐇮 العدد الحقيقي الان  ↫ ( '..blackgp3..' ) \n ', 1, 'md')
end end
end,nil)
end
return false
...
bot_data:set(black..'MARTEN:Lock:Clean'..msg.chat_id_,true)  
end
...
bot_data:del(black..'MARTEN:Lock:Clean'..msg.chat_id_) 
end
...
bot_data:set(black..'MARTEN:CleanNum'..msg.chat_id_,Num) 
end end 
if msg and bot_data:get(black..'MARTEN:Lock:Clean'..msg.chat_id_) then
if bot_data:get(black..'MARTEN:CleanNum'..msg.chat_id_) then CleanNum = bot_data:get(black..'MARTEN:CleanNum'..msg.chat_id_) else CleanNum = 200 end
if bot_data:scard(black.."MARTEN:cleaner"..msg.chat_id_) >= tonumber(CleanNum) then 
local List = bot_data:smembers(black.."MARTEN:cleaner"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
...
bot_data:del(black.."MARTEN:cleaner"..msg.chat_id_)
end 
end 
if Cleaner(msg) then
if bot_data:get(black..'MARTEN:Lock:Clean'..msg.chat_id_) then 
if text == "الميديا" and ChCheck(msg) or text == "عدد الميديا" and ChCheck(msg) then 
local M = bot_data:scard(black.."MARTEN:cleaner"..msg.chat_id_)
if M ~= 0 then
send_X(msg.chat_id_, msg.id_, 1, "𐇮 عدد الميديا ↫ "..M.."\n𐇮 الحذف التلقائي ↫ "..(bot_data:get(black..'MARTEN:CleanNum'..msg.chat_id_) or 200), 1, 'md') 
else
...
if bot_data:get(black..'MARTEN:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𐇮 تم فتح التعديل")  
bot_data:del(black..'MARTEN:Lock:EditMsgs'..msg.chat_id_)
else
...
bot_data:del(black.."MARTEN:Lock:Bots"..msg.chat_id_)  
end
if UnLockText[2] == "التكرار" then 
bot_data:hdel(black.."MARTEN:Spam:Group:User"..msg.chat_id_ ,"Spam:User")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𐇮 تم فتح التكرار")  
end
if BasicConstructor(msg) then
if UnLockText[2] == "التثبيت" then
if bot_data:get(black..'MARTEN:Lock:Pin'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𐇮 تم فتح التثبيت")  
bot_data:del(black..'MARTEN:Lock:Pin'..msg.chat_id_)
bot_data:srem(black.."MARTEN:Lock:Pinpin",msg.chat_id_)
else
...
bot_data:del(black..'MARTEN:Lock:Text'..msg.chat_id_)
else
...
bot_data:del(black..'MARTEN:Lock:Photo'..msg.chat_id_)
else
send_X(msg.chat_id_, msg.id_, 1, '𐇮 الصور بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الكلايش" then
if bot_data:get(black..'MARTEN:Lock:Spam'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𐇮 تم فتح الكلايش")  
bot_data:del(black..'MARTEN:Lock:Spam'..msg.chat_id_)
else
...
bot_data:del(black..'MARTEN:Lock:Join'..msg.chat_id_)
else
...
bot_data:del(black..'MARTEN:Lock:Videos'..msg.chat_id_)
else
...
bot_data:del(black..'MARTEN:Lock:Document'..msg.chat_id_)
else
...
bot_data:del(black..'MARTEN:Lock:Inline'..msg.chat_id_)
else
...
bot_data:del(black..'MARTEN:Lock:Markdown'..msg.chat_id_)
else
...
bot_data:del(black..'MARTEN:Lock:Gifs'..msg.chat_id_)
else
...
bot_data:del(black..'MARTEN:Lock:Music'..msg.chat_id_)
else
...
bot_data:del(black..'MARTEN:Lock:Voice'..msg.chat_id_)
else
...
bot_data:del(black..'MARTEN:Lock:Links'..msg.chat_id_)
else
...
bot_data:del(black..'MARTEN:Lock:Location'..msg.chat_id_)
else
...
bot_data:del(black..'MARTEN:Lock:Tags'..msg.chat_id_)
else
...
bot_data:del(black..'MARTEN:Lock:Hashtak'..msg.chat_id_)
else
...
bot_data:del(black..'MARTEN:Lock:Contact'..msg.chat_id_)
else
...
bot_data:del(black..'MARTEN:Lock:WebLinks'..msg.chat_id_)
else
...
bot_data:del(black..'MARTEN:Lock:Arabic'..msg.chat_id_)
else
...
bot_data:del(black..'MARTEN:Lock:English'..msg.chat_id_)
else
...
bot_data:del(black..'MARTEN:Lock:TagServr'..msg.chat_id_)
else
...
bot_data:del(black..'MARTEN:Lock:Stickers'..msg.chat_id_)
else
...
bot_data:del(black..'MARTEN:Lock:Forwards'..msg.chat_id_)
else
send_X(msg.chat_id_, msg.id_, 1, '𐇮 التوجيه بالفعل مفتوح في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الاباحي" then
if bot_data:get(black..'MARTEN:MARTEN:Lock:Xn'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𐇮 تم فتح الاباحي")  
bot_data:del(black..'MARTEN:MARTEN:Lock:Xn'..msg.chat_id_)
else
...
bot_data:set(black.."MARTEN:Lock:Bots"..msg.chat_id_,"del") bot_data:hset(black.."MARTEN:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
LockList ={'MARTEN:Lock:Links','MARTEN:Lock:Contact','MARTEN:Lock:Forwards','MARTEN:Lock:Videos','MARTEN:Lock:Gifs','MARTEN:Lock:EditMsgs','MARTEN:Lock:Stickers','MARTEN:Lock:Farsi','MARTEN:Lock:Spam','MARTEN:Lock:WebLinks','MARTEN:Lock:Photo'}
for i,Lock in pairs(LockList) do
...
bot_data:del(black..'MARTEN:Lock:Fshar'..msg.chat_id_) bot_data:del(black..'MARTEN:Lock:Taf'..msg.chat_id_) bot_data:del(black..'MARTEN:Lock:Kfr'..msg.chat_id_) 
bot_data:set(black.."MARTEN:Lock:Bots"..msg.chat_id_,"del") bot_data:hset(black.."MARTEN:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
...
bot_data:set(black..'MARTEN:Lock:Fshar'..msg.chat_id_,true) bot_data:set(black..'MARTEN:Lock:Taf'..msg.chat_id_,true) bot_data:set(black..'MARTEN:Lock:Kfr'..msg.chat_id_,true) bot_data:hdel(black.."MARTEN:Spam:Group:User"..msg.chat_id_ ,"Spam:User") 
...
bot_data:set(black..'MARTEN:Spam:Text'..msg.chat_id_,SetSpam)
...
bot_data:del(black.."MARTEN:mem:Rd"..msg.chat_id_)
bot_data:del(black.."MARTEN:Cleaner:Rd"..msg.chat_id_)
bot_data:del(black.."MARTEN:VipMem:Rd"..msg.chat_id_)
bot_data:del(black.."MARTEN:Admins:Rd"..msg.chat_id_)
bot_data:del(black.."MARTEN:Managers:Rd"..msg.chat_id_)
bot_data:del(black.."MARTEN:Constructor:Rd"..msg.chat_id_)
bot_data:del(black.."MARTEN:BasicConstructor:Rd"..msg.chat_id_)
bot_data:del(black.."MARTEN:SudoBot:Rd"..msg.chat_id_)
end
end
--     Source -black-     --
...
bot_data:del(black..'MARTEN:BanAll:')
bot_data:del(black..'MARTEN:MuteAll:')
...
bot_data:del(black..'MARTEN:AdminAll:')
end
...
bot_data:del(black..'MARTEN:VipAll:')
end
...
bot_data:del(black..'MARTEN:ManagerAll:')
end
if txts[2] == 'المالكين' or txtss[2] == 'المالكين' then
bot_data:del(black..'MARTEN:Owner:'..msg.chat_id_)
...
bot_data:del(black..'MARTEN:BasicConstructor:'..msg.chat_id_)
end
end
if BasicConstructor(msg) then
if txts[2] == 'المنشئين' or txtss[2] == 'المنشئين' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𐇮 تم حذف المنشئين\n✓")  
bot_data:del(black..'MARTEN:Constructor:'..msg.chat_id_)
end end
if Constructor(msg) then
if txts[2] == 'المدراء' or txtss[2] == 'المدراء' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𐇮 تم حذف المدراء\n✓")  
bot_data:del(black..'MARTEN:Managers:'..msg.chat_id_)
end 
...
bot_data:del(black.."MARTEN:Groups:Links"..msg.chat_id_)
end
if txts[2] == 'المميزين' or txtss[2] == 'المميزين' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𐇮 تم حذف المميزين\n✓")  
bot_data:del(black..'MARTEN:VipMem:'..msg.chat_id_)
end
if txts[2] == 'المكتومين' or txtss[2] == 'المكتومين' then
bot_data:del(black..'MARTEN:Muted:'..msg.chat_id_)
...
bot_data:srem(black..'MARTEN:Tkeed:'..msg.chat_id_, v)
end 
...
bot_data:del(black..'MARTEN:Filters:'..msg.chat_id_)
end
if txts[2] == 'قوائم المنع' or txtss[2] == 'قوائم المنع' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","𐇮 تم حذف قوائم المنع\n✓")  
bot_data:del(black..'MARTEN:Filters:'..msg.chat_id_)
bot_data:del(black.."MARTEN:FilterAnimation"..msg.chat_id_)
bot_data:del(black.."MARTEN:FilterPhoto"..msg.chat_id_)
bot_data:del(black.."MARTEN:FilterSteckr"..msg.chat_id_)
end
...
local Ban = bot_data:smembers(black..'MARTEN:Ban:'..msg.chat_id_)
local Muted = bot_data:smembers(black..'MARTEN:Muted:'..msg.chat_id_)
local Tkeed = bot_data:smembers(black..'MARTEN:Tkeed:'..msg.chat_id_)
local Filters = bot_data:smembers(black..'MARTEN:Filters:'..msg.chat_id_)
...
bot_data:del(black..'MARTEN:Ban:'..msg.chat_id_) 
bot_data:del(black..'MARTEN:Filters:'..msg.chat_id_) 
bot_data:del(black..'MARTEN:Muted:'..msg.chat_id_)
bot_data:del(black..'MARTEN:Tkeed:'..msg.chat_id_)
bot_data:del(black..'MARTEN:Cleaner:'..msg.chat_id_)
bot_data:del(black..'User:Donky:'..msg.chat_id_)
...
local basicconstructor = bot_data:smembers(black..'MARTEN:BasicConstructor:'..msg.chat_id_)
local constructor = bot_data:smembers(black..'MARTEN:Constructor:'..msg.chat_id_)
local Managers = bot_data:smembers(black..'MARTEN:Managers:'..msg.chat_id_)
local admins = bot_data:smembers(black..'MARTEN:Admins:'..msg.chat_id_)
local vipmem = bot_data:smembers(black..'MARTEN:VipMem:'..msg.chat_id_)
local cleaner = bot_data:smembers(black..'MARTEN:Cleaner:'..msg.chat_id_)
local donky = bot_data:smembers(black..'User:Donky:'..msg.chat_id_)
local HaTa = bot_data:smembers(black..'User:HaTa:'..msg.chat_id_)
local hlo = bot_data:smembers(black..'User:hlo:'..msg.chat_id_)
local Sakl = bot_data:smembers(black..'User:Sakl:'..msg.chat_id_)
...
spam_c = bot_data:get(black..'MARTEN:Spam:Text'..msg.chat_id_)
end
--     Source -black-     --
if bot_data:hget(black.."MARTEN:Spam:Group:User"..msg.chat_id_, "Spam:User") == "kick" then     
flood = "بالطرد"     
elseif bot_data:hget(black.."MARTEN:Spam:Group:User"..msg.chat_id_,"Spam:User") == "keed" then     
flood = "بالتقيد"     
elseif bot_data:hget(black.."MARTEN:Spam:Group:User"..msg.chat_id_,"Spam:User") == "mute" then     
flood = "بالكتم"           
elseif bot_data:hget(black.."MARTEN:Spam:Group:User"..msg.chat_id_,"Spam:User") == "del" then     
flood = "بالحذف"
else     
flood = "مفتوح"     
end
--     Source -black-     --
if bot_data:get(black.."MARTEN:Lock:Bots"..msg.chat_id_) == "del" then
lock_bots = "بالحذف"
elseif bot_data:get(black.."MARTEN:Lock:Bots"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif bot_data:get(black.."MARTEN:Lock:Bots"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "مفتوحه"    
end
--     Source -black-     --
if bot_data:get(black..'MARTEN:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه'end
if bot_data:get(black..'MARTEN:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفله' else mute_photo = 'مفتوحه' end
if bot_data:get(black..'MARTEN:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفله' else mute_video = 'مفتوحه' end
if bot_data:get(black..'MARTEN:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفله' else mute_gifs = 'مفتوحه' end
if bot_data:get(black..'MARTEN:Lock:Music'..msg.chat_id_) then mute_music = 'مقفله' else mute_music = 'مفتوحه' end
if bot_data:get(black..'MARTEN:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفله' else mute_in = 'مفتوحه' end
if bot_data:get(black..'MARTEN:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفله' else mute_voice = 'مفتوحه' end
if bot_data:get(black..'MARTEN:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفله' else mute_edit = 'مفتوحه' end
if bot_data:get(black..'MARTEN:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end
if bot_data:get(black..'MARTEN:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفله' else lock_pin = 'مفتوحه' end
if bot_data:get(black..'MARTEN:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفله' else lock_sticker = 'مفتوحه' end
if bot_data:get(black..'MARTEN:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفله' else lock_tgservice = 'مفتوحه' end
if bot_data:get(black..'MARTEN:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفله' else lock_wp = 'مفتوحه' end
if bot_data:get(black..'MARTEN:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفله' else lock_htag = 'مفتوحه' end
if bot_data:get(black..'MARTEN:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفله' else lock_tag = 'مفتوحه' end
if bot_data:get(black..'MARTEN:Lock:Location'..msg.chat_id_) then lock_location = 'مقفله' else lock_location = 'مفتوحه' end
if bot_data:get(black..'MARTEN:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفله' else lock_contact = 'مفتوحه' end
if bot_data:get(black..'MARTEN:Lock:English'..msg.chat_id_) then lock_english = 'مقفله' else lock_english = 'مفتوحه' end
if bot_data:get(black..'MARTEN:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفله' else lock_arabic = 'مفتوحه' end
if bot_data:get(black..'MARTEN:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفله' else lock_forward = 'مفتوحه' end
if bot_data:get(black..'MARTEN:Lock:Document'..msg.chat_id_) then lock_file = 'مقفله' else lock_file = 'مفتوحه' end
if bot_data:get(black..'MARTEN:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفله' else markdown = 'مفتوحه' end
if bot_data:get(black..'MARTEN:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفله' else lock_spam = 'مفتوحه' end
if bot_data:get(black..'MARTEN:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفل' else lock_Join = 'مفتوح' end
if bot_data:get(black.."MARTEN:Lock:Welcome"..msg.chat_id_) then send_welcome = 'مقفله' else send_welcome = 'مفتوحه' end
if bot_data:get(black..'MARTEN:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end
if bot_data:get(black..'MARTEN:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end
if bot_data:get(black..'MARTEN:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end
if bot_data:get(black..'MARTEN:Lock:Farsi'..msg.chat_id_) then lock_farsi = 'مقفله' else lock_farsi = 'مفتوحه' end
if bot_data:get(black..'MARTEN:MARTEN:Lock:Xn'..msg.chat_id_) then lock_xn = 'مفتوحه' else lock_xn = 'مقفله' end
if bot_data:get(black..'MARTEN:Lock:Clean'..msg.chat_id_) then lock_Clean = 'مفعله' else lock_Clean = 'معطله' end
local Flood_Num = bot_data:hget(black.."MARTEN:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
local Flood_Num_Time = bot_data:hget(black.."MARTEN:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 5
local Clean_Num = bot_data:get(black.."MARTEN:CleanNum"..msg.chat_id_,Num) or 200
--     Source -black-     --
...
.."𐇮 عدد السبام ↫ "..spam_c.."\n"
.."┋⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎┋ \n"
local inline = {{{text="✗ 𝐬𝐨𝐮𝐫𝐜𝐞 ✗ .",url="t.me/BLACK_TEAM_4"}}}
...
bot_data:del(black..'MARTEN:spech:MARTEN'..msg.chat_id_) 
end
if text == "تعطيل كول" and Manager(msg) and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"EbDsDrg","𐇮 تم تعطيل امر كول بنجاح")
bot_data:set(black..'MARTEN:spech:MARTEN'..msg.chat_id_,true)  
end
if text and text:match("^كول (.*)$") and not bot_data:get(black..'MARTEN:spech:MARTEN'..msg.chat_id_) then
local txt = {string.match(text, "^(كول) (.*)$")}
send_X(msg.chat_id_,0, 1, txt[2], 1, 'md')
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
--     Source -black-     --
if bot_data:get(black..'MARTEN:setrules'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
send_X(msg.chat_id_, msg.id_, 1, '𐇮 تم الغاء حفظ قوانين المجموعه', 1, 'md')
bot_data:del(black..'MARTEN:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
bot_data:del(black..'MARTEN:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
bot_data:set(black..'MARTEN:rules'..msg.chat_id_,text)
...
bot_data:set(black..'MARTEN:setrules'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
end
if text and text:match("^القوانين$") then
local rules = bot_data:get(black..'MARTEN:rules'..msg.chat_id_)
...
bot_data:del(black..'MARTEN:Antk:MARTEN'..msg.chat_id_) 
end
if text == "تعطيل انطق" and Manager(msg) and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"EbDsDrg","𐇮 تم تفعيل ميزة انطق")
bot_data:set(black..'MARTEN:Antk:MARTEN'..msg.chat_id_,true)  
end
if text and text:match("^انطق (.*)$") and not bot_data:get(black..'MARTEN:Antk:MARTEN'..msg.chat_id_) and ChCheck(msg) then
...
bot_data:del(black..'MARTEN:Zrf:MARTEN'..msg.chat_id_) 
end
if text == "تعطيل الزخرفه" and Manager(msg) and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"EbDsDrg","𐇮 تم تعطيل الزخرفه بنجاح")
bot_data:set(black..'MARTEN:Zrf:MARTEN'..msg.chat_id_,true)  
end
if bot_data:get(black..'Zrf:MARTEN'..msg.chat_id_..msg.sender_user_id_) then 
if text and text == 'الغاء' then 
send_X(msg.chat_id_, msg.id_, 1, '𐇮 تم الغاء امر الزخرفه', 1, 'md')
bot_data:del(black..'Zrf:MARTEN'..msg.chat_id_..msg.sender_user_id_)
return false  
end 
...
if not bot_data:get(black..'MARTEN:Zrf:MARTEN'..msg.chat_id_) then
if text == 'زخرفه' and ChCheck(msg) or text == 'الزخرفه' and ChCheck(msg) then  
bot_data:setex(black.."Zrf:MARTEN"..msg.chat_id_..msg.sender_user_id_,300,true)
...
bot_data:del(black..'MARTEN:Brg:MARTEN'..msg.chat_id_) 
end
...
bot_data:set(black..'MARTEN:Brg:MARTEN'..msg.chat_id_,true)  
end
if not bot_data:get(black..'MARTEN:Brg:MARTEN'..msg.chat_id_) then
if text and text:match("^برج (.*)$") and ChCheck(msg) or text and text:match("^برجي (.*)$") and ChCheck(msg) then 
local TextBrg = text:match("^برج (.*)$") or text:match("^برجي (.*)$") 
UrlBrg = https.request('https://apiabs.ml/brg.php?brg='..URL.escape(TextBrg)) 
Brg = JSON.decode(UrlBrg) 
t = Brg.ok.abs:gsub( "⌁", "⌯" ):gsub( "┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉", "┋⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎┋" )
send_X(msg.chat_id_, msg.id_, 1, t, 1, 'html')
end
end
--     Source -black-     --
...
bot_data:del(black..'MARTEN:Nsba:MARTEN'..msg.chat_id_) 
end
...
bot_data:set(black..'MARTEN:Nsba:MARTEN'..msg.chat_id_,true)  
end
if not bot_data:get(black..'MARTEN:Nsba:MARTEN'..msg.chat_id_) then
if text == "نسبه الحب" and ChCheck(msg) or text == "نسبة الحب" and ChCheck(msg) then
bot_data:set(black..'LoveNsba:MARTEN'..msg.chat_id_..msg.sender_user_id_,true) 
send_X(msg.chat_id_, msg.id_, 1, '𐇮 قم بارسل اسمين لحساب نسبة الحب بينهما كمثال ↫ جاك وروز', 1, 'md')
end
end
if text and text ~= "نسبه الحب" and text ~= "نسبة الحب" and bot_data:get(black..'LoveNsba:MARTEN'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
send_X(msg.chat_id_, msg.id_, 1, '𐇮 تم الغاء امر نسبة الحب ', 1, 'md')
bot_data:del(black..'LoveNsba:MARTEN'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
...
bot_data:set(black..'HataNsba:MARTEN'..msg.chat_id_..msg.sender_user_id_,true) 
send_X(msg.chat_id_, msg.id_, 1, '𐇮 قم بارسل اسمين لحساب نسبة الكره بينهما كمثال ↫ جاك وروز', 1, 'md')
end
end
if text and text ~= "نسبه الكره" and text ~= "نسبة الكره" and bot_data:get(black..'HataNsba:MARTEN'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
send_X(msg.chat_id_, msg.id_, 1, '𐇮 تم الغاء امر نسبة الكره ', 1, 'md')
bot_data:del(black..'HataNsba:MARTEN'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
MARTEN = math.random(0,100);
...
bot_data:set(black..'RjolaNsba:MARTEN'..msg.chat_id_..msg.sender_user_id_,true) 
send_X(msg.chat_id_, msg.id_, 1, '𐇮 قم بارسل اسم الشخص لقياس نسبة رجولته كمثال ↫ جاك', 1, 'md')
end
end
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and bot_data:get(black..'RjolaNsba:MARTEN'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
send_X(msg.chat_id_, msg.id_, 1, '𐇮 تم الغاء امر نسبة الرجوله ', 1, 'md')
bot_data:del(black..'RjolaNsba:MARTEN'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
MARTEN = math.random(0,100);
...
bot_data:set(black..'AnothaNsba:MARTEN'..msg.chat_id_..msg.sender_user_id_,true) 
send_X(msg.chat_id_, msg.id_, 1, '𐇮 قم بارسل اسم الشخص لقياس نسبة انوثته كمثال ↫ روز', 1, 'md')
end
end
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and bot_data:get(black..'AnothaNsba:MARTEN'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
send_X(msg.chat_id_, msg.id_, 1, '𐇮 تم الغاء امر نسبة الانوثه ', 1, 'md')
bot_data:del(black..'AnothaNsba:MARTEN'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
MARTEN = math.random(0,100);
...
bot_data:set(black..'StupidNsba:MARTEN'..msg.chat_id_..msg.sender_user_id_,true) 
send_X(msg.chat_id_, msg.id_, 1, '𐇮 قم بارسل اسم الشخص لقياس نسبة غبائه كمثال ↫ جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الغباء" and text ~= "نسبة الغباء" and bot_data:get(black..'StupidNsba:MARTEN'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
send_X(msg.chat_id_, msg.id_, 1, '𐇮 تم الغاء امر نسبة الغباء ', 1, 'md')
bot_data:del(black..'StupidNsba:MARTEN'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
MARTEN = math.random(0,100);
...
bot_data:del(black..'MARTEN:Age:MARTEN'..msg.chat_id_) 
end
...
bot_data:set(black..'MARTEN:Age:MARTEN'..msg.chat_id_,true)  
end
if not bot_data:get(black..'MARTEN:Age:MARTEN'..msg.chat_id_) then
...
bot_data:del(black..'MARTEN:Mean:MARTEN'..msg.chat_id_) 
end
...
bot_data:set(black..'MARTEN:Mean:MARTEN'..msg.chat_id_,true)  
end
if not bot_data:get(black..'MARTEN:Mean:MARTEN'..msg.chat_id_) then
...
bot_data:del(black..'MARTEN:Audios:MARTEN'..msg.chat_id_) 
end
...
bot_data:set(black..'MARTEN:Audios:MARTEN'..msg.chat_id_,true)  
end
if text == "غنيلي" and not bot_data:get(black..'MARTEN:Audios:MARTEN'..msg.chat_id_) and ChCheck(msg) then
...
--     Source -black-     --
if Admin(msg) then
if bot_data:get(black..'MARTEN:LockSettings'..msg.chat_id_) then 
if text == "الروابط" then if bot_data:get(black..'MARTEN:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end local XboT = "\n" .."𐇮 الروابط ↫ "..mute_links.."\n" send_X(msg.chat_id_, msg.id_, 1, XboT, 1, 'md') end
if text == "المعرف" or text == "المعرفات" then if bot_data:get(black..'MARTEN:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفوله' else lock_tag = 'مفتوحه' end local XboT = "\n" .."𐇮 المعرف ↫ "..lock_tag.."\n" send_X(msg.chat_id_, msg.id_, 1, XboT, 1, 'md') end
if text == "المتحركه" or text == "الملصقات المتحركه" then if bot_data:get(black..'MARTEN:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفوله' else mute_gifs = 'مفتوحه' end local XboT = "\n" .."𐇮 المتحركه ↫ "..mute_gifs.."\n" send_X(msg.chat_id_, msg.id_, 1, XboT, 1, 'md') end
if text == "الملصقات" then if bot_data:get(black..'MARTEN:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفوله' else lock_sticker = 'مفتوحه' end local XboT = "\n" .."𐇮 الملصقات ↫ "..lock_sticker.."\n" send_X(msg.chat_id_, msg.id_, 1, XboT, 1, 'md') end
if text == "الصور" then if bot_data:get(black..'MARTEN:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفوله' else mute_photo = 'مفتوحه' end local XboT = "\n" .."𐇮 الصور ↫ "..mute_photo.."\n" send_X(msg.chat_id_, msg.id_, 1, XboT, 1, 'md') end
if text == "الفيديو" or text == "الفيديوهات" then if bot_data:get(black..'MARTEN:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفوله' else mute_video = 'مفتوحه' end local XboT = "\n" .."𐇮 الفيديو ↫ "..mute_video.."\n" send_X(msg.chat_id_, msg.id_, 1, XboT, 1, 'md') end
if text == "الاونلاين" then if bot_data:get(black..'MARTEN:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفل' else mute_in = 'مفتوح' end local XboT = "\n" .."𐇮 الاونلاين ↫ "..mute_in.."\n" send_X(msg.chat_id_, msg.id_, 1, XboT, 1, 'md') end
if text == "الدردشه" then if bot_data:get(black..'MARTEN:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه' end local XboT = "\n" .."𐇮 الدردشه ↫ "..mute_text.."\n" send_X(msg.chat_id_, msg.id_, 1, XboT, 1, 'md') end
if text == "التوجيه" or text == "اعاده التوجيه" then if bot_data:get(black..'MARTEN:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفل' else lock_forward = 'مفتوح' end local XboT = "\n" .."𐇮 التوجيه ↫ "..lock_forward.."\n" send_X(msg.chat_id_, msg.id_, 1, XboT, 1, 'md') end
if text == "الاغاني" then if bot_data:get(black..'MARTEN:Lock:Music'..msg.chat_id_) then mute_music = 'مقفوله' else mute_music = 'مفتوحه' end local XboT = "\n" .."𐇮 الاغاني ↫ "..mute_music.."\n" send_X(msg.chat_id_, msg.id_, 1, XboT, 1, 'md') end
if text == "الصوت" or text == "الصوتيات" then if bot_data:get(black..'MARTEN:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفول' else mute_voice = 'مفتوح' end local XboT = "\n" .."𐇮 الصوت ↫ "..mute_voice.."\n" send_X(msg.chat_id_, msg.id_, 1, XboT, 1, 'md') end
if text == "الجهات" or text == "جهات الاتصال" then if bot_data:get(black..'MARTEN:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفوله' else lock_contact = 'مفتوحه' end local XboT = "\n" .."𐇮 الجهات ↫ "..lock_contact.."\n" send_X(msg.chat_id_, msg.id_, 1, XboT, 1, 'md') end
if text == "الماركداون" then if bot_data:get(black..'MARTEN:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفل' else markdown = 'مفتوح' end local XboT = "\n" .."𐇮 الماركداون ↫ "..markdown.."\n" send_X(msg.chat_id_, msg.id_, 1, XboT, 1, 'md') end
if text == "الهاشتاك" then if bot_data:get(black..'MARTEN:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفل' else lock_htag = 'مفتوح' end local XboT = "\n" .."𐇮 الهاشتاك ↫ "..lock_htag.."\n"send_X(msg.chat_id_, msg.id_, 1, XboT, 1, 'md') end
if text == "التعديل" then if bot_data:get(black..'MARTEN:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفل' else mute_edit = 'مفتوح' end local XboT = "\n" .."𐇮 التعديل ↫ "..mute_edit.."\n" send_X(msg.chat_id_, msg.id_, 1, XboT, 1, 'md') end
if text == "التثبيت" then if bot_data:get(black..'MARTEN:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفل' else lock_pin = 'مفتوح' end local XboT = "\n" .."𐇮 التثبيت ↫ "..lock_pin.."\n" send_X(msg.chat_id_, msg.id_, 1, XboT, 1, 'md') end
if text == "الاشعارات" then if bot_data:get(black..'MARTEN:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفوله' else lock_tgservice = 'مفتوحه' end local XboT = "\n" .."𐇮 الاشعارات ↫ "..lock_tgservice.."\n" send_X(msg.chat_id_, msg.id_, 1, XboT, 1, 'md') end
if text == "الكلايش" then if bot_data:get(black..'MARTEN:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفوله' else lock_spam = 'مفتوحه' end local XboT = "\n" .."𐇮 الكلايش ↫ "..lock_spam.."\n" send_X(msg.chat_id_, msg.id_, 1, XboT, 1, 'md') end
if text == "الدخول" then if bot_data:get(black..'MARTEN:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفول' else lock_Join = 'مفتوح' end local XboT = "\n" .."𐇮 الدخول ↫ "..lock_Join.."\n" send_X(msg.chat_id_, msg.id_, 1, XboT, 1, 'md') end
if text == "الشبكات" then if bot_data:get(black..'MARTEN:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفوله' else lock_wp = 'مفتوحه' end local XboT = "\n" .."𐇮 الشبكات ↫ "..lock_wp.."\n" send_X(msg.chat_id_, msg.id_, 1, XboT, 1, 'md') end
if text == "المواقع" then if bot_data:get(black..'MARTEN:Lock:Location'..msg.chat_id_) then lock_location = 'مقفوله' else lock_location = 'مفتوحه' end local XboT = "\n" .."𐇮 المواقع ↫ "..lock_location.."\n" send_X(msg.chat_id_, msg.id_, 1, XboT, 1, 'md') end
if text == "العربيه" then if bot_data:get(black..'MARTEN:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفوله' else lock_arabic = 'مفتوحه' end local XboT = "\n" .."𐇮 العربيه ↫ "..lock_arabic.."\n" send_X(msg.chat_id_, msg.id_, 1, XboT, 1, 'md') end
if text == "الانكليزيه" then if bot_data:get(black..'MARTEN:Lock:English'..msg.chat_id_) then lock_english = 'مقفوله' else lock_english = 'مفتوحه' end local XboT = "\n" .."𐇮 الانكليزيه ↫ "..lock_english.."\n" send_X(msg.chat_id_, msg.id_, 1, XboT, 1, 'md') end
if text == "الكفر" then if bot_data:get(black..'MARTEN:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end local XboT = "\n" .."𐇮 الكفر ↫ "..lock_kaf.."\n" send_X(msg.chat_id_, msg.id_, 1, XboT, 1, 'md') end
if text == "الفشار" then if bot_data:get(black..'MARTEN:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end local XboT = "\n" .."𐇮 الفشار ↫ "..lock_fshar.."\n" send_X(msg.chat_id_, msg.id_, 1, XboT, 1, 'md') end
if text == "الطائفيه" then if bot_data:get(black..'MARTEN:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end local XboT = "\n" .."𐇮 الطائفيه ↫ "..lock_taf.."\n" send_X(msg.chat_id_, msg.id_, 1, XboT, 1, 'md') end
end
--     Source -black-     --
if text == 'تفعيل كشف الاعدادات' and ChCheck(msg) then 
ReplyStatus(msg,msg.sender_user_id_,"EbDsDrg","𐇮 تم تفعيل كشف الاعدادات بنجاح\n✓")
bot_data:set(black..'MARTEN:LockSettings'..msg.chat_id_,true)  
end
if text == 'تعطيل كشف الاعدادات' and ChCheck(msg) then 
ReplyStatus(msg,msg.sender_user_id_,"EbDsDrg","𐇮 تم تعطيل كشف الاعدادات بنجاح\n✓")
bot_data:del(black..'MARTEN:LockSettings'..msg.chat_id_) 
end
--     Source -black-     --
...
bot_data:del(black..'MARTEN:Lock:Stupid'..msg.chat_id_)
end
...
--     Source -black-     --
if msg.content_.photo_ then
if bot_data:get(black..'MARTEN:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_) then
if msg.content_.photo_.sizes_[3] then
...
bot_data:del(black..'MARTEN:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
return false  end
if data.message_ == "CHAT_ADMIN_REQUIRED" then 
send(msg.chat_id_, msg.id_,"𐇮 ليست لدي صلاحية تغير معلومات المجموعه يرجى التحقق من الصلاحيات") 
bot_data:del(black..'MARTEN:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
...
bot_data:set(black..'MARTEN:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
--     Source -black-     --
...
if data.ID == "Ok" then
bot_data:del(black..'MARTEN:PinnedMsg'..msg.chat_id_)
...
local PinId = bot_data:get(black..'MARTEN:PinnedMsg'..msg.chat_id_)
if PinId then
...
local Muted = bot_data:scard(black.."MARTEN:Muted:"..msg.chat_id_) or "0"
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub("-100","")},function(arg,data) 
...
local ConstructorList = bot_data:scard(black.."MARTEN:Constructor:"..ChatId) or 0
local BanedList = bot_data:scard(black.."MARTEN:Ban:"..ChatId) or 0
local ManagerList = bot_data:scard(black.."MARTEN:Managers:"..ChatId) or 0
local MutedList = bot_data:scard(black.."MARTEN:Muted:"..ChatId) or 0
local TkeedList = bot_data:scard(black.."MARTEN:MARTEN:Tkeed:"..ChatId) or 0
local AdminsList = bot_data:scard(black.."MARTEN:Admins:"..ChatId) or 0
local VipList = bot_data:scard(black.."MARTEN:VipMem:"..ChatId) or 0
...
ConstructorMARTEN = "["..MARTEN.first_name_.."](T.me/"..(MARTEN.username_ or "BLACK_TEAM_4")..")"
else 
...
bot_data:srem(black.."MARTEN:Groups", dp.id_)
else
...
bot_data:set(black..'MARTEN:Num:Add:Bot',Num) 
...
bot_data:del(black..'MARTEN:Lock:FreeBot'..black) 
end 
end
...
bot_data:set(black.."MARTEN:Lock:GpLinks"..msg.chat_id_,"ok")
return false  
end
end
...
bot_data:del(black.."MARTEN:Lock:GpLinks"..msg.chat_id_)
return false  
end
end
--     Source -black-     --
...
ReplyStatus(msg,result.id_,"ReplyBy","𐇮 تم تفعيل المجموعه "..dp.title_)  
bot_data:sadd(black.."MARTEN:Groups",msg.chat_id_)
if not bot_data:get(black..'MARTEN:SudosGp'..msg.sender_user_id_..msg.chat_id_) and not SecondSudo(msg) then 
bot_data:incrby(black..'MARTEN:Sudos'..msg.sender_user_id_,1)
bot_data:set(black..'MARTEN:SudosGp'..msg.sender_user_id_..msg.chat_id_,"MARTEN")
end
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
if not bot_data:sismember(black..'MARTEN:Groups',msg.chat_id_) then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '# َʙʟᴀᴄᴋ ғɪʟᴇs ⁞.', url="t.me/J_F_A_I"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '# َᴊᴏᴋᴇʀ ⁞', url="t.me/UUOUOU_7"},{text = '# َᴊᴀᴄᴋ ⁞', url="t.me/V_P_E"}},
...
for k,v in pairs(List) do
local GroupsManagers = bot_data:scard(black.."MARTEN:Managers:"..v) or 0
local GroupsAdmins = bot_data:scard(black.."MARTEN:Admins:"..v) or 0
local Groupslink = bot_data:get(black.."MARTEN:Groups:Links" ..v)
...
bot_data:setex(black.."MARTEN:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
ReplyStatus(msg,msg.sender_user_id_,"EbDsDrg","𐇮 ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n𐇮 للخروج ارسل ↫ ( الغاء ) \n ✓")
return false
end 
if bot_data:get(black.."MARTEN:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
send_X(msg.chat_id_, msg.id_, 1, "𐇮 تم الغاء امر الاذاعه بنجاح", 1, 'md')
bot_data:del(black.."MARTEN:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = bot_data:smembers(black..'MARTEN:Users') 
if msg.content_.text_ then
for k,v in pairs(List) do 
MARTENText = "الرساله"
...
bot_data:setex(black.."MARTEN:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
ReplyStatus(msg,msg.sender_user_id_,"EbDsDrg","𐇮 ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n𐇮 للخروج ارسل ↫ ( الغاء ) \n ✓")
return false
end 
if bot_data:get(black.."MARTEN:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
send_X(msg.chat_id_, msg.id_, 1, "𐇮 تم الغاء امر الاذاعه بنجاح", 1, 'md')
bot_data:del(black.."MARTEN:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = bot_data:smembers(black..'MARTEN:Groups') 
if msg.content_.text_ then
for k,v in pairs(List) do 
MARTENText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
...
bot_data:setex(black.."MARTEN:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
ReplyStatus(msg,msg.sender_user_id_,"EbDsDrg","𐇮 ارسل الرساله الان لتوجيها \n𐇮 للخروج ارسل ↫ ( الغاء ) \n ✓")
return false
end 
if bot_data:get(black.."MARTEN:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
send_X(msg.chat_id_, msg.id_, 1, "𐇮 تم الغاء امر الاذاعه بنجاح", 1, 'md')
bot_data:del(black.."MARTEN:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = bot_data:smembers(black..'MARTEN:Groups')   
for k,v in pairs(List) do  
...
bot_data:setex(black.."MARTEN:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
ReplyStatus(msg,msg.sender_user_id_,"EbDsDrg","𐇮 ارسل الرساله الان لتوجيها \n𐇮 للخروج ارسل ↫ ( الغاء ) \n ✓")
return false
end 
if bot_data:get(black.."MARTEN:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
send_X(msg.chat_id_, msg.id_, 1, "𐇮 تم الغاء امر الاذاعه بنجاح", 1, 'md')
bot_data:del(black.."MARTEN:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = bot_data:smembers(black..'MARTEN:Users')   
for k,v in pairs(List) do  
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = msg.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end   
send_X(msg.chat_id_, msg.id_, 1, "𐇮 تم اذاعة رسالتك بالتوجيه \n𐇮 ‏الى ↫ ❨ "..#List.." ❩ مشترك \n ✓", 1, 'md')
...
bot_data:setex(black.."MARTEN:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
ReplyStatus(msg,msg.sender_user_id_,"EbDsDrg","𐇮 ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n𐇮 للخروج ارسل ↫ ( الغاء ) \n ✓")
return false
end 
if bot_data:get(black.."MARTEN:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == "الغاء" then   
send_X(msg.chat_id_, msg.id_, 1, "𐇮 تم الغاء امر الاذاعه بنجاح", 1, 'md')
bot_data:del(black.."MARTEN:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
local List = bot_data:smembers(black.."MARTEN:Groups") 
if msg.content_.text_ then
...
MARTENText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
bot_data:set(black..'MARTEN:PinnedMsgs'..v,msg.content_.text_) 
end
elseif msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
MARTENText = "الصوره"
sendPhoto(v, 0, 0, 1, nil, photo,(msg.content_.caption_ or ''))
bot_data:set(black..'MARTEN:PinnedMsgs'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(List) do 
MARTENText = "المتحركه"
sendDocument(v, 0, 0, 1,nil, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or ''))    
bot_data:set(black..'MARTEN:PinnedMsgs'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.video_ then
for k,v in pairs(List) do 
MARTENText = "الفيديو"
sendVideo(v, 0, 0, 1, nil, msg.content_.video_.video_.persistent_id_,(msg.content_.caption_ or '')) 
bot_data:set(black..'MARTEN:PinnedMsgs'..v,msg.content_.video_.video_.persistent_id_)
end 
elseif msg.content_.voice_ then
for k,v in pairs(List) do 
MARTENText = "البصمه"
sendVoice(v, 0, 0, 1, nil, msg.content_.voice_.voice_.persistent_id_,(msg.content_.caption_ or '')) 
bot_data:set(black..'MARTEN:PinnedMsgs'..v,msg.content_.voice_.voice_.persistent_id_)
end 
elseif msg.content_.audio_ then
for k,v in pairs(List) do 
MARTENText = "الصوت"
sendAudio(v, 0, 0, 1, nil, msg.content_.audio_.audio_.persistent_id_,(msg.content_.caption_ or '')) 
bot_data:set(black..'MARTEN:PinnedMsgs'..v,msg.content_.audio_.audio_.persistent_id_)
end 
elseif msg.content_.document_ then
for k,v in pairs(List) do 
MARTENText = "الملف"
sendDocument(v, 0, 0, 1,nil, msg.content_.document_.document_.persistent_id_,(msg.content_.caption_ or ''))    
bot_data:set(black..'MARTEN:PinnedMsgs'..v,msg.content_.document_.document_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(List) do 
MARTENText = "الملصق"
sendSticker(v, 0, 0, 1, nil, msg.content_.sticker_.sticker_.persistent_id_)   
bot_data:set(black..'MARTEN:PinnedMsgs'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
local List = bot_data:smembers(black..'MARTEN:Manager:GpRedod'..msg.chat_id_)
if #List == 0 then
send_X(msg.chat_id_, msg.id_, 1, "𐇮 لا توجد ردود متعدده مضافه" ,  1, "md")
return false
end
bot_data:set(black..'MARTEN:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedod')
send_X(msg.chat_id_, msg.id_, 1, "𐇮 حسنا ارسل كلمة الرد اولا" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local DelGpRedRedod = bot_data:get(black..'MARTEN:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
if not bot_data:sismember(black..'MARTEN:Manager:GpRedod'..msg.chat_id_,text) then
...
bot_data:set(black..'MARTEN:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedods')
bot_data:set(black..'MARTEN:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
return false
end end
...
bot_data:set(black..'MARTEN:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedod')
send_X(msg.chat_id_, msg.id_, 1, "𐇮 حسنا ارسل الكلمه لحذفها" ,  1, "md")
return false
end
if text == 'اضف رد متعدد' and Manager(msg) and ChCheck(msg) then
bot_data:set(black..'MARTEN:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SetGpRedod')
send_X(msg.chat_id_, msg.id_, 1, "𐇮 حسنا ارسل الكلمه الان" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetGpRedod = bot_data:get(black..'MARTEN:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
bot_data:set(black..'MARTEN:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SaveGpRedod')
bot_data:set(black..'MARTEN:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
bot_data:sadd(black..'MARTEN:Manager:GpRedod'..msg.chat_id_,text)
return false
end end
--     Source -black-     --
if text == 'حذف رد' and Manager(msg) and ChCheck(msg) or text == 'مسح رد' and  Manager(msg) and ChCheck(msg) then
local List = bot_data:smembers(black..'MARTEN:Manager:GpRed'..msg.chat_id_)
if #List == 0 then
send_X(msg.chat_id_, msg.id_, 1, "𐇮 لا توجد ردود مضافه" ,  1, "md")
return false
end
bot_data:set(black..'MARTEN:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'DelGpRed')
send_X(msg.chat_id_, msg.id_, 1, "𐇮 حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
if text == 'اضف رد' and Manager(msg) and ChCheck(msg) then
bot_data:set(black..'MARTEN:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SetGpRed')
send_X(msg.chat_id_, msg.id_, 1, "𐇮 حسنا ارسل الكلمه الان " ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetGpRed = bot_data:get(black..'MARTEN:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
...
bot_data:set(black..'MARTEN:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SaveGpRed')
bot_data:set(black..'MARTEN:Add:GpText'..msg.sender_user_id_..msg.chat_id_,text)
bot_data:sadd(black..'MARTEN:Manager:GpRed'..msg.chat_id_,text)
...
local List = bot_data:smembers(black.."MARTEN:Sudo:AllRed")
if #List == 0 then
send_X(msg.chat_id_, msg.id_, 1, "𐇮 لا توجد ردود مضافه" ,  1, "md")
return false
end
bot_data:set(black.."MARTEN:Add:AllRed"..msg.sender_user_id_,'DelAllRed')
send_X(msg.chat_id_, msg.id_, 1, "𐇮 حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
if text == 'اضف رد عام' and SecondSudo(msg) or text == '↫ اضف رد عام ⌯' and SecondSudo(msg) then
bot_data:set(black.."MARTEN:Add:AllRed"..msg.sender_user_id_,'SetAllRed')
send_X(msg.chat_id_, msg.id_, 1, "𐇮 حسنا ارسل الكلمه الان " ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetAllRed = bot_data:get(black.."MARTEN:Add:AllRed"..msg.sender_user_id_)
...
send_X(msg.chat_id_, msg.id_, 1, "𐇮 ارسل لي الرد سواء كان ↫ ⤈\n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n𐇮 يمكنك اضافة الى النص ↫ ⤈\n┋⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎┋ \n𐇮 🌐 `#username` ↬ معرف المستخدم\n𐇮 📎 `#name` ↬ اسم المستخدم\n𐇮 🆔 `#id` ↬ ايدي المستخدم\n𐇮 ✏️ `#bio` ↬ نبذا المستخدم\n𐇮 🎖 `#stast` ↬ رتبة المستخدم\n𐇮 📨 `#msgs` ↬ عدد الرسائل\n𐇮 📝 `#edit` ↬ عدد السحكات\n┋⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎┋ \n𐇮 للخروج ارسل ↫ ( الغاء )\n ✓" ,  1, "md")
bot_data:set(black.."MARTEN:Add:AllRed"..msg.sender_user_id_,'SaveAllRed')
bot_data:set(black.."MARTEN:Add:AllText"..msg.sender_user_id_, text)
bot_data:sadd(black.."MARTEN:Sudo:AllRed",text)
bot_data:set(black.."DelSudoRep",text)
return false 
end end
--     Source -black-     --
if text == 'الردود المتعدده' and Manager(msg) and ChCheck(msg) then
local redod = bot_data:smembers(black..'MARTEN:Manager:GpRedod'..msg.chat_id_)
MsgRep = '𐇮 قائمة الردود المتعدده ↫ ⤈ \n┋⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎┋\n'
for k,v in pairs(redod) do
MsgRep = MsgRep..k..'~ (`'..v..'`) • {*العدد ↫ '..#bot_data:smembers(black..'MARTEN:Text:GpTexts'..v..msg.chat_id_)..'*}\n' 
end
if #redod == 0 then
...
for k,v in pairs(redod) do
bot_data:del(black..'MARTEN:Text:GpTexts'..v..msg.chat_id_)
bot_data:del(black..'MARTEN:Manager:GpRedod'..msg.chat_id_)
end
...
local redod = bot_data:smembers(black..'MARTEN:Manager:GpRed'..msg.chat_id_)
MsgRep = '𐇮 ردود المدير ↫ ⤈ \n┋⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎┋\n'
for k,v in pairs(redod) do
if bot_data:get(black.."MARTEN:Gif:GpRed"..v..msg.chat_id_) then
dp = 'متحركه 🎭'
elseif bot_data:get(black.."MARTEN:Voice:GpRed"..v..msg.chat_id_) then
dp = 'بصمه 🎙'
elseif bot_data:get(black.."MARTEN:Stecker:GpRed"..v..msg.chat_id_) then
dp = 'ملصق 🃏'
elseif bot_data:get(black.."MARTEN:Text:GpRed"..v..msg.chat_id_) then
dp = 'رساله ✉'
elseif bot_data:get(black.."MARTEN:Photo:GpRed"..v..msg.chat_id_) then
dp = 'صوره 🎇'
elseif bot_data:get(black.."MARTEN:Video:GpRed"..v..msg.chat_id_) then
dp = 'فيديو 📽'
elseif bot_data:get(black.."MARTEN:File:GpRed"..v..msg.chat_id_) then
dp = 'ملف 📁'
elseif bot_data:get(black.."MARTEN:Audio:GpRed"..v..msg.chat_id_) then
dp = 'اغنيه 🎶'
end
...
for k,v in pairs(redod) do
bot_data:del(black..'MARTEN:Gif:GpRed'..v..msg.chat_id_)
bot_data:del(black..'MARTEN:Voice:GpRed'..v..msg.chat_id_)
bot_data:del(black..'MARTEN:Audio:GpRed'..v..msg.chat_id_)
bot_data:del(black..'MARTEN:Photo:GpRed'..v..msg.chat_id_)
bot_data:del(black..'MARTEN:Stecker:GpRed'..v..msg.chat_id_)
bot_data:del(black..'MARTEN:Video:GpRed'..v..msg.chat_id_)
bot_data:del(black..'MARTEN:File:GpRed'..v..msg.chat_id_)
bot_data:del(black..'MARTEN:Text:GpRed'..v..msg.chat_id_)
bot_data:del(black..'MARTEN:Manager:GpRed'..msg.chat_id_)
end
...
local redod = bot_data:smembers(black.."MARTEN:Sudo:AllRed")
MsgRep = '𐇮 ردود المطور ↫ ⤈ \n┋⁽ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐋𝐀𝐂𝐊 ₎┋\n'
for k,v in pairs(redod) do
if bot_data:get(black.."MARTEN:Gif:AllRed"..v) then
dp = 'متحركه 🎭'
elseif bot_data:get(black.."MARTEN:Voice:AllRed"..v) then
dp = 'بصمه 🎙'
elseif bot_data:get(black.."MARTEN:Stecker:AllRed"..v) then
dp = 'ملصق 🃏'
elseif bot_data:get(black.."MARTEN:Text:AllRed"..v) then
dp = 'رساله ✉'
elseif bot_data:get(black.."MARTEN:Photo:AllRed"..v) then
dp = 'صوره 🎇'
elseif bot_data:get(black.."MARTEN:Video:AllRed"..v) then
dp = 'فيديو 📽'
elseif bot_data:get(black.."MARTEN:File:AllRed"..v) then
dp = 'ملف 📁'
elseif bot_data:get(black.."MARTEN:Audio:AllRed"..v) then
dp = 'اغنيه 🎶'
end
MsgRep = MsgRep..k..'~ (`'..v..'`) ↫ {*'..dp..'*}\n' 
end
...
for k,v in pairs(redod) do
bot_data:del(black.."MARTEN:Add:AllRed"..v)
bot_data:del(black.."MARTEN:Gif:AllRed"..v)
bot_data:del(black.."MARTEN:Voice:AllRed"..v)
bot_data:del(black.."MARTEN:Audio:AllRed"..v)
bot_data:del(black.."MARTEN:Photo:AllRed"..v)
bot_data:del(black.."MARTEN:Stecker:AllRed"..v)
bot_data:del(black.."MARTEN:Video:AllRed"..v)
bot_data:del(black.."MARTEN:File:AllRed"..v)
bot_data:del(black.."MARTEN:Text:AllRed"..v)
bot_data:del(black.."MARTEN:Sudo:AllRed")
end
...
bot_data:set(black..'MARTEN:NameBot'..msg.sender_user_id_, 'msg')
return false 
end
end
...
bot_data:del(black..'MARTEN:NameBot')
...
bot_data:set(black..'MARTEN:Help0'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local XboT =  bot_data:get(black..'MARTEN:Help0'..msg.sender_user_id_)
if XboT == 'msg' then
send_X(msg.chat_id_, msg.id_, 1, text , 1, 'md')
bot_data:del(black..'MARTEN:Help0'..msg.sender_user_id_)
bot_data:set(black..'MARTEN:Help', text)
send_X(msg.chat_id_, msg.id_, 1, "𐇮 تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
bot_data:set(black..'MARTEN:Help01'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local XboT =  bot_data:get(black..'MARTEN:Help01'..msg.sender_user_id_)
if XboT == 'msg' then 
send_X(msg.chat_id_, msg.id_, 1, text , 1, 'md')
bot_data:del(black..'MARTEN:Help01'..msg.sender_user_id_)
bot_data:set(black..'MARTEN:Help1', text)
send_X(msg.chat_id_, msg.id_, 1, "𐇮 تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
bot_data:set(black..'MARTEN:Help21'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local XboT =  bot_data:get(black..'MARTEN:Help21'..msg.sender_user_id_)
if XboT == 'msg' then
send_X(msg.chat_id_, msg.id_, 1, text , 1, 'md')
bot_data:del(black..'MARTEN:Help21'..msg.sender_user_id_)
bot_data:set(black..'MARTEN:Help2', text)
send_X(msg.chat_id_, msg.id_, 1, "𐇮 تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
bot_data:set(black..'MARTEN:Help31'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local XboT =  bot_data:get(black..'MARTEN:Help31'..msg.sender_user_id_)
if XboT == 'msg' then
send_X(msg.chat_id_, msg.id_, 1, text , 1, 'md')
bot_data:del(black..'MARTEN:Help31'..msg.sender_user_id_)
bot_data:set(black..'MARTEN:Help3', text)
send_X(msg.chat_id_, msg.id_, 1, "𐇮 تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
bot_data:set(black..'MARTEN:Help41'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local XboT =  bot_data:get(black..'MARTEN:Help41'..msg.sender_user_id_)
if XboT == 'msg' then
send_X(msg.chat_id_, msg.id_, 1, text , 1, 'md')
bot_data:del(black..'MARTEN:Help41'..msg.sender_user_id_)
bot_data:set(black..'MARTEN:Help4', text)
send_X(msg.chat_id_, msg.id_, 1, "𐇮 تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
bot_data:set(black..'MARTEN:Help51'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local XboT =  bot_data:get(black..'MARTEN:Help51'..msg.sender_user_id_)
if XboT == 'msg' then
send_X(msg.chat_id_, msg.id_, 1, text , 1, 'md')
bot_data:del(black..'MARTEN:Help51'..msg.sender_user_id_)
bot_data:set(black..'MARTEN:Help5', text)
send_X(msg.chat_id_, msg.id_, 1, "𐇮 تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
bot_data:set(black..'MARTEN:Help61'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local XboT =  bot_data:get(black..'MARTEN:Help61'..msg.sender_user_id_)
if XboT == 'msg' then
send_X(msg.chat_id_, msg.id_, 1, text , 1, 'md')
bot_data:del(black..'MARTEN:Help61'..msg.sender_user_id_)
bot_data:set(black..'MARTEN:Help6', text)
send_X(msg.chat_id_, msg.id_, 1, "𐇮 تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
--     source -black-     --
if bot_data:get(black..'MARTEN:Lock:Text'..msg.chat_id_) then mute_text = '🔴' else mute_text = '🟢'end
if bot_data:get(black..'MARTEN:Lock:Join'..msg.chat_id_) then lock_Join = '🔴' else lock_Join = '🟢' end
if bot_data:get(black..'MARTEN:Lock:TagServr'..msg.chat_id_) then lock_tgservice = '🔴' else lock_tgservice = '🟢' end
if bot_data:get(black..'MARTEN:Lock:EditMsgs'..msg.chat_id_) then mute_edit = '🔴' else mute_edit = '🟢' end
if bot_data:get(black..'MARTEN:Lock:Stickers'..msg.chat_id_) then lock_sticker = '🔴' else lock_sticker = '🟢' end
if bot_data:get(black..'MARTEN:Lock:Gifs'..msg.chat_id_) then mute_gifs = '🔴' else mute_gifs = '🟢' end
if bot_data:get(black..'MARTEN:Lock:Videos'..msg.chat_id_) then mute_video = '🔴' else mute_video = '🟢' end
if bot_data:get(black..'MARTEN:Lock:Photo'..msg.chat_id_) then mute_photo = '🔴' else mute_photo = '🟢' end
if bot_data:get(black..'MARTEN:Lock:Forwards'..msg.chat_id_) then lock_forward = '🔴' else lock_forward = '🟢' end
...
--     source -black-     --
if text == "غادر" and SudoBot(msg) then
local Leave = bot_data:get(black..'MARTEN:Leave')
local Text = [[
...
os.execute('wget https://raw.githubusercontent.com/black-MAIN/black/main/black.lua') 
dofile('black.lua') 
...
bot_data:del(black..'MARTEN:Text:BotWelcome')
bot_data:del(black..'MARTEN:Photo:BotWelcome')
return false
end 
...
bot_data:del(black..'MARTEN:Lock:BotWelcome')
return false
end 
...
bot_data:set(black..'MARTEN:Lock:BotWelcome',true)
return false
end 
...
bot_data:del(black..'MARTEN:Text:BotWelcome')
bot_data:del(black..'MARTEN:Photo:BotWelcome')
bot_data:set(black.."MARTEN:Set:BotWelcome"..msg.sender_user_id_,"Text") 
return false
end 
if text and bot_data:get(black.."MARTEN:Set:BotWelcome"..msg.sender_user_id_) == 'Text' then 
if text and text:match("^الغاء$") then 
send_X(msg.chat_id_, msg.id_, 1, "𐇮 تم الغاء الامر", 1, "md") 
bot_data:del(black.."MARTEN:Set:BotWelcome"..msg.sender_user_id_)   
return false
end 
send_X(msg.chat_id_, msg.id_, 1, "𐇮 تم حفظ النص ارسل لي صورة الترحيب\n𐇮 ارسل ↫ الغاء لحفظ النص فقط", 1, 'md')   
bot_data:set(black.."MARTEN:Text:BotWelcome",text) 
bot_data:set(black.."MARTEN:Set:BotWelcome"..msg.sender_user_id_,"Photo") 
return false 
end 
if bot_data:get(black.."MARTEN:Set:BotWelcome"..msg.sender_user_id_) == 'Photo' then 
if text and text:match("^الغاء$") then 
...
bot_data:set(black.."MARTEN:Photo:BotWelcome",msg.content_.photo_.sizes_[1].photo_.persistent_id_)
...
bot_data:setex(black.."MARTEN:DevText"..msg.chat_id_..":" .. msg.sender_user_id_, 300, true)
end end
...
bot_data:set(black..'MARTEN:ChText',texxt)
...
bot_data:del(black..'MARTEN:ChText')
...
bot_data:incr(black..'MARTEN:EditMsg'..result.chat_id_..result.sender_user_id_)
local text = result.content_.text_ or result.content_.caption_
local Text = result.content_.text_
if bot_data:get(black..'MARTEN:Lock:EditMsgs'..msg.chat_id_) and not Text and not BasicConstructor(result) then
...
local GetMsgPin = bot_data:get(black..'MARTEN:PinnedMsgs'..msg.chat_id_)
if GetMsgPin ~= nil then
if text == GetMsgPin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) if dp.ID == 'Ok' then;bot_data:del(black..'MARTEN:PinnedMsgs'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if GetMsgPin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) bot_data:del(black..'MARTEN:PinnedMsgs'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
bot_data:srem(black..'MARTEN:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
bot_data:srem(black..'MARTEN:Groups',v)  
end
...
bot_data:sadd(black..'MARTEN:Groups',v)  
end end,nil) end
end
--     Source -black-     --
end 
